...
extern UINT32 _SECTION(".kercfg_data") IQS_SIE2SemiId;
...
extern UINT32 _SECTION(".kercfg_data") IQS_RHESemiId;


#if IQS_SEMI_EN
#define WAI_SIESEM (wai_sem(IQS_SIESemiId))
#define SIG_SIESEM (sig_sem(IQS_SIESemiId))
#define WAI_SIE2SEM (wai_sem(IQS_SIE2SemiId))
#define SIG_SIE2SEM (sig_sem(IQS_SIE2SemiId))
#define WAI_PRESEM (wai_sem(IQS_PRESemiId))
#define SIG_PRESEM (sig_sem(IQS_PRESemiId))
#define WAI_RHESEM (wai_sem(IQS_RHESemiId))
#define SIG_RHESEM (sig_sem(IQS_RHESemiId))
