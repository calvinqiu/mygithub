#this file is auto created by yq_prebuild.pl YOUQING,pls do not modified this file;
#
#
...
#[YQCONFIG_GYRO_SUPPORT]=start=======================================================================================
YQCONFIG_GYRO_SUPPORT := false
#
#./resource/common_makefile/features.mak defined value=no
#
#
...
#[YQCONFIG_GPS_SUPPORT]=start=======================================================================================
YQCONFIG_GPS_SUPPORT := false
#
#./resource/common_makefile/features.mak defined value=no
#
#
...
#[YQCONFIG_WIFI_SUPPORT]=start=======================================================================================
YQCONFIG_WIFI_SUPPORT := false
#
#./resource/common_makefile/features.mak defined value=no
#
#
...
#[YQCONFIG_COMB_SENSOR_DISPLAY_FLIP_OPTION]=start=======================================================================================
YQCONFIG_COMB_SENSOR_DISPLAY_FLIP_OPTION := FLIP_NONE
#
#./resource/common_makefile/features.mak defined YQCONFIG_COMB_SENSOR_DISPLAY_FLIP_OPTION=FLIP_NONE
#
#
# end ========================================================================================


#[YQCONFIG_COMB_SENSOR_DISPLAY_FLIP_OPTION_FLIP_NONE]=start=======================================================================================
YQCONFIG_COMB_SENSOR_DISPLAY_FLIP_OPTION_FLIP_NONE := true
#
#./resource/common_makefile/features.mak defined comb marco=YQCONFIG_COMB_SENSOR_DISPLAY_FLIP_OPTION_FLIP_NONE=1
#
#
# end ========================================================================================
...
#[YQCONFIG_CPU2_TYPE_CUST]=start=======================================================================================
YQCONFIG_CPU2_TYPE_CUST := CPU2_ECOS
#
#./resource/common_makefile/features.mak defined value=CPU2_ECOS
#
#
# end ========================================================================================


#[YQCONFIG_STORAGE_CUST]=start=======================================================================================
YQCONFIG_STORAGE_CUST := Storage_SPI
#
#./resource/common_makefile/features.mak defined value=Storage_SPI
#
#
# end ========================================================================================


#[YQCONFIG_EMBMEM_BLK_SIZE_CUST]=start=======================================================================================
YQCONFIG_EMBMEM_BLK_SIZE_CUST := 0x1000
#
#./resource/common_makefile/features.mak defined value=0x1000
#
#
# end ========================================================================================


#[YQCONFIG_USB_TYPE_CUST]=start=======================================================================================
YQCONFIG_USB_TYPE_CUST := DEVICE
#
#./resource/common_makefile/features.mak defined value=DEVICE
#
#
# end ========================================================================================


#[YQCONFIG_GPS_CUST]=start=======================================================================================
YQCONFIG_GPS_CUST := GPS_NONE
#
#./resource/common_makefile/features.mak defined value=GPS_NONE
#
#
# end ========================================================================================


#[YQCONFIG_UI_STYLE_CUST]=start=======================================================================================
YQCONFIG_UI_STYLE_CUST := UI_STYLE_SPORTCAM
#
#./resource/common_makefile/features.mak defined value=UI_STYLE_SPORTCAM
#
#
# end ========================================================================================


#[YQCONFIG_USE_FIX_PROJECT_SUPPORT]=start=======================================================================================
YQCONFIG_USE_FIX_PROJECT_SUPPORT := true
#
#./resource/common_makefile/features.mak defined value=yes
#
#
# end ========================================================================================
...
#
#./resource/U15/base.U15.mak redefined value="U15.public"
#./resource/U15/base.U15.mak redefined value="U15.public"
...
#[YQCONFIG_DRIVE_EVENT_SUPPORT]=start=======================================================================================
YQCONFIG_DRIVE_EVENT_SUPPORT := false
#
#./resource/common_makefile/features.mak defined value=no
#
#
...
#[YQCONFIG_SDHOTPLUG_FUNCTION_SUPPORT]=start=======================================================================================
YQCONFIG_SDHOTPLUG_FUNCTION_SUPPORT := false
#
#./resource/common_makefile/features.mak defined value=no
#
#
...
#[YQCONFIG_POWERLOGO_FUNCTION_SUPPORT]=start=======================================================================================
YQCONFIG_POWERLOGO_FUNCTION_SUPPORT := false
#
#./resource/common_makefile/features.mak defined value=no
#
#
...
#[YQCONFIG_POWERSOUND_FUNCTION_SUPPORT]=start=======================================================================================
YQCONFIG_POWERSOUND_FUNCTION_SUPPORT := false
#
#./resource/common_makefile/features.mak defined value=no
#
#
...
#[YQCONFIG_PWRLEVEL_FUNCTION_SUPPORT]=start=======================================================================================
YQCONFIG_PWRLEVEL_FUNCTION_SUPPORT := false
#
#./resource/common_makefile/features.mak defined value=no
#
#
...
#[YQCONFIG_USB1_TYPE_SUPPORT]=start=======================================================================================
...
#[YQCONFIG_LONG_STARTUP_SUPPORT]=start=======================================================================================
YQCONFIG_LONG_STARTUP_SUPPORT := false
#
#./resource/common_makefile/features.mak defined value=no
#
#
...
#[YQCONFIG_MOVIE_AUTOREC_ACPLUG_SUPPORT]=start=======================================================================================
YQCONFIG_MOVIE_AUTOREC_ACPLUG_SUPPORT := false
#
#./resource/common_makefile/features.mak defined value=no
#
#
...
#[YQCONFIG_COMB_AUDIO_OUTPUT_PATH]=start=======================================================================================
YQCONFIG_COMB_AUDIO_OUTPUT_PATH := LINE
#
#./resource/common_makefile/features.mak defined YQCONFIG_COMB_AUDIO_OUTPUT_PATH=LINE
#
#
# end ========================================================================================


#[YQCONFIG_COMB_AUDIO_OUTPUT_PATH_LINE]=start=======================================================================================
YQCONFIG_COMB_AUDIO_OUTPUT_PATH_LINE := true
#
#./resource/common_makefile/features.mak defined comb marco=YQCONFIG_COMB_AUDIO_OUTPUT_PATH_LINE=1
#
#
# end ========================================================================================


#[YQCONFIG_COMB_MOVIE_LIVEVIEW]=start=======================================================================================
YQCONFIG_COMB_MOVIE_LIVEVIEW := RTSP_LIVEVIEW
#
#./resource/common_makefile/features.mak defined YQCONFIG_COMB_MOVIE_LIVEVIEW=RTSP_LIVEVIEW
#
#
# end ========================================================================================


#[YQCONFIG_COMB_MOVIE_LIVEVIEW_RTSP_LIVEVIEW]=start=======================================================================================
YQCONFIG_COMB_MOVIE_LIVEVIEW_RTSP_LIVEVIEW := true
#
#./resource/common_makefile/features.mak defined comb marco=YQCONFIG_COMB_MOVIE_LIVEVIEW_RTSP_LIVEVIEW=1
#
#
# end ========================================================================================
...
#[YQCONFIG_TOUCH_AUDIOSWITCH_OPTION]=start=======================================================================================
YQCONFIG_TOUCH_AUDIOSWITCH_OPTION := false
#
#./resource/common_makefile/default_options.mak redefined value=no
#./resource/common_makefile/features.mak defined value=no
#
# end ========================================================================================
...
#[YQCONFIG_COMB_RAM_SIZE]=start=======================================================================================
YQCONFIG_COMB_RAM_SIZE := 2G
#
#./resource/common_makefile/features.mak defined YQCONFIG_COMB_RAM_SIZE=2G
#
#
# end ========================================================================================


#[YQCONFIG_COMB_RAM_SIZE_2G]=start=======================================================================================
YQCONFIG_COMB_RAM_SIZE_2G := true
#
#./resource/common_makefile/features.mak defined comb marco=YQCONFIG_COMB_RAM_SIZE_2G=1
#
#
# end ========================================================================================


#[YQCONFIG_LCD_RESET_REVERSE_SUPPORT]=start=======================================================================================
YQCONFIG_LCD_RESET_REVERSE_SUPPORT := false
#
#./resource/common_makefile/features.mak defined value=no
#
#
...
#[YQCONFIG_UCTRL_CUSTOM_SUPPORT]=start=======================================================================================
YQCONFIG_UCTRL_CUSTOM_SUPPORT := false
#
#./resource/common_makefile/features.mak defined value=no
#
#
...
#[YQCONFIG_ADC2_FOR_KPD_SUPPORT]=start=======================================================================================
YQCONFIG_ADC2_FOR_KPD_SUPPORT := false
#
#./resource/common_makefile/features.mak defined value=no
#
#
...
#[YQCONFIG_YUANEDOG_SUPPORT]=start=======================================================================================
YQCONFIG_YUANEDOG_SUPPORT := false
#
#./resource/common_makefile/features.mak defined value=no
#
#
...
#[YQCONFIG_SDCARD_SWITCH_DETECT_SUPPORT]=start=======================================================================================
YQCONFIG_SDCARD_SWITCH_DETECT_SUPPORT := false
#
#./resource/common_makefile/features.mak defined value=no
#
#
...
#[YQCONFIG_POWER_KEY_SWITCH_LCD_TV_SUPPORT]=start=======================================================================================
YQCONFIG_POWER_KEY_SWITCH_LCD_TV_SUPPORT := false
#
#./resource/common_makefile/features.mak defined value=no
#
#
...
#[YQCONFIG_BACKCAR_DET_SUPPORT]=start=======================================================================================
YQCONFIG_BACKCAR_DET_SUPPORT := false
#
#./resource/common_makefile/features.mak defined value=no
#
#
...
#[YQCONFIG_PWRKEY_LONGPRESS_PWROFF_SUPPORT]=start=======================================================================================
YQCONFIG_PWRKEY_LONGPRESS_PWROFF_SUPPORT := false
#
#./resource/common_makefile/features.mak defined value=no
#
#
...
#[YQCONFIG_NTK2MCU_STATUS_SUPPORT]=start=======================================================================================
YQCONFIG_NTK2MCU_STATUS_SUPPORT := false
#
#./resource/common_makefile/features.mak defined value=no
#
#
...
#
#./resource/U15/base.U15.mak redefined YQCONFIG_COMB_CUST_PROJECT_NAME=U15_BASE
#./resource/U15/base.U15.mak defined YQCONFIG_COMB_CUST_PROJECT_NAME=U15_BASE
#
# end ========================================================================================


#[YQCONFIG_COMB_CUST_PROJECT_NAME_U15_BASE]=start=======================================================================================
YQCONFIG_COMB_CUST_PROJECT_NAME_U15_BASE := true
#
#./resource/U15/base.U15.mak redefined comb marco=YQCONFIG_COMB_CUST_PROJECT_NAME_U15_BASE=1
#./resource/U15/base.U15.mak defined comb marco=YQCONFIG_COMB_CUST_PROJECT_NAME_U15_BASE=1
#
# end ========================================================================================
...
#
#./resource/common_makefile/default_options.mak defined value=ALPS.MT6753.L1C.MP3.V2.62_P1
#
#
# end ========================================================================================


#[YQCONFIG_SW_ENGINEER_BUILD_VERSION]=start=======================================================================================
YQCONFIG_SW_ENGINEER_BUILD_VERSION := ..ALPS.MT6753.L1C.MP3.V2.62_P1
#
#./resource/common_makefile/default_options.mak defined value={YQCONFIG_SW_ENGINEER_VERSION}.{YQCONFIG_COMPILEMODE}.{YQCONFIG_PLAT_VERSION}
#
#
# end ========================================================================================
...
YQ_AUTO_ADD_GLOBAL_DEFINE_BY_STRING := YQCONFIG_CUSTOM_VERSION_NAME
