...
YQCONFIG_LCD_CUST = Disp_IFDSI_LCD1_TG078UW006A0
            							# Option1:Disp_IFDSI_LCD1_TWJ50IP008_ILI9806E//Disp_IFDSI_LCD1_TG078UW006A0 //Disp_IFDSI_LCD1_QiCheng     
            							# Option2:OFF
...
#****************************************************************************************#
YQCONFIG_COMB_CUST_PROJECT_NAME = U05_BASE
								# YQCONFIG_COMB_CUST_PROJECT_NAME_K40_BASE
            							# Option1:K40_BASE
            							# Option2:DIDI_BASE
YQCONFIG_CUSTOM_VERSION_NAME = "R104.public"
            							# Option1:.AMX
            							# Option2:.public            							
...
YQCONFIG_UART_TO_MCU_SUPPORT = yes
								# Option1:yes
            							# Option2:no  

            							
YQCONFIG_COMB_DET_BACKCAR_BY = GPIO
								# Option1:GPIO
            							# Option2:UART
            							# Option3:NONE 
...
YQCONFIG_LED_FUNCTION_SUPPORT = yes	    
 ...
 YQCONFIG_TP_EVENT_LOCK_SUPPORT = yes	    
            							# Option1:yes
            							# Option2:no   
