...
YQCONFIG_LCD_CUST = Disp_IFDSI_LCD1_TM686B18BA139_EK79030      
...
#****************************************************************************************#
YQCONFIG_COMB_CUST_PROJECT_NAME = U10_BASE
								# YQCONFIG_COMB_CUST_PROJECT_NAME_K40_BASE
            							# Option1:K40_BASE
            							# Option2:DIDI_BASE
YQCONFIG_CUSTOM_VERSION_NAME = "U10.public"
            							# Option1:.AMX
            							# Option2:.public            							
...
YQCONFIG_TOUCH_TO_MTK_PLAYSOUND_OPTION = yes
            							# Option1:yes
            							# Option2:no    
YQCONFIG_UVC_FUNCTION_OPTION = yes
            							# Option1:yes
            							# Option2:no  
YQCONFIG_UVC_AUTO_OPTION = yes
            							# Option1:yes
            							# Option2:no              							