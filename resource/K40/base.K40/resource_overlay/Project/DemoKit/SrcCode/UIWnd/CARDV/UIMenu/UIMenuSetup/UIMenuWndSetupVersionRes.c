...
SHOW_ITEM_GROUP(CMD_Group,Normal4,324,194,543,221)
...
CREATE_STATIC_CTRL(UIMenuSetupVersionText,0,324,194,543,221)
...
SHOW_ITEM_GROUP(CMD_Group,Normal9,325,245,544,272)
...
CREATE_STATIC_CTRL(UIMenuSetupVersionText2,0,325,245,544,272)
