...
enum _MENU_IDS
{
    ...
    IDS_MOVIE_CLOUDDOG    = STRID_CLOUD,
    ...
    IDS_MOVIE_PARKING_ON= STRID_OFF,
    ...
    IDS_MOVIE_CLOUDDOG_OFF = STRID_OFF,
    IDS_MOVIE_CLOUDDOG_ON = STRID_ON,
...
enum _MENU_IDI
{
    ...
    IDI_MOVIE_PARKING    = ICON_PARKING_MONITOR,
    IDI_MOVIE_GSENSOR    = ICON_G_SENSOR,
    IDI_MOVIE_CLOUDDOG    = ICON_CLOUD_ON,
...
enum _MENU_IDF
{
    ...
    IDF_MOVIE_GSENSOR                    = FL_MOVIE_GSENSOR,
    IDF_MOVIE_PARKING                   = FL_MOVIE_PARKING,
     IDF_MOVIE_CLOUDDOG                   = FL_MOVIE_CLOUDDOG,
