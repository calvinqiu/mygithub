...
SHOW_ITEM_GROUP(CMD_Group,Normal13,679,5,786,32)
...
CREATE_STATIC_CTRL(UIFlowWndPhoto_StaticTXT_FreePic,0,679,5,786,32)
...
SHOW_ITEM_GROUP(CMD_Group,Normal41,679,38,786,65)
...
CREATE_STATIC_CTRL(UIFlowWndPhoto_StaticTXT_Size,0,679,38,786,65)
...
SHOW_ITEM_GROUP(CMD_Group,Normal59,759,104,786,131)
...
CREATE_STATE_CTRL(UIFlowWndPhoto_StatusICN_FD,0,759,104,786,131)
...
SHOW_ITEM_GROUP(CMD_Group,Normal65,759,71,786,98)
...
CREATE_STATE_CTRL(UIFlowWndPhoto_StatusICN_Quality,0,759,71,786,98)
...
SHOW_ITEM_GROUP(CMD_Group,Normal71,759,399,786,426)
...
CREATE_STATE_CTRL(UIFlowWndPhoto_StatusICN_Storage,0,759,399,786,426)
...
SHOW_ITEM_GROUP(CMD_Group,Normal82,759,439,790,466)
...
CREATE_STATE_CTRL(UIFlowWndPhoto_StatusICN_Battery,0,759,439,790,466)
...
SHOW_ITEM_GROUP(CMD_Group,Skin97,0,0,799,479)
