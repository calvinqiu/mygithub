...
//-----------------------------------------------------------------------------
// MTK Menu Setting Resq
//-----------------------------------------------------------------------------
enum _MTK_MENU_RESQ
{
    MTK_MENU_RESQ_SUCCESS = 0,
    MTK_MENU_RESQ_FAIL,
    MTK_MENU_RESQ_KEEP,
    MTK_MENU_RESQ_MAX
};
...
enum MTK_MENU_SETTING
{
	MENU_MOVIE_RESOLUTION=0x00,
	MENU_MOVIE_CYCLE_RECORD,
	MENU_MOVIE_HDR,
	MENU_MOVIE_MOTION_DET,
	MENU_MOVIE_GSENSOR,
	MENU_MOVIE_PARKINGMODE,
	MENU_MOVIE_ADAS,		
	MENU_ADAS_SPEED_TRR,	
#if defined(YQCONFIG_AUDIO_MIC_SWITCH_SUPPORT)
	MENU_AUDIO_RECORD_SWITCH,	//pgl 20160628 add
#endif
	MENU_VERSION1,
	MENU_VERSION2,	
	MENU_MCUVERSION1,
	MENU_MCUVERSION2,
	MENU_MTK_SETTING_MAX
};
...
typedef enum 
{
    TOUCH_KEY_STATUS_PRESSED,
    TOUCH_KEY_STATUS_RELEASED,
    TOUCH_GESTURE_RIGHT2LEFT,
    TOUCH_GESTURE_LEFT2RIGHT,
    TOUCH_GESTURE_DOWN2UP,
    TOUCH_GESTURE_UP2DOWN,    
    TOUCH_STATUS_MAX
}TOUCH_KEY_STATUS;


typedef struct _IMG_CAP_DATA_
{
    UINT32 PriBS_Addr;
    UINT32 PriBS_Size; 
    UINT32 ScrBS_Addr;
