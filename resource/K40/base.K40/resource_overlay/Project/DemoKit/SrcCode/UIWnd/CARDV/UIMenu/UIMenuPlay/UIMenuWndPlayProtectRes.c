...
SHOW_ITEM_RECT(CMD_Rectangle,Rect4,0,0,248,158,272,0,5,0,0,0,0)
...
SHOW_ITEM_RECT(CMD_Rectangle,Skin6Rect,0,0,215,37,0,0,0,0,0,0,0)
...
CREATE_CTRL(UIMenuWndPlayProtect,UIMenuWndPlayProtect,CTRL_WND,NULL,0 ,0,0,799,479)
#endif
