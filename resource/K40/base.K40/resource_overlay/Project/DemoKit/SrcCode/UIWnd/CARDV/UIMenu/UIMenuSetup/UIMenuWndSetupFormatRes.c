...
SHOW_ITEM_GROUP(CMD_Group,Normal4,326,185,541,222)
...
SHOW_ITEM_GROUP(CMD_Group,Focused8,326,185,541,222)
...
SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text22,0,0,215,37,STRID_NULL,0,0,0,0,2,1,1,0,0,17,0,0,0,0)
SHOW_MAP_BEGIN(Normal_Disable19)
SHOW_MAP_BODY(Skin20)
SHOW_MAP_BODY(Text22)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal_Disable19,326,185,541,222)
...
SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text26,0,0,215,37,STRID_NULL,0,0,0,0,2,1,1,0,0,17,0,0,0,0)
SHOW_MAP_BEGIN(Focused_Disable23)
SHOW_MAP_BODY(Skin24)
SHOW_MAP_BODY(Text26)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Focused_Disable23,326,185,541,222)
...
SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text30,0,0,215,37,STRID_NULL,0,0,0,0,2,1,1,0,0,17,0,0,0,0)
SHOW_MAP_BEGIN(Pressed27)
SHOW_MAP_BODY(Skin28)
SHOW_MAP_BODY(Text30)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Pressed27,326,185,541,222)
...
CREATE_LIST_CTRL(UIMenuWndSetupFormat_List_Text,UIMenuWndSetupFormat_List_Text,0,326,185,541,222)
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
CREATE_CTRL(UIMenuWndSetupFormat,UIMenuWndSetupFormat,CTRL_WND,NULL,0 ,0,0,799,479)
#endif
