...
SHOW_ITEM_GROUP(CMD_Group,Normal6,12,109,39,136)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_Flash,0,12,109,39,136)
...
SHOW_ITEM_GROUP(CMD_Group,Normal29,679,32,786,59)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticTXT_Size,0,679,32,786,59)
...
SHOW_ITEM_GROUP(CMD_Group,Normal42,759,60,786,87)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_Quality,0,759,60,786,87)
...
SHOW_ITEM_GROUP(CMD_Group,Normal48,759,92,786,119)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_Sharpness,0,759,92,786,119)
...
SHOW_ITEM_GROUP(CMD_Group,Normal54,759,399,786,426)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_Storage,0,759,399,786,426)
...
SHOW_ITEM_GROUP(CMD_Group,Normal59,759,439,790,466)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_Battery,0,759,439,790,466)
...
SHOW_ITEM_RECT(CMD_Rectangle,Skin70Rect,0,0,259,27,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin70)
SHOW_MAP_BODY(Skin70Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin70,0,0,259,27)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text72,0,0,259,27,STRID_NULL,0,1280,0,0,2,1,1,0,0,16,0,0,0,0)
SHOW_MAP_BEGIN(Normal69)
SHOW_MAP_BODY(Skin70)
SHOW_MAP_BODY(Text72)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal69,126,5,385,32)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticTXT_Filename,0,126,5,385,32)
...
SHOW_ITEM_GROUP(CMD_Group,Normal74,50,5,77,32)
...
SHOW_ITEM_RECT(CMD_Rectangle,Skin79Rect,0,0,79,27,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin79)
SHOW_MAP_BODY(Skin79Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin79,0,0,79,27)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text81,0,0,79,27,STRID_NULL,0,1280,0,0,2,1,1,0,0,16,0,0,0,0)
SHOW_MAP_BEGIN(Normal78)
SHOW_MAP_BODY(Skin79)
SHOW_MAP_BODY(Text81)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal78,250,439,329,466)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticTXT_Date,0,250,439,329,466)

//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@

SHOW_ITEM_RECT(CMD_Rectangle,Skin84Rect,0,0,59,27,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Skin84)
SHOW_MAP_BODY(Skin84Rect)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Skin84,0,0,59,27)

SHOW_ITEM_TEXT(CMD_Text|CMD_ITEM,Text86,0,0,59,27,STRID_NULL,0,1280,0,0,2,1,1,0,0,16,0,0,0,0)
SHOW_MAP_BEGIN(Normal83)
SHOW_MAP_BODY(Skin84)
SHOW_MAP_BODY(Text86)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal83,356,439,415,466)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticTXT_Time,0,356,439,415,466)
...
SHOW_ITEM_GROUP(CMD_Group,Normal89,5,439,58,466)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_MovPlay,0,5,439,58,466)
...
SHOW_ITEM_GROUP(CMD_Group,Normal94,63,439,116,466)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_MovStop,0,63,439,116,466)
...
SHOW_ITEM_GROUP(CMD_Group,Normal98,122,439,175,466)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_MovBwd,0,122,439,175,466)
...
SHOW_ITEM_GROUP(CMD_Group,Normal107,181,439,234,466)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_MovFwd,0,181,439,234,466)
...
SHOW_ITEM_GROUP(CMD_Group,Normal111,12,399,123,426)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_Volumn,0,12,399,123,426)
...
SHOW_ITEM_GROUP(CMD_Group,Normal123,12,147,39,174)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticICN_Print,0,12,147,39,174)
...
SHOW_ITEM_GROUP(CMD_Group,Normal127,140,399,199,426)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticTXT_Speed,0,140,399,199,426)
