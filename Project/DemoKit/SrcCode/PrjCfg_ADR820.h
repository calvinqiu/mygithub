...
#define POWEROFFLOGO_FUNCTION           DISABLE//ENABLE//DISABLE //ENABLE
#if ((POWERON_FAST_BOOT == ENABLE) || (POWERON_FAST_RECORD == ENABLE))
#define POWERONSOUND_FUNCTION           DISABLE
#else
#define POWERONSOUND_FUNCTION           DISABLE//ENABLE
#endif
#define POWEROFFSOUND_FUNCTION          DISABLE//ENABLE
...
#if((_MODEL_DSC_ == _MODEL_DEMO1_||_MODEL_DSC_ == _MODEL_ADR820D_) && _USB1_TYPE_ != _USB1_HOST_)
...
//#NT#SD_HOTPLUG
#define SDHOTPLUG_FUNCTION              DISABLE //Not Yet, Dont Enable it
//#NT#2016/09/19#Niven Cho -end
//..............................................................................
#define USE_FILEDB                      ENABLE //DISABLE
#define FILEDB_CARDV_ROOT               "ADR820"   // the max length should not exceeds 16
// DCF/EXIF Config
...
//..............................................................................
// Other Config
#if(_MODEL_DSC_ == _MODEL_ADR820D_)
#define GSENSOR_FUNCTION                ENABLE  //G-sensor
#define GSENSOR_INT						DISABLE
#else
...
#define WAVEGUARD_FNUCTION              DISABLE

#define CUSTOM_TIMER_FUNCTION           ENABLE
...
#define WATERLOGO_FUNCTION              ENABLE//DISABLE  // Enable/Disable waterlogo function
#define WATERLOGO_BEHIND_CAM_FUNCTION   DISABLE//DISABLE
// Important Notice:
...
#define MOVIE_ENSURE_SD_CLASS4          DISABLE//DISABLE
#define MOVIE_ENSURE_SD_32KCLUSTER      DISABLE//DISABLE
