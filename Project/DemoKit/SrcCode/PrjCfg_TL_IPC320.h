...
#define FW_VERSION_NUM              "REGULAR_0621_OK1"

//..............................................................................
// Memory Partition
#define MEM_DRAM_ADDR                   0x80000000  //cached region of MIPS

#if (_MODEL_DSC_ == _MODEL_TL_IPC320_)
#define MEM_DRAM_SIZE                   ALIGN_CEIL_32(0x8000000) //DRAM size
#else
#define MEM_DRAM_SIZE                   ALIGN_CEIL_32(0x10000000) //DRAM size
#endif
...
*/
#if (MEM_DRAM_SIZE == ALIGN_CEIL_32(0x10000000))
#if (_CPU2_TYPE_==_CPU2_LINUX_ && _DSP_TYPE_== _DSP_NONE_)
#define COREMEM_LINUX_ADDR              0x88000000
#define COREMEM_LINUX_SIZE              0x08000000
...
#define COREMEM_LINUX_ADDR              0x88000000
#define COREMEM_LINUX_SIZE              0x07F00000
#define COREMEM_DSP_ADDR                0x8FF00000
#define COREMEM_DSP_SIZE                0x00100000
//Sub-Address in address range of linux
#define COREMEM_LINUX_SUBADDR_ROOTFS    DISABLE
#define COREMEM_LINUX_SUBADDR_UIMAGE    0x8F000000
#define COREMEM_LINUX_SUBADDR_UBOOT     0x8F400000
...
#if (_CPU2_TYPE_==_CPU2_LINUX_ && _DSP_TYPE_== _DSP_NONE_)
#define COREMEM_LINUX_ADDR              0x84C00000
#define COREMEM_LINUX_SIZE              0x03400000
//Sub-Address in address range of linux
#define COREMEM_LINUX_SUBADDR_ROOTFS    DISABLE
...
#elif (_CPU2_TYPE_==_CPU2_LINUX_ && _DSP_TYPE_== _DSP_FREERTOS_)
#define COREMEM_LINUX_ADDR              0x84C00000
#define COREMEM_LINUX_SIZE              0x03300000
#define COREMEM_DSP_ADDR                0x87F00000
#define COREMEM_DSP_SIZE                0x00100000
//Sub-Address in address range of linux
#define COREMEM_LINUX_SUBADDR_ROOTFS    DISABLE
#define COREMEM_LINUX_SUBADDR_UIMAGE    0x87000000
...
#define LINUX_LOAD_BY_UBOOT             ENABLE
...
//#NT#2016/08/05#David Tsai -begin
//#NT#Support 3/4/5M resolution
#if (_MODEL_DSC_ == _MODEL_TL_IPC350_)
#define CROP_SOURCE_W                   2560
#define CROP_SOURCE_H                   1920
#elif (_MODEL_DSC_ == _MODEL_TL_IPC340_)
#define CROP_SOURCE_W                   2560
#define CROP_SOURCE_H                   1440
...
#define MOVIE_PATH1_MAX_TBR             1500*1024
#else
