...
extern BOOL MovieExe_IsAdasFuncSupported(void);
...
typedef enum
{
    ...
    //#NT# support sbs mode
    NVTEVT_EXE_MOVIE_SBS_MODE   = 0x14001116,
...
extern void UIMovie_RawEncCB(UINT32 uiEventID, UINT32 uiPathID);
...
extern void UIVAStrm_UpdParamsCB(UINT32 path);
