...
//    UINT32  ui3DNRLevel;
    ...
    iAE_AVG=AE_getCurLum(0,12);

    AE_GetPrvAEArg(0,&uiISO1, &uiExpT1, &uiIris1);
...
//
//-------------------------------------------------------------------------------------------------
#elif ((defined(_SENSORLIB_CMOS_AR0330M_)&& (_SENSORLIB_ == _SENSORLIB_CMOS_AR0330M_)) || \
        (defined(_SENSORLIB_CMOS_AR0330P_) && (_SENSORLIB_ == _SENSORLIB_CMOS_AR0330P_)) || \
        (defined(_SENSORLIB_CMOS_OV2710_) && (_SENSORLIB_ == _SENSORLIB_CMOS_OV2710_)))
UINT32 UIMovie_3DNRAdjust(void)
{
    UINT32  uiISO1, uiExpT1, uiIris1;
    UINT32  ui3DNRLevel;
