...
WIFI_CMD_ITEM(WIFIAPP_CMD_MOVIE_RTSP_AUD_CTRL      ,NVTEVT_WIFI_EXE_MOVIE_RTSP_AUD_CTRL, 0, 0, FL_NULL)
...
WIFI_CMD_ITEM(WIFIAPP_CMD_GET_SBS_CAL, 0, (UINT32)XML_GetSbsCalFromPstore, 0, FL_NULL)
#endif
