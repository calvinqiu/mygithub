...
{ \
    ImageUnit_Begin((pUnit), 0); \
        ImageUnit_CfgWindow(ISF_IN1, (CurIdx), ISF_VALUE_KEEP, ISF_VALUE_KEEP, ISF_VALUE_KEEP); \
    ImageUnit_End(); \
