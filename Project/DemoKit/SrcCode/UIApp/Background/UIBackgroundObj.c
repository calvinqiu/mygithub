...
UINT32 Background_CopyTo(BOOL isCopyToCard,UINT32 copMode)
{
    ...
    UINT32 uiTempBufAddr, uiTempBufSize, uiTempBufEnd;
    ...
    if (isCopyToCard)
    {
        ...
        pOriDXH = pDstDXH;
        // --> TODO:remove begin
        #if (_INTERSTORAGE_ == _INTERSTORAGE_NAND_ || _INTERSTORAGE_ == _INTERSTORAGE_SPINAND_)
        {
...
static UINT32 BackgroundFWUpdate(void)
{
    return System_OnStrg_UploadFW(0);
}
