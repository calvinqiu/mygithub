...
typedef enum
{
    ...
    NVTEVT_EXE_UPDATEUIINFO              = 0x14002117,
    NVTEVT_EXE_UPDATEUIINFO1              = 0x14002118,   
    /* INSERT NEW EVENT HRER */
...
extern void PhotoExe_CfgNetHttp(USIZE HttpLviewSize);
extern void PhotoExe_CfgNetHttpPIP(USIZE HttpLviewSize,UINT32 dualCam);
