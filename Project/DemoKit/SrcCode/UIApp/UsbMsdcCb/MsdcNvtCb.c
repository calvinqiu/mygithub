...
//#NT#AUTO_TEST
	...
	|| _MODEL_DSC_ == _MODEL_EVB_)
#define CFG_MSDC_NVT_CB_EXAM    ENABLE
#define CFG_MSDC_NVT_CB_EXAM_TYPE "TARGET" // "TARGET" or "MONITOR"
#else
...
static void xMsdcNvtCb_Init(void)
{
    ...
    if(m_bInit == FALSE)
    {
		...
		MsdcNvtCb_ExamSetName(CFG_MSDC_NVT_CB_EXAM_TYPE);
		MsdcNvtRegBi_Exam();
