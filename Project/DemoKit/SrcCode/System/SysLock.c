...
UINT32 UI_IsForceLockAutoSleep(void){return bDetect_LockSleep;}
UINT32 UI_IsForceLockAutoPWROff(void){return bDetect_LockAutoPWROff;}
void UI_LockAutoSleep(void){bDetect_LockSleep = TRUE;}
void UI_LockAutoPWROff(void){bDetect_LockAutoPWROff = TRUE;}
void UI_UnlockAutoSleep(void){bDetect_LockSleep = FALSE;}
void UI_UnlockAutoPWROff(void){bDetect_LockAutoPWROff = FALSE;}

UINT32 UI_IsForceLockStatus(void){return bDetect_ForceLockStatus;}
UINT32 UI_IsForceLock(void){return bDetect_ForceLock;}
