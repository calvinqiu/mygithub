...
//#NT#2016/05/03#KCHong#[0099778] -begin
//#NT#Force change mode if FC/LD setting is changed
#include "ImageUnit_ADAS.h"
//#NT#2016/05/03#KCHong#[0099778] -end
...
BOOL MenuCommonItem_CheckReOpenItem(void)
{
...
INT32 MenuCommonItem_OnOpen(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    ...
    if(System_GetEnableSensor() == (SENSOR_1|SENSOR_2))
    {
        ...
        TM_SetOptionStatus(&gMovieMenu,IDM_MOVIE_SIZE,MOVIE_SIZE_FRONT_2880x2160P24,TM_OPTION_DISABLE);
        TM_SetOptionStatus(&gMovieMenu,IDM_MOVIE_SIZE,MOVIE_SIZE_FRONT_2560x1440P30,TM_OPTION_DISABLE);
    }
    else
    {
        ...
        TM_SetOptionStatus(&gMovieMenu,IDM_MOVIE_SIZE,MOVIE_SIZE_FRONT_2880x2160P24,TM_OPTION_ENABLE);
        TM_SetOptionStatus(&gMovieMenu,IDM_MOVIE_SIZE,MOVIE_SIZE_FRONT_2560x1440P30,TM_OPTION_ENABLE);
        #endif
