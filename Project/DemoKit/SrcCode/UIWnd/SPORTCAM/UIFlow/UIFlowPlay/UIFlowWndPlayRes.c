...
SHOW_ITEM_GROUP(CMD_Group,Normal3,569,558,618,607)
...
SHOW_ITEM_GROUP(CMD_Group,Focused6,569,558,618,607)
...
SHOW_ITEM_GROUP(CMD_Group,Normal_Disable9,569,558,618,607)
...
SHOW_ITEM_GROUP(CMD_Group,Focused_Disable12,569,558,618,607)
...
SHOW_ITEM_GROUP(CMD_Group,Pressed15,569,558,618,607)
...
SHOW_ITEM_GROUP(CMD_Group,Normal19,514,558,563,607)
...
SHOW_ITEM_GROUP(CMD_Group,Focused22,514,558,563,607)
...
SHOW_ITEM_GROUP(CMD_Group,Normal_Disable25,514,558,563,607)
...
SHOW_ITEM_GROUP(CMD_Group,Focused_Disable28,514,558,563,607)
...
SHOW_ITEM_GROUP(CMD_Group,Pressed31,514,558,563,607)
...
SHOW_ITEM_GROUP(CMD_Group,Normal35,624,558,673,607)
...
SHOW_ITEM_GROUP(CMD_Group,Focused38,624,558,673,607)
...
SHOW_ITEM_GROUP(CMD_Group,Normal_Disable41,624,558,673,607)
...
SHOW_ITEM_GROUP(CMD_Group,Focused_Disable44,624,558,673,607)
...
SHOW_ITEM_GROUP(CMD_Group,Pressed47,624,558,673,607)
...
SHOW_ITEM_GROUP(CMD_Group,Normal51,569,503,618,552)
...
SHOW_ITEM_GROUP(CMD_Group,Focused54,569,503,618,552)
...
SHOW_ITEM_GROUP(CMD_Group,Normal_Disable57,569,503,618,552)
...
SHOW_ITEM_GROUP(CMD_Group,Focused_Disable60,569,503,618,552)
...
SHOW_ITEM_GROUP(CMD_Group,Pressed63,569,503,618,552)
...
SHOW_ITEM_GROUP(CMD_Group,Normal67,569,613,618,662)
...
SHOW_ITEM_GROUP(CMD_Group,Focused70,569,613,618,662)
...
SHOW_ITEM_GROUP(CMD_Group,Normal_Disable73,569,613,618,662)
...
SHOW_ITEM_GROUP(CMD_Group,Focused_Disable76,569,613,618,662)
...
SHOW_ITEM_GROUP(CMD_Group,Pressed79,569,613,618,662)
...
CREATE_TAB_CTRL(UIFlowWndPlay_TabNavi,UIFlowWndPlay_TabNavi,0,512,500,513,501)
...
SHOW_ITEM_GROUP(CMD_Group,Normal83,224,500,273,549)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticICN_DSCMode,0,224,500,273,549)
...
SHOW_ITEM_GROUP(CMD_Group,Normal87,262,5,289,32)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_Flash,0,262,5,289,32)
...
SHOW_ITEM_GROUP(CMD_Group,Normal94,292,5,319,32)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_EV,0,292,5,319,32)
...
SHOW_ITEM_GROUP(CMD_Group,Normal110,744,40,851,67)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticTXT_Size,0,744,40,851,67)
...
SHOW_ITEM_GROUP(CMD_Group,Normal115,322,5,349,32)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_WB,0,322,5,349,32)
...
SHOW_ITEM_GROUP(CMD_Group,Normal123,382,5,409,32)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_Quality,0,382,5,409,32)
...
SHOW_ITEM_GROUP(CMD_Group,Normal129,412,5,439,32)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_Sharpness,0,412,5,439,32)
...
SHOW_ITEM_GROUP(CMD_Group,Normal135,442,5,469,32)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_Storage,0,442,5,469,32)
...
SHOW_ITEM_GROUP(CMD_Group,Normal140,836,443,867,470)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_Battery,0,836,443,867,470)
...
SHOW_ITEM_GROUP(CMD_Group,Normal149,744,130,851,157)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticTXT_Filename,0,744,130,851,157)
...
SHOW_ITEM_GROUP(CMD_Group,Normal154,350,5,377,32)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticICN_Protect,0,350,5,377,32)
...
SHOW_ITEM_GROUP(CMD_Group,Normal168,660,5,769,32)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticTXT_MovPlayTime,0,660,5,769,32)
...
SHOW_ITEM_GROUP(CMD_Group,Normal173,300,350,455,377)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticTXT_LeftBtn,0,300,350,455,377)
...
SHOW_ITEM_GROUP(CMD_Group,Normal179,470,350,615,377)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticTXT_RightBtn,0,470,350,615,377)
...
SHOW_ITEM_GROUP(CMD_Group,Skin187,0,0,69,69)

SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon188, 0, 0, 69,69, ICONID_NULL,0,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Normal186)
SHOW_MAP_BODY(Skin187)
SHOW_MAP_BODY(Icon188)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal186,397,390,466,459)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_MovPlay,0,397,390,466,459)
...
SHOW_ITEM_GROUP(CMD_Group,Skin194,0,0,69,69)

SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon195, 0, 0, 69,69, ICONID_NULL,0,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Normal193)
SHOW_MAP_BODY(Skin194)
SHOW_MAP_BODY(Icon195)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal193,637,390,706,459)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_MovStop,0,637,390,706,459)
...
SHOW_ITEM_GROUP(CMD_Group,Skin199,0,0,69,69)

SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon200, 0, 0, 69,69, ICONID_NULL,0,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Normal198)
SHOW_MAP_BODY(Skin199)
SHOW_MAP_BODY(Icon200)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal198,277,390,346,459)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_MovBwd,0,277,390,346,459)
...
SHOW_ITEM_GROUP(CMD_Group,Skin204,0,0,69,69)

SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon205, 0, 0, 69,69, ICONID_NULL,0,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Normal203)
SHOW_MAP_BODY(Skin204)
SHOW_MAP_BODY(Icon205)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal203,517,390,586,459)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_MovFwd,0,517,390,586,459)
...
SHOW_ITEM_GROUP(CMD_Group,Normal208,800,206,821,335)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_Volumn,0,800,206,821,335)
...
SHOW_ITEM_GROUP(CMD_Group,Skin230,0,0,69,69)

SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon231, 0, 0, 69,69, ICONID_NULL,0,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Normal229)
SHOW_MAP_BODY(Skin230)
SHOW_MAP_BODY(Icon231)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal229,20,400,89,469)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_ChangeMode,0,20,400,89,469)
...
SHOW_ITEM_GROUP(CMD_Group,Skin235,0,0,69,69)

SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon236, 0, 0, 69,69, ICONID_NULL,0,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Normal234)
SHOW_MAP_BODY(Skin235)
SHOW_MAP_BODY(Icon236)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal234,20,225,89,294)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_FileList,0,20,225,89,294)
...
SHOW_ITEM_GROUP(CMD_Group,Skin240,0,0,69,69)

SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon241, 0, 0, 69,69, ICONID_NULL,0,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Normal239)
SHOW_MAP_BODY(Skin240)
SHOW_MAP_BODY(Icon241)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal239,20,50,89,119)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_Thumbnail,0,20,50,89,119)
...
SHOW_ITEM_GROUP(CMD_Group,Normal244,770,5,851,32)
...
CREATE_STATIC_CTRL(UIFlowWndPlay_StaticTXT_MovTotalTime,0,770,5,851,32)
...
SHOW_ITEM_GROUP(CMD_Group,Skin250,0,0,68,68)

SHOW_ITEM_IMAGE(CMD_Image|CMD_ITEM,Icon251, 0, 0, 68,68, ICONID_NULL,0,0,0,0,0,0,0,0)
SHOW_MAP_BEGIN(Normal249)
SHOW_MAP_BODY(Skin250)
SHOW_MAP_BODY(Icon251)
SHOW_MAP_END

SHOW_ITEM_GROUP(CMD_Group,Normal249,20,50,88,118)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_Delete,0,20,50,88,118)
...
SHOW_ITEM_GROUP(CMD_Group,Normal254,800,340,821,361)
...
CREATE_STATE_CTRL(UIFlowWndPlay_StatusICN_Speaker,0,800,340,821,361)
...
CREATE_CTRL(UIFlowWndPlay,UIFlowWndPlay,CTRL_WND,NULL,0 ,0,0,863,479)
#endif
