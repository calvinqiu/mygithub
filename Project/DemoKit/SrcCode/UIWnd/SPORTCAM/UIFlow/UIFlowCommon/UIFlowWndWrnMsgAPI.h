...
typedef enum
{
    ...
    FLOWWRNMSG_ISSUE_CHECK_SECOND_SENSOR = STRID_CHECK_SECONDERY_SENSOR,
    FLOWWRNMSG_ISSUE_CHECK_ADAS = STRID_ADAS_NOT_SUPPORTED,        	    	
    ...
    FLOWWRNMSG_ISSUE_RAWENC=STRID_RAWENC,
...
#define UIFlowWndWrnMsg_StatusTXT_Msg_STRID_CHECK_SECOND_SENSOR           FLOWWRNMSG_ISSUE_CHECK_SECOND_SENSOR
#define UIFlowWndWrnMsg_StatusTXT_Msg_STRID_CHECK_ADAS          FLOWWRNMSG_ISSUE_CHECK_ADAS
#define UIFlowWndWrnMsg_StatusTXT_Msg_STRID_RAWENC      FLOWWRNMSG_ISSUE_RAWENC
//#NT#2016/03/07#KCHong -begin
//#NT#Low power timelapse function
#if (TIMELAPSE_LPR_FUNCTION == ENABLE)
