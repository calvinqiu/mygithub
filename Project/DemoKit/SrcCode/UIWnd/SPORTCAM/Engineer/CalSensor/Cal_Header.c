...
#elif   (_IPPLIB_ == _IPL_MN34120_EVB_FF_)

    ER Set2Preview(IPL_PROC_ID Id, UINT32 IplNum, UINT32 BufAddr,UINT32 BufSize)
    {
        extern ER Set2Preview_MN34120_EVB_FF(IPL_PROC_ID Id, UINT32 IplNum, UINT32 BufAddr,UINT32 BufSize) ;
        return Set2Preview_MN34120_EVB_FF(Id, IplNum, BufAddr,BufSize);
    }

    pCAL_ITEM_OBJ CAL_ITEM(IPL_PROC_ID Id)
    {
        extern pCAL_ITEM_OBJ CAL_ITEM_MN34120_EVB_FF(IPL_PROC_ID Id) ;
        return CAL_ITEM_MN34120_EVB_FF(Id);
    }

    BOOL CAL_ReadDebugConfig(void)
    {
        extern BOOL CAL_ReadDebugConfig_MN34120_EVB_FF(void);
        return CAL_ReadDebugConfig_MN34120_EVB_FF();
    }
