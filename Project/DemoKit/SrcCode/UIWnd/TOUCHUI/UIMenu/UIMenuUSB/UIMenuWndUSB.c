...
INT32 UIMenuWndUSB_Item_OnTouchPanelClick(VControl *, UINT32, UINT32 *);
...
EVENT_ITEM(NVTEVT_CLICK,UIMenuWndUSB_Item_OnTouchPanelClick)
EVENT_END
...
INT32 UIMenuWndUSB_Item_OnTouchPanelClick(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    UINT32  item;
