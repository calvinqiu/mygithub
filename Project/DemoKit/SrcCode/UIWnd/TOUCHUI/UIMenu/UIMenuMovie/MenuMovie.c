...
TMDEF_BEGIN_OPTIONS(MOVIE_SIZE)
    ...
    TMDEF_OPTION_TEXT_S(MOVIE_SIZE_FRONT_2304x1296P30,TM_OPTION_NOT_SUPPORT) //3MHD P30
    TMDEF_OPTION_TEXT_S(MOVIE_SIZE_FRONT_1920x1080P96,TM_OPTION_NOT_SUPPORT) //FHD
    TMDEF_OPTION_TEXT_S(MOVIE_SIZE_FRONT_1920x1080P60,TM_OPTION_NOT_SUPPORT)  //FHD
    TMDEF_OPTION_TEXT_S(MOVIE_SIZE_FRONT_1920x1080P30,TM_OPTION_ENABLE)  //FHD
...
TMDEF_BEGIN_OPTIONS(MOVIE_TIMELAPSE_REC)
    ...
    TMDEF_OPTION_TEXT_S(MOVIE_TIMELAPSE_REC_2HOUR,TM_OPTION_ENABLE)
    TMDEF_OPTION_TEXT_S(MOVIE_TIMELAPSE_REC_3HOUR,TM_OPTION_ENABLE)
    TMDEF_OPTION_TEXT_S(MOVIE_TIMELAPSE_REC_1DAY,TM_OPTION_ENABLE)
TMDEF_END_OPTIONS()
