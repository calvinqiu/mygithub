...
#if (_MODEL_DSC_ == _MODEL_TWIN_360_) // TWIN_360 requests two 1248x1080 to combine to one 2496x1080
    [MOVIE_SIZE_DUAL_1920x1080P30_1920x1080P30] = {
        MOVIE_REC_TYPE_DUAL,
        {2496,  1080,   30,     1800*1024,  VIDENC_DAR_DEFAULT, IMAGERATIO_16_9},
        {2496,  1080,   30,     1800*1024,  VIDENC_DAR_DEFAULT, IMAGERATIO_16_9},
    },
...
//#NT#2015/04/25#ML Cui -end
    ...
    [MOVIE_SIZE_CLONE_1920x1080P30_848x480P30] = {
        MOVIE_REC_TYPE_CLONE,
        {2496, 1080,    30,     1800*1024,  VIDENC_DAR_DEFAULT, IMAGERATIO_16_9},
        {1120,  480,    30,     500*1024,   VIDENC_DAR_DEFAULT, IMAGERATIO_16_9},
    },
#else
    [MOVIE_SIZE_CLONE_1920x1080P30_848x480P30] = {
        MOVIE_REC_TYPE_CLONE,
    ...
    [MOVIE_SIZE_CLONE_2048x2048P30_480x480P30] = {
        ...
        { 480,  480,    30,     500*1024,   VIDENC_DAR_DEFAULT, IMAGERATIO_1_1},
    },
