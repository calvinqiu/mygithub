...
extern VControl UIFlowWndMovie_BTN_DscModeCtrl;//Static type
...
typedef enum
{
UIFlowWndMovie_StatusICN_SNG_Alert_ICON_SNG_STOP_ALERT,
UIFlowWndMovie_StatusICN_SNG_Alert_ICON_SNG_GO_ALERT,
