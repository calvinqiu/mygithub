...
void FlowMovie_IconDrawSetup(VControl *pCtrl)
{
    UxCtrl_SetShow(pCtrl, TRUE);
}

void FlowMovie_IconHideSetup(VControl *pCtrl)
{
     UxCtrl_SetShow(pCtrl, FALSE);
}

void FlowMovie_IconDrawCapture(VControl *pCtrl)
{
...
void FlowMovie_IconHideCapture(VControl *pCtrl)
{
     UxCtrl_SetShow(pCtrl, FALSE);
}
...
void FlowMovie_UpdateIcons(BOOL bShow)
{
    ...
    {
        FlowMovie_IconHideDscMode(&UIFlowWndMovie_BTN_DscModeCtrl);
        ...
        FlowMovie_IconHideSetup(&UIFlowWndMovie_BTN_SetupCtrl);
        FlowMovie_IconHideCapture(&UIFlowWndMovie_BTN_RecCtrl);
    }
    else
    {
        FlowMovie_IconDrawDscMode(&UIFlowWndMovie_BTN_DscModeCtrl);
        ...
        FlowMovie_DrawPIM(FALSE);
        FlowMovie_IconDrawSetup(&UIFlowWndMovie_BTN_SetupCtrl);
        FlowMovie_IconDrawCapture(&UIFlowWndMovie_BTN_RecCtrl);
    }
}
