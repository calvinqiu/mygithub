...
CTRL_LIST_ITEM(UIFlowWndPlayThumb_PanelTouch0)
CTRL_LIST_ITEM(UIFlowWndPlayThumb_PanelTouch1)
CTRL_LIST_ITEM(UIFlowWndPlayThumb_PanelTouch2)
CTRL_LIST_ITEM(UIFlowWndPlayThumb_PanelTouch3)
CTRL_LIST_ITEM(UIFlowWndPlayThumb_PanelTouch4)
CTRL_LIST_ITEM(UIFlowWndPlayThumb_PanelTouch5)
CTRL_LIST_ITEM(UIFlowWndPlayThumb_PanelTouch6)
CTRL_LIST_ITEM(UIFlowWndPlayThumb_PanelTouch7)
CTRL_LIST_ITEM(UIFlowWndPlayThumb_PanelTouch8)
CTRL_LIST_END
...
INT32 UIFlowWndPlayThumb_OnTouchPanelSlideLeft(VControl *, UINT32, UINT32 *);
INT32 UIFlowWndPlayThumb_OnTouchPanelSlideRight(VControl *, UINT32, UINT32 *);
...
EVENT_ITEM(NVTEVT_SLIDE_LEFT,UIFlowWndPlayThumb_OnTouchPanelSlideLeft)
EVENT_ITEM(NVTEVT_SLIDE_RIGHT,UIFlowWndPlayThumb_OnTouchPanelSlideRight)
EVENT_END
...
INT32 UIFlowWndPlayThumb_OnTouchPanelSlideLeft(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    UIFlowWndPlayThumb_NaviKey(NVTEVT_KEY_PREV);
    return NVTEVT_CONSUME;
}

INT32 UIFlowWndPlayThumb_OnTouchPanelSlideRight(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
...
//---------------------UIFlowWndPlayThumb_PanelTouch0Ctrl Control List---------------------------
CTRL_LIST_BEGIN(UIFlowWndPlayThumb_PanelTouch0)
CTRL_LIST_END

//----------------------UIFlowWndPlayThumb_PanelTouch0Ctrl Event---------------------------
INT32 UIFlowWndPlayThumb_PanelTouch0_OnTouchPanelClick(VControl *, UINT32, UINT32 *);
EVENT_BEGIN(UIFlowWndPlayThumb_PanelTouch0)
EVENT_ITEM(NVTEVT_CLICK,UIFlowWndPlayThumb_PanelTouch0_OnTouchPanelClick)
EVENT_END

INT32 UIFlowWndPlayThumb_PanelTouch0_OnTouchPanelClick(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
...
//---------------------UIFlowWndPlayThumb_PanelTouch1Ctrl Control List---------------------------
CTRL_LIST_BEGIN(UIFlowWndPlayThumb_PanelTouch1)
CTRL_LIST_END

//----------------------UIFlowWndPlayThumb_PanelTouch1Ctrl Event---------------------------
INT32 UIFlowWndPlayThumb_PanelTouch1_OnTouchPanelClick(VControl *, UINT32, UINT32 *);
EVENT_BEGIN(UIFlowWndPlayThumb_PanelTouch1)
EVENT_ITEM(NVTEVT_CLICK,UIFlowWndPlayThumb_PanelTouch1_OnTouchPanelClick)
EVENT_END

INT32 UIFlowWndPlayThumb_PanelTouch1_OnTouchPanelClick(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
...
//---------------------UIFlowWndPlayThumb_PanelTouch2Ctrl Control List---------------------------
CTRL_LIST_BEGIN(UIFlowWndPlayThumb_PanelTouch2)
CTRL_LIST_END

//----------------------UIFlowWndPlayThumb_PanelTouch2Ctrl Event---------------------------
INT32 UIFlowWndPlayThumb_PanelTouch2_OnTouchPanelClick(VControl *, UINT32, UINT32 *);
EVENT_BEGIN(UIFlowWndPlayThumb_PanelTouch2)
EVENT_ITEM(NVTEVT_CLICK,UIFlowWndPlayThumb_PanelTouch2_OnTouchPanelClick)
EVENT_END

INT32 UIFlowWndPlayThumb_PanelTouch2_OnTouchPanelClick(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
...
//---------------------UIFlowWndPlayThumb_PanelTouch3Ctrl Control List---------------------------
CTRL_LIST_BEGIN(UIFlowWndPlayThumb_PanelTouch3)
CTRL_LIST_END

//----------------------UIFlowWndPlayThumb_PanelTouch3Ctrl Event---------------------------
INT32 UIFlowWndPlayThumb_PanelTouch3_OnTouchPanelClick(VControl *, UINT32, UINT32 *);
EVENT_BEGIN(UIFlowWndPlayThumb_PanelTouch3)
EVENT_ITEM(NVTEVT_CLICK,UIFlowWndPlayThumb_PanelTouch3_OnTouchPanelClick)
EVENT_END

INT32 UIFlowWndPlayThumb_PanelTouch3_OnTouchPanelClick(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
...
//---------------------UIFlowWndPlayThumb_PanelTouch4Ctrl Control List---------------------------
CTRL_LIST_BEGIN(UIFlowWndPlayThumb_PanelTouch4)
CTRL_LIST_END

//----------------------UIFlowWndPlayThumb_PanelTouch4Ctrl Event---------------------------
INT32 UIFlowWndPlayThumb_PanelTouch4_OnTouchPanelClick(VControl *, UINT32, UINT32 *);
EVENT_BEGIN(UIFlowWndPlayThumb_PanelTouch4)
EVENT_ITEM(NVTEVT_CLICK,UIFlowWndPlayThumb_PanelTouch4_OnTouchPanelClick)
EVENT_END

INT32 UIFlowWndPlayThumb_PanelTouch4_OnTouchPanelClick(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
...
//---------------------UIFlowWndPlayThumb_PanelTouch5Ctrl Control List---------------------------
CTRL_LIST_BEGIN(UIFlowWndPlayThumb_PanelTouch5)
CTRL_LIST_END

//----------------------UIFlowWndPlayThumb_PanelTouch5Ctrl Event---------------------------
INT32 UIFlowWndPlayThumb_PanelTouch5_OnTouchPanelClick(VControl *, UINT32, UINT32 *);
EVENT_BEGIN(UIFlowWndPlayThumb_PanelTouch5)
EVENT_ITEM(NVTEVT_CLICK,UIFlowWndPlayThumb_PanelTouch5_OnTouchPanelClick)
EVENT_END

INT32 UIFlowWndPlayThumb_PanelTouch5_OnTouchPanelClick(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
...
//---------------------UIFlowWndPlayThumb_PanelTouch6Ctrl Control List---------------------------
CTRL_LIST_BEGIN(UIFlowWndPlayThumb_PanelTouch6)
CTRL_LIST_END

//----------------------UIFlowWndPlayThumb_PanelTouch6Ctrl Event---------------------------
INT32 UIFlowWndPlayThumb_PanelTouch6_OnTouchPanelClick(VControl *, UINT32, UINT32 *);
EVENT_BEGIN(UIFlowWndPlayThumb_PanelTouch6)
EVENT_ITEM(NVTEVT_CLICK,UIFlowWndPlayThumb_PanelTouch6_OnTouchPanelClick)
EVENT_END

INT32 UIFlowWndPlayThumb_PanelTouch6_OnTouchPanelClick(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
...
//---------------------UIFlowWndPlayThumb_PanelTouch7Ctrl Control List---------------------------
CTRL_LIST_BEGIN(UIFlowWndPlayThumb_PanelTouch7)
CTRL_LIST_END

//----------------------UIFlowWndPlayThumb_PanelTouch7Ctrl Event---------------------------
INT32 UIFlowWndPlayThumb_PanelTouch7_OnTouchPanelClick(VControl *, UINT32, UINT32 *);
EVENT_BEGIN(UIFlowWndPlayThumb_PanelTouch7)
EVENT_ITEM(NVTEVT_CLICK,UIFlowWndPlayThumb_PanelTouch7_OnTouchPanelClick)
EVENT_END

INT32 UIFlowWndPlayThumb_PanelTouch7_OnTouchPanelClick(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    FlowPB_ClearAllThumbIcon();
    Ux_Redraw();
    Ux_CloseWindow((VControl *)(&UIFlowWndPlayThumbCtrl), 1, NVTRET_THUMBNAIL);
...
//---------------------UIFlowWndPlayThumb_PanelTouch8Ctrl Control List---------------------------
CTRL_LIST_BEGIN(UIFlowWndPlayThumb_PanelTouch8)
CTRL_LIST_END

//----------------------UIFlowWndPlayThumb_PanelTouch8Ctrl Event---------------------------
INT32 UIFlowWndPlayThumb_PanelTouch8_OnTouchPanelClick(VControl *, UINT32, UINT32 *);
EVENT_BEGIN(UIFlowWndPlayThumb_PanelTouch8)
EVENT_ITEM(NVTEVT_CLICK,UIFlowWndPlayThumb_PanelTouch8_OnTouchPanelClick)
EVENT_END

INT32 UIFlowWndPlayThumb_PanelTouch8_OnTouchPanelClick(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
