...
static void FlowPB_IconDrawDSCMode(BOOL bShow)
{
    ...
    if (bShow==FALSE)
    {
        UxCtrl_SetShow(&UIFlowWndPlay_BTN_DscModeCtrl, FALSE);
        return;
    }
    ...
    UxButton_SetItemData(&UIFlowWndPlay_BTN_DscModeCtrl, 0, BTNITM_ICONID, uiFlag);
    UxCtrl_SetShow(&UIFlowWndPlay_BTN_DscModeCtrl, TRUE);
}
...
void FlowPB_IconDrawSetup(BOOL bShow)
{
    UxCtrl_SetShow(&UIFlowWndPlay_BTN_SetupCtrl, bShow);
}

void FlowPB_IconDrawPause(BOOL bShow)
{
    UxCtrl_SetShow(&UIFlowWndPlay_StaticICN_PauseCtrl, bShow);
}

void FlowPB_PanelEnablePNLContrl(UINT32 PanelNo)
{
    if(g_PlbData.State == PLB_ST_PLAY_MOV)
    {
        UxButton_SetItemData(&UIFlowWndPlay_BTN_PlayPause2Ctrl, 0, BTNITM_ICONID, ICON_PLAY_PAUSE);
    }
    else
    {
        UxButton_SetItemData(&UIFlowWndPlay_BTN_PlayPause2Ctrl, 0, BTNITM_ICONID, ICON_PLAY_PLAY);
    }

    switch (PanelNo)
    {
        case 4:
            UxCtrl_SetShow(&UIFlowWndPlay_PNL_Control4Ctrl, TRUE);
            UxCtrl_SetShow(&UIFlowWndPlay_PNL_Control2Ctrl, FALSE);
            break;
        case 2:
            UxCtrl_SetShow(&UIFlowWndPlay_PNL_Control4Ctrl, FALSE);
            UxCtrl_SetShow(&UIFlowWndPlay_PNL_Control2Ctrl, TRUE);
            break;
        case 0:
        default:
            UxCtrl_SetShow(&UIFlowWndPlay_PNL_Control4Ctrl, FALSE);
...
void FlowPB_UpdateIcons(BOOL bShow)
{
    ...
    else
    {
        ...
        FlowPB_IconDrawLeftBtn(FALSE);
        FlowPB_IconDrawRightBtn(FALSE);
        FlowPB_IconDrawSetup(TRUE);
        FlowPB_IconDrawPause(FALSE);
        StopAutoHideTimer();                            // stop full screen auto hide timer
...
void FlowPB_ClearAllThumbIcon(void)
{
    ...
    UxCtrl_SetShow(&UIFlowWndPlayThumb_PanelTouch0Ctrl,FALSE);
    UxCtrl_SetShow(&UIFlowWndPlayThumb_PanelTouch1Ctrl,FALSE);
    UxCtrl_SetShow(&UIFlowWndPlayThumb_PanelTouch2Ctrl,FALSE);
    UxCtrl_SetShow(&UIFlowWndPlayThumb_PanelTouch3Ctrl,FALSE);
    UxCtrl_SetShow(&UIFlowWndPlayThumb_PanelTouch4Ctrl,FALSE);
    UxCtrl_SetShow(&UIFlowWndPlayThumb_PanelTouch5Ctrl,FALSE);
    UxCtrl_SetShow(&UIFlowWndPlayThumb_PanelTouch6Ctrl,FALSE);
    UxCtrl_SetShow(&UIFlowWndPlayThumb_PanelTouch7Ctrl,FALSE);
    UxCtrl_SetShow(&UIFlowWndPlayThumb_PanelTouch8Ctrl,FALSE);
...
void FlowPB_ShowAllThumbIcon(void)
{
    ...
    for (i=0; i<loopcnts; i++)
    {
        ...
        {
            case 0:
                UxCtrl_SetShow(&UIFlowWndPlayThumb_PanelTouch0Ctrl,TRUE);
                break;
            case 1:
                UxCtrl_SetShow(&UIFlowWndPlayThumb_PanelTouch1Ctrl,TRUE);
                break;
            case 2:
                UxCtrl_SetShow(&UIFlowWndPlayThumb_PanelTouch2Ctrl,TRUE);
                break;
            case 3:
                UxCtrl_SetShow(&UIFlowWndPlayThumb_PanelTouch3Ctrl,TRUE);
                break;
            case 4:
                UxCtrl_SetShow(&UIFlowWndPlayThumb_PanelTouch4Ctrl,TRUE);
                break;
            case 5:
                UxCtrl_SetShow(&UIFlowWndPlayThumb_PanelTouch5Ctrl,TRUE);
                break;
            case 6:
                UxCtrl_SetShow(&UIFlowWndPlayThumb_PanelTouch6Ctrl,TRUE);
                break;
            case 7:
                UxCtrl_SetShow(&UIFlowWndPlayThumb_PanelTouch7Ctrl,TRUE);
                break;
            case 8:
                UxCtrl_SetShow(&UIFlowWndPlayThumb_PanelTouch8Ctrl,TRUE);
                break;
        }
    }
}
