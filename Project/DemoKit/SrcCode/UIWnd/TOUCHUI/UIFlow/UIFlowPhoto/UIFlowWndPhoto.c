...
CTRL_LIST_ITEM(UIFlowWndPhoto_BTN_DscMode)
...
CTRL_LIST_ITEM(UIFlowWndPhoto_BTN_Setup)
CTRL_LIST_ITEM(UIFlowWndPhoto_BTN_Capture)
CTRL_LIST_END
...
INT32 UIFlowWndPhoto_OnTouchPanelPress(VControl *, UINT32, UINT32 *);
INT32 UIFlowWndPhoto_OnTouchPanelSlideUp(VControl *, UINT32, UINT32 *);
INT32 UIFlowWndPhoto_OnTouchPanelSlideDown(VControl *, UINT32, UINT32 *);
...
EVENT_ITEM(NVTEVT_PRESS,UIFlowWndPhoto_OnTouchPanelPress)
EVENT_ITEM(NVTEVT_SLIDE_UP,UIFlowWndPhoto_OnTouchPanelSlideUp)
EVENT_ITEM(NVTEVT_SLIDE_DOWN,UIFlowWndPhoto_OnTouchPanelSlideDown)
EVENT_END
...
#endif
INT32 UIFlowWndPhoto_OnTouchPanelPress(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
...
INT32 UIFlowWndPhoto_OnTouchPanelSlideUp(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    INT32 uiPosX;
    INT32 uiPosY;
    ...
    {
        gPhotoData.State = PHOTO_ST_MENU;
        Ux_OpenWindow(&MenuCommonItemCtrl, 1, &gPhotoMenu);
    }
    return NVTEVT_CONSUME;
}

INT32 UIFlowWndPhoto_OnTouchPanelSlideDown(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    INT32 uiPosX;
    INT32 uiPosY;
