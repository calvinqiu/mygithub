...
void FlowPhoto_IconDrawFD(VControl *pCtrl)
{
    ...
    {
        UxState_SetData(&UIFlowWndPhoto_StatusICN_FDCtrl,STATE_CURITEM,UIFlowWndPhoto_StatusICN_FD_ICON_FACE_ON);
        UxCtrl_SetShow(pCtrl,TRUE);
    }
}
...
void FlowPhoto_IconDrawSetup(VControl *pCtrl)
{
    UxCtrl_SetShow(pCtrl, TRUE);
}

void FlowPhoto_IconHideSetup(VControl *pCtrl)
{
     UxCtrl_SetShow(pCtrl, FALSE);
}

void FlowPhoto_IconDrawCapture(VControl *pCtrl)
{
    UxCtrl_SetShow(pCtrl, TRUE);
}

void FlowPhoto_IconHideCapture(VControl *pCtrl)
{
     UxCtrl_SetShow(pCtrl, FALSE);
}
...
void FlowPhoto_UpdateIcons(BOOL bShow)
{
    ...
    {
        FlowPhoto_IconHideDscMode(&UIFlowWndPhoto_BTN_DscModeCtrl);
        ...
        FlowPhoto_IconHideSetup(&UIFlowWndPhoto_BTN_SetupCtrl);
        FlowPhoto_IconHideCapture(&UIFlowWndPhoto_BTN_CaptureCtrl);
    }
    else
    {
        FlowPhoto_IconDrawDscMode(&UIFlowWndPhoto_BTN_DscModeCtrl);
        ...
        FlowPhoto_IconDrawSetup(&UIFlowWndPhoto_BTN_SetupCtrl);
        FlowPhoto_IconDrawCapture(&UIFlowWndPhoto_BTN_CaptureCtrl);
    }
}
