...
#define DEFAULT_MOVIE_CYCLICREC         MOVIE_CYCLICREC_OFF
...
#define DEFAULT_IR_CUT                  MOVIE_IR_CUT_AUTO
...
// Wi-Fi
#define DEFAULT_MOVIE_WIFI_AUTO_RECORDING_OPTION    WIFI_AUTO_RECORDING_OFF
