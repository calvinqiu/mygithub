...
// Movie mode key mask
#define MOVIE_KEY_PRESS_MASK        (FLGKEY_MODE|FLGKEY_UP|FLGKEY_DOWN|FLGKEY_ENTER|FLGKEY_SHUTTER2|FLGKEY_CUSTOM1|FLGKEY_MENU)
#define MOVIE_KEY_RELEASE_MASK      (FLGKEY_MODE|FLGKEY_UP|FLGKEY_DOWN|FLGKEY_ENTER|FLGKEY_SHUTTER2|FLGKEY_CUSTOM1|FLGKEY_MENU)
...
INT32 UIFlowWndMovie_ADASDsp_Draw(VControl *pCtrl, UINT32 paramNum, UINT32 *paramArray)
{
    ...
    if (pAdasDspRlt->LdwsDspRsltInfo.Failure == LDWS_FAILURE_FALSE)
    {
        ...
        #endif
        {
			...
			debug_msg("--------draw lane detection result------");
    ...
    {
        UINT32 y;
        debug_msg("--------Show SnG & stop detection debug info------");
