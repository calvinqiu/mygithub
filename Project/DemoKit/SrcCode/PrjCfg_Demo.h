...
#define FW_VERSION_NUM              "REGULAR_0502_OK1"
#define FW_RELEASE_TO_FAE           "RELEASE_FAE_20170524"
...
#if(_MODEL_DSC_ == _MODEL_DEMO1_ && _USB1_TYPE_ != _USB1_HOST_)
...
#define _AUTOVP_FUNC_                   ENABLE  //DISABLE//
#define _DRAW_LDFCINFO_ON_OSD_          DISABLE //ENABLE//
#define _DRAW_LDWSINFO_ON_VIDEO_        DISABLE //ENABLE// This function is only valid if data path is D2D!!
...
//#NT#2016/03/02#MB Wang xa00202 -begin
//#NT#Support different versions of OT switching
#define OT_SINGLE_SCALE                 DISABLE
#define OT_MULTI_SCALE                  DISABLE
//#NT#2016/03/02#MB Wang xa00202 -end
...
// 4. enable COPYCARD2CARD_FUNCTION (for SDIO2 memory pool)
// 5. NETWORK = NETWORK_GMAC_ETHERNET (Both uITRON and eCos-Kit)
#define FS_MULTI_STRG_FUNC              DISABLE
//#NT#2016/10/18#Niven Cho -end
//#NT#2017/03/07#Niven Cho[117156] -begin
//#NT#FS_SWITCH_STRG_FUNC
// strg mount FS_DX_TYPE_DRIVE_B as A:\\ if card is not inserted.
// this is exclusive with FS_MULTI_STRG_FUNC, SDHOTPLUG_FUNCTION
