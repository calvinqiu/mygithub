...
// Power-Saving Config
//battery level
#if(_MODEL_DSC_ == _MODEL_WiFiSDV_)
...
#if  ((_SENSORLIB2_ == _SENSORLIB2_OFF_) && (_SENSORLIB3_ == _SENSORLIB3_OFF_) && (_SENSORLIB4_ == _SENSORLIB4_OFF_))
#define SENSOR_CAPS_COUNT               1
#define SENSOR_CAPS_MASK                (SENSOR_1)
#elif ((_SENSORLIB2_ != _SENSORLIB2_OFF_) && (_SENSORLIB3_ == _SENSORLIB3_OFF_) && (_SENSORLIB4_ == _SENSORLIB4_OFF_))
...
#define SENSOR_DEFAULT_ATTACH_MASK      (SENSOR_1) // hw default attach sensors
