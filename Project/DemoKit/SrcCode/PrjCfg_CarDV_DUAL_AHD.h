...
#elif (_LCDTYPE_ == _LCDTYPE_AT050TN43_ILI6122_)
...
#elif (_LCDTYPE_ == _LCDTYPE_HY40_JD9161_)
#define LCDMODE                         DISP_LCDMODE_MIPI
