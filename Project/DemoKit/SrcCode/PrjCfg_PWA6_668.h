...
#define FW_VERSION_NUM                  "PWA620151027V01" //"GSDEMO_0508_1153"
...
#define BATTERY_DET                         DISABLE //Det battery low //lacy add 2015-9-8
...
#define FLASHLIGHT_FUNCTION             DISABLE//ENABLE
...
// OSD size and format
#define DISPLAY_OSD_W                   320 //800//320//640
#define DISPLAY_OSD_H                   240 //480//240
...
#define TOOL_LAYOUT_W                   320 //800//320//640
#define TOOL_LAYOUT_H                   240 //480//240//480
...
#define VDO2_USE_ROTATE_BUFFER          ENABLE//DISABLE //use rotate buffer (enable to support LCD with stripe-type subpixel)
...
#elif (_LCDTYPE_ == _LCDTYPE_PW50P00_HX8369B_DSI_)
#define LCDMODE                         DISP_LCDMODE_MIPI
#else
...
#define CAR_NUMBER_STAMP_STR            "AAAAAA" //lacyli add 2015-11-14
