...
#define FW_VERSION_NUM              "REGULAR_0712_OK2"
...
//#NT#adjust linux memory when use media vastrem, because we need to record media in linux
#undef  COREMEM_LINUX_ADDR
#undef  COREMEM_LINUX_SIZE
