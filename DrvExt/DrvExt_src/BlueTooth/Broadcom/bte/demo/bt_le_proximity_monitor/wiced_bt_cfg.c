 ...
 ****************************************************************************/
//const wiced_bt_device_address_t WICED_BT_CFG_PEER_BDA = {0x20, 0x73, 0x7A, 0x14, 0x56, 0x89};
//const wiced_bt_device_address_t WICED_BT_CFG_PEER_BDA = { 0x20, 0x73, 0x7A, 0x10, 0x00, 0x02 };
const wiced_bt_device_address_t WICED_BT_CFG_PEER_BDA = { 0xE4, 0x24, 0xDE, 0xff, 0x57, 0x4D };
...
{
    (uint8_t *)"WICED Proximity",                                   /**< Local device name (NULL terminated) */
