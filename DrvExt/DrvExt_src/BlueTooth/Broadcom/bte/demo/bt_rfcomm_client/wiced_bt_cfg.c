...
{
    (uint8_t *)"WICED RFCOMM Client",                               /**< Local device name (NULL terminated) */
    ...
    /* GATT configuration */
    {
        ...
        0                                                           /**< Maximum attribute length; gki_cfg must have a corresponding buffer pool that can hold this length */
    },
