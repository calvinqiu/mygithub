...
#include "bt_le_proximity_reporter.h"
...
static void bt_le_proximity_reporter_init(void);
...
static wiced_bt_gatt_status_t bt_le_proximity_gatt_write_request(wiced_bt_gatt_write_t *p_write_request)
{
...
static wiced_bt_gatt_status_t bt_le_proximity_gatt_read_request(wiced_bt_gatt_read_t *p_read_request)
{
    wiced_bt_gatt_status_t status = WICED_BT_GATT_SUCCESS;
