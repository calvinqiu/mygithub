...
#define TV_NTSC_BLAND_LEVEL_3_3                 0x78
#define TV_NTSC_Y_SCALE_3_3                     0x88//0x8A
#define TV_NTSC_CB_SCALE_3_3                    0x77//0x77
#define TV_NTSC_CR_SCALE_3_3                    0xAA//0xAA

#define TV_PAL_BURST_LEVEL_3_3                  0x2C
#define TV_PAL_BLAND_LEVEL_3_3                  0x7D
#define TV_PAL_Y_SCALE_3_3                      0x92//0x92
#define TV_PAL_CB_SCALE_3_3                     0x80//0x7F
#define TV_PAL_CR_SCALE_3_3                     0xB6//0xB2
