...
#define ZOOM_PWM_ENABLE          0
#define MOTOR_PWM_THRESHOLD_EN   0
#define IRIS_USTEP_ENABLE        0
#define FOCUS_USTEP_ENABLE       0
...
static void     motorG2007_ircut_setState(MOTOR_IRCUT_ACT state, UINT32 param1);
#if ZOOM_PWM_ENABLE
...
static MOTOR_PVT_OBJ gG2007PvtObj =
{
    ...
    FOCUS_USTEP_ENABLE   // enable u-step default.
};
