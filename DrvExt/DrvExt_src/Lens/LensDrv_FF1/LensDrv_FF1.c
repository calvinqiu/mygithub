...
static void        lensFF1_Focus_SetFocalLength(UINT32 ZoomSection, UINT32 FocalLength);
...
static void        lensFF1_ircut_setState(MOTOR_IRCUT_ACT state, UINT32 param1);
