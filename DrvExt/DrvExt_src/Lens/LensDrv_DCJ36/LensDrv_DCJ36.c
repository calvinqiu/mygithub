...
static void        lensDCJ36_Focus_SetFocalLength(UINT32 ZoomSection, UINT32 FocalLength);
...
static void        lensDCJ36_ircut_setState(MOTOR_IRCUT_ACT state, UINT32 param1);
...
static LENS_TAB g_pDCJ36Obj =
{
    ...
    lensDCJ36_Focus_SetFocalLength,
...
static void lensDCJ36_Focus_SetFocalLength(UINT32 ZoomSection, UINT32 FocalLength)
{
    FocusLength[ZoomSection] = FocalLength;
}
...
static INT32 lensDCJ36_Focus_GetDefultTable(UINT32 section, UINT32 FocusDistance)
{
    if (section>ZOOM_SECTION_TELE-1)
    {
        section = ZOOM_SECTION_TELE-1;
        DBG_ERR("%s, section error, (%d)r\n",__func__,section);
    }

    if (FocusDistance>FOCUS_DISTANCE-1)
    {
        FocusDistance = FOCUS_DISTANCE-1;
    ...
    else if(DCJ36_Para.AperturePos != position)
    {
        ...
        switch (position)
        {
            ...
            case IRIS_POS_F8_0:
                ...
                {
                    if(DCJ36_Para.AperturePos > IRIS_TOTAL_SEGMENT -1)
                       DCJ36_Para.AperturePos = IRIS_TOTAL_SEGMENT -1;
