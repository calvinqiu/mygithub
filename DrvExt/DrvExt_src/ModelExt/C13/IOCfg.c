...
GPIO_INIT_OBJ uiGPIOMapInitTab[] = {
     {  GPIO_SENSOR_PWR_VDD_A_V28,    GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,     PAD_PIN_NOT_EXIST   },
     {  GPIO_SENSOR_PWR_VDD_D_V12,    GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,     PAD_PIN_NOT_EXIST   },
     {  GPIO_SENSOR_PWR_VDD_IO_V18,   GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_LOW,    PAD_PIN_NOT_EXIST   },
     ...
     {  GPIO_LCD_RESET_LEGACY,  GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,   PAD_PIN_NOT_EXIST   },
#endif
     {  GPIO_LCD_TE,            GPIO_DIR_INPUT,     PAD_PULLUP,           PAD_LCD_TE          },
     //LED
    ...
    //IR CUT
     ...
     {  GPIO_SENSOR3_POWER_EN,  GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,     PAD_PIN_NOT_EXIST   },
     {  GPIO_SENSOR3_PDN,       GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,     PAD_PIN_NOT_EXIST   },
     {  GPIO_SENSOR3_RESET,     GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,     PAD_PIN_NOT_EXIST   },
     {  GPIO_SENSOR3_PART_DTC,  GPIO_DIR_INPUT,     PAD_PULLUP,             PAD_PIN_NOT_EXIST   },
     {  GPIO_SENSOR3_CVBS_PLUG, GPIO_DIR_INPUT,     PAD_PULLUP,             PAD_PIN_NOT_EXIST   },
#endif

#if (_TOUCH_FUNC_ == _TOUCH_ENABLE_)
    {  GPIO_TP_RST,             GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,     PAD_TP_RST          },
    {  GPIO_TP_INT,             GPIO_DIR_INPUT,     PAD_NONE,               PAD_TP_INT          },
#endif
