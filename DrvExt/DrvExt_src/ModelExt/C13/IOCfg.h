...
#define GPIO_PWM_LCD_BLG_PCTL       19
#define PWMID_LCD_BLG_PCTL          PWMID_19
#elif (LCD_BACKLIGHT_CTRL == LCD_BACKLIGHT_BY_GPIO)
#define GPIO_LCD_BLG_PCTL           P_GPIO_30
#define PAD_LCD_BLG_PCTL            PAD_PIN_PGPIO30
#endif
#if (_LCDTYPE_ == _LCDTYPE_BPB5017BFW_ILI9806E_DSI_)
#define GPIO_LCD_RESET              L_GPIO_9
#define GPIO_LCD_RESET_LEGACY       L_GPIO_10
#endif

#define GPIO_LCD_TE                 L_GPIO_22
#define PAD_LCD_TE                  PAD_PIN_LGPIO22
...
#define GPIO_TV_PLUG                P_GPIO_36
#define PAD_TV_PLUG                 PAD_PIN_PGPIO36
#endif
...
// CARD
// card power
#define GPIO_CARD_POWER             P_GPIO_26
#define PAD_CARD_POWER              PAD_PIN_PGPIO26
// SD card detect
...
// audio power
#define GPIO_AUDIO_POWER            P_GPIO_25
...
#define GPIO_RED_LED                C_GPIO_9
#define PAD_RED_LED                 PAD_PIN_CGPIO9

#define LED_GREEN_DUMMY             0
#define LED_GREEN_BY_GPIO           1
#define LED_GREEN_CTRL              LED_RED_BY_GPIO
#define GPIO_GREEN_LED              C_GPIO_10
#define PAD_GREEN_LED               PAD_PIN_CGPIO10
...
// IR LED
#define LED_IR_DUMMY             0
#define LED_IR_BY_GPIO           1
#define LED_IR_BY_PWM            2 //use PWM to control LED brightness
#define LED_IR_CTRL              LED_IR_BY_GPIO//LED_IR_BY_PWM
#if(LED_IR_CTRL == LED_IR_BY_GPIO)
#define GPIO_IR_LED              P_GPIO_0
#define PAD_IR_LED               PAD_PIN_PGPIO0
#elif(LED_IR_CTRL == LED_IR_BY_PWM)
#define PWMID_IR_LED             PWMID_0 //FPGA
#endif
// IR CUT
#define GPIO_IRCUT_CTRL1                C_GPIO_14
#define GPIO_IRCUT_CTRL2                C_GPIO_15
//--------------------------------------------------------------------
// Power device
//--------------------------------------------------------------------
//Battery
...
#define GPIO_TP_RST                 L_GPIO_19
#define GPIO_TP_INT                 L_GPIO_20
#define PAD_TP_RST                  PAD_PIN_LGPIO19
#define PAD_TP_INT                  PAD_PIN_LGPIO20
#endif
...
*/
#define GPIO_SENSOR_PWR_VDD_A_V28   P_GPIO_29
#define GPIO_SENSOR_PWR_VDD_D_V12   P_GPIO_28
#define GPIO_SENSOR_PWR_VDD_IO_V18  S_GPIO_4
#define GPIO_SENSOR_STANDBY         S_GPIO_8
#define GPIO_SENSOR_RESET           S_GPIO_7

#define GPIO_SENSOR3_POWER_EN       P_GPIO_40
#define GPIO_SENSOR3_PDN            P_GPIO_20
#define GPIO_SENSOR3_RESET          P_GPIO_14

#define GPIO_SENSOR3_PART_DTC       P_GPIO_35
#define GPIO_SENSOR3_CVBS_PLUG      P_GPIO_36
...
#define SENSOR_DET_CTRL             SENSOR_DET_BY_GPIO
...
// RTL 8192/8189
#define GPIO_WIFI_SHDN  P_GPIO_4  //WiFi Shut Down                      => useless in C13
#define PAD_WIFI_SHDN   PAD_PIN_PGPIO4
#define GPIO_WIFI_PWREN P_GPIO_39 //WiFi Power Enable (low enable)      => useless in C13
#define GPIO_WIFI_CS    P_GPIO_27 //WiFi CS Enable (High enable)
