...
UINT32 DrvCARDInit(void* pInitParam) // Set Init Parameters
{
    ...
    */
    ...
    sdio_setConfig(SDIO_CONFIG_ID_AUTOPINMUX, TRUE);                                            // Auto pinmux for SD
    sdio_setCallBack(SDIO_CALLBACK_POWER_CONTROL, (SDIO_CALLBACK_HDL)DrvCARD_EnableCardPower); //for patching 3.3v voltage glitch issue on C10.
    //if(STRG_OBJ_FAT1)
    {
