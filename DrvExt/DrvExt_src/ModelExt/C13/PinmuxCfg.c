...
#elif ((_SENSORLIB_ == _SENSORLIB_CMOS_OV4689_)  && (_SENSORLIB2_ == _SENSORLIB2_OFF_) && (_SENSORLIB3_ == _SENSORLIB3_CMOS_GM7150_) && (_SENSORLIB4_ == _SENSORLIB4_OFF_))
    {PIN_FUNC_SENSOR,           PIN_SENSOR_CFG_MIPI|PIN_SENSOR_CFG_MCLK},
    {PIN_FUNC_SENSOR2,          PIN_SENSOR2_CFG_NONE},
    {PIN_FUNC_SENSOR3,          PIN_SENSOR3_CFG_8BITS},
    {PIN_FUNC_SENSOR4,          PIN_SENSOR4_CFG_NONE},
    {PIN_FUNC_MIPI_LVDS,        PIN_MIPI_LVDS_CFG_CLK0 | PIN_MIPI_LVDS_CFG_DAT0 | PIN_MIPI_LVDS_CFG_DAT1 | PIN_MIPI_LVDS_CFG_DAT2 | PIN_MIPI_LVDS_CFG_DAT3},
...
#endif
#if (_SENSORLIB2_ == _SENSORLIB2_CMOS_NT99141_ || _SENSORLIB3_ == _SENSORLIB3_CMOS_GM7150_)
                                PIN_I2C_CFG_CH1 |   //Need check
#endif
...
#endif
                                0},
    {PIN_FUNC_UART,             PIN_UART_CFG_CH1 | PIN_UART_CFG_CH2 | PIN_UART_CFG_CH2_CTSRTS | PIN_UART_CFG_CH3},
...
#elif (_LCD2TYPE_ != _LCD2TYPE_OFF_)
