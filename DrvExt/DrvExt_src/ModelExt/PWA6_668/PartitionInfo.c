...
EMB_PARTITION gPartition[EMB_PARTITION_INFO_COUNT] _SECTION(".partitioninfo_data") = {
    ...
    [2] = {EMBTYPE_PSTORE,  0,  0x00500000, 0x00300000, 0x00000000},
#else
    [0] = {EMBTYPE_UITRON,  0,  0x00000000, 0x00300000, 0x00000000},
    [1] = {EMBTYPE_ECOS,    0,  0x00300000, 0x00121000, 0x00000000},
    [2] = {EMBTYPE_DSP,     0,  0x00421000, 0x00360000, 0x00000000},
    [3] = {EMBTYPE_FAT,     0,  0x00781000, 0x00000000, 0x00000000},
    [4] = {EMBTYPE_PSTORE,  0,  0x00781000, 0x00023000, 0x00000000},
#endif
#endif
