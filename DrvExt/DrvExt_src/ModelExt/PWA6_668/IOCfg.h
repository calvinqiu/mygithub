...
#define GPIO_LCD_BLG_PCTL           P_GPIO_0//P_GPIO_3
#define PAD_LCD_BLG_PCTL            PAD_PIN_PGPIO0//PAD_PIN_PGPIO3
#endif
...
#define GPIO_RED_LED                C_GPIO_10  //FPGA
#define PAD_RED_LED                 PAD_PIN_CGPIO10

#define LED_GREEN_DUMMY             0
#define LED_GREEN_BY_GPIO           1
#define LED_GREEN_CTRL              LED_GREEN_BY_GPIO
#define GPIO_GREEN_LED              C_GPIO_11  //FPGA
#define PAD_GREEN_LED               PAD_PIN_CGPIO11

#define LED_BLUE_DUMMY              0
#define LED_BLUE_BY_GPIO            1
#define LED_BLUE_CTRL               LED_BLUE_BY_GPIO
#define GPIO_BLUE_LED               C_GPIO_12 //FPGA
#define PAD_BLUE_LED                PAD_PIN_CGPIO12
