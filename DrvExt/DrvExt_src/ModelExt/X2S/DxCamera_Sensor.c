...
#elif ((_SENSORLIB_ == _SENSORLIB_CMOS_IMX322LQJVX1_) &&      \
       (_SENSORLIB2_ == _SENSORLIB2_OFF_) &&            \
       (_SENSORLIB3_ == _SENSORLIB3_OFF_) &&            \
       (_SENSORLIB4_ == _SENSORLIB_OFF_))
...
static SEN_GET_DRV SenDrvTab[SENSOR_ID_MAX_NUM] =
{
    Sensor_GetDrvTab_IMX322LQJVX1,   NULL,   NULL,   NULL,
};
...
static SENSOR_INIT_OBJ Sensor_GetObj(void)
{
    ...
    */
    ...
    InitObj.Sen2LVDSPinMap[5] = 4;
    InitObj.Sen2LVDSPinMap[6] = 9;
    InitObj.Sen2LVDSPinMap[7] = 5;
    InitObj.Sen2LVDSPinMap[8] = 6;
    InitObj.Sen2LVDSPinMap[9] = 7;
    return InitObj;
}
