...
#define GPIO_LCD_BLG_PCTL           P_GPIO_18  // useless
#define PAD_LCD_BLG_PCTL            PAD_PIN_PGPIO18 // useless
#endif
...
*/
#define GPIO_SENSOR_STANDBY         P_GPIO_18 // useless
#define GPIO_SENSOR_RESET           S_GPIO_7

#define GPIO_SENSOR2_STANDBY        P_GPIO_18 // useless
#define GPIO_SENSOR2_RESET          S_GPIO_8

#define GPIO_SENSOR2_PWR            P_GPIO_18 // useless
...
#define SENSOR_DET_CTRL             SENSOR_DET_DUMMY
