...
const PIN_GROUP_CONFIG vTopConfig[] =
{
...
#elif 0//((_SENSORLIB_ == _SENSORLIB_CMOS_IMX322LQJ_ ) && (_SENSORLIB2_ == _SENSORLIB2_CMOS_SC2033CVX1_) && (_SENSORLIB3_ == _SENSORLIB3_OFF_) && (_SENSORLIB4_ == _SENSORLIB4_OFF_))
    {PIN_FUNC_SENSOR,           PIN_SENSOR_CFG_12BITS|PIN_SENSOR_CFG_MCLK},
    {PIN_FUNC_SENSOR2,          PIN_SENSOR2_CFG_NONE},
    {PIN_FUNC_SENSOR3,          PIN_SENSOR3_CFG_NONE},
    {PIN_FUNC_SENSOR4,          PIN_SENSOR4_CFG_NONE},
    {PIN_FUNC_MIPI_LVDS,        PIN_MIPI_LVDS_CFG_NONE},
#elif ((_SENSORLIB_ == _SENSORLIB_CMOS_IMX322LQJ_ ) && (_SENSORLIB2_ == _SENSORLIB2_CMOS_IMX322LQJVX1_) && (_SENSORLIB3_ == _SENSORLIB3_OFF_) && (_SENSORLIB4_ == _SENSORLIB4_OFF_))
    {PIN_FUNC_SENSOR,           PIN_SENSOR_CFG_12BITS|PIN_SENSOR_CFG_MCLK},
    {PIN_FUNC_SENSOR2,          PIN_SENSOR2_CFG_NONE},
    {PIN_FUNC_SENSOR3,          PIN_SENSOR3_CFG_NONE},
    {PIN_FUNC_SENSOR4,          PIN_SENSOR4_CFG_NONE},
    {PIN_FUNC_MIPI_LVDS,        PIN_MIPI_LVDS_CFG_NONE},
#elif ((_SENSORLIB_ == _SENSORLIB_CMOS_IMX322LQJ_)  && (_SENSORLIB2_ == _SENSORLIB2_CMOS_TVP5150_||_SENSORLIB2_ == _SENSORLIB2_CMOS_GM7150_) && (_SENSORLIB3_ == _SENSORLIB3_OFF_) && (_SENSORLIB4_ == _SENSORLIB4_OFF_))
    {PIN_FUNC_SENSOR,           PIN_SENSOR_CFG_12BITS|PIN_SENSOR_CFG_MCLK},
    {PIN_FUNC_SENSOR2,          PIN_SENSOR2_CFG_CCIR8BITS|PIN_SENSOR_CFG_MCLK2},
    {PIN_FUNC_SENSOR3,          PIN_SENSOR3_CFG_NONE},
    {PIN_FUNC_SENSOR4,          PIN_SENSOR4_CFG_NONE},
    {PIN_FUNC_MIPI_LVDS,        PIN_MIPI_LVDS_CFG_NONE},
#elif ((_SENSORLIB_ == _SENSORLIB_OFF_)  && (_SENSORLIB2_ == _SENSORLIB2_CMOS_TVP5150_) && (_SENSORLIB3_ == _SENSORLIB3_OFF_) && (_SENSORLIB4_ == _SENSORLIB4_OFF_))
    ...
    {PIN_FUNC_MIPI_LVDS,        PIN_MIPI_LVDS_CFG_NONE},
       ...
       (_SENSORLIB_ == _SENSORLIB_CMOS_OV4689_) && (_SENSORLIB2_ == _SENSORLIB2_CMOS_IMX322LQJ_ || _SENSORLIB2_ == _SENSORLIB2_CMOS_IMX322LQJVX1_|| _SENSORLIB2_ == _SENSORLIB2_CMOS_SC2033CVX1_|| _SENSORLIB2_ == _SENSORLIB2_CMOS_OV9712VX1_|| _SENSORLIB2_ == _SENSORLIB2_CMOS_OV2710VX1_) && (_SENSORLIB3_ == _SENSORLIB3_OFF_) && (_SENSORLIB4_ == _SENSORLIB4_OFF_))
    ...
    */
    {PIN_FUNC_I2C,              PIN_I2C_CFG_NONE |
                                ...
                                PIN_I2C_CFG_CH1 |
#endif
#if 0//((_SENSORLIB_ == _SENSORLIB_CMOS_IMX322LQJ_ || _SENSORLIB_ == _SENSORLIB_CMOS_IMX322LQJVX1_)||(_SENSORLIB_ == _SENSORLIB_CMOS_SC2033CVX1_) || (_SENSORLIB_ == _SENSORLIB_CMOS_IMX124LQT_) || (_SENSORLIB_ == _SENSORLIB_CMOS_IMX123LQT_))
                                PIN_I2C_CFG_CH1_2ND_PINMUX |
#endif
#if ((_SENSORLIB_ == _SENSORLIB_CMOS_OV4689_) || (_SENSORLIB_ == _SENSORLIB_CMOS_AR0330M_) || (_SENSORLIB_ == _SENSORLIB_CMOS_AR0230CS_) || (_SENSORLIB2_ == _SENSORLIB2_CMOS_TVP5150_)|| (_SENSORLIB2_ == _SENSORLIB2_CMOS_GM7150_))
                                PIN_I2C_CFG_CH1_2ND_PINMUX |
#endif
