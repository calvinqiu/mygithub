...
// PWM common
//--------------------------------------------------------------------
#define x_GPIO_x     P_GPIO_12   //@300+
#define PAD_PIN_xGPIOx   PAD_PIN_PGPIO12
...
#endif
//#define GPIO_LCD_SLEEP              C_GPIO_28 //FPGA not support
#define GPIO_LCD_RESET              x_GPIO_x //FPGA not support
#define PAD_LCD_RESET              	PAD_PIN_xGPIOx //FPGA not support

#define GPIO_LCD_CTRL              	x_GPIO_x //FPGA not support
#define PAD_LCD_CTRL              	PAD_PIN_xGPIOx //FPGA not support
...
#define GPIO_LCD_BLG_PCTL           P_GPIO_36
#define PAD_LCD_BLG_PCTL            PAD_PIN_PGPIO36
#endif

// LCD2 communicate
#define LCD2_COMM_CTRL              LCD_COMM_DUMMY //EVB
...
#define GPIO_TV_PLUG                x_GPIO_x
#define PAD_TV_PLUG                 PAD_PIN_xGPIOx
#endif
...
// CARD
// card power
#define GPIO_CARD_POWER             C_GPIO_6//P_GPIO_2
#define PAD_CARD_POWER              PAD_PIN_CGPIO6//PAD_PIN_PGPIO2
// SD card detect
#define GPIO_CARD_DETECT            D_GPIO_0
#define PAD_CARD_DETECT             PAD_PIN_DGPIO0
// SD card write protect
#define GPIO_CARD_WP                x_GPIO_x
...
#define GPIO_STATE_DET             L_GPIO_21
#define PAD_STATE_DET              PAD_PIN_LGPIO21
...
#define GPIO_KEY_MENU           C_GPIO_11           // Key Shutter2 (ks2)
#define PAD_KEY_MENU            PAD_PIN_CGPIO11
...
#define GPIO_RED_LED                C_GPIO_28//x_GPIO_x  //FPGA
#define PAD_RED_LED                 PAD_PIN_CGPIO28//PAD_PIN_xGPIOx

#define LED_GREEN_DUMMY             0
#define LED_GREEN_BY_GPIO           1
#define LED_GREEN_CTRL              LED_GREEN_BY_GPIO
#define GPIO_GREEN_LED              C_GPIO_29  //FPGA
#define PAD_GREEN_LED               PAD_PIN_CGPIO29
...
*/
#define GPIO_SENSOR_STANDBY         x_GPIO_x//S_GPIO_8
#define GPIO_SENSOR_RESET           S_GPIO_9

#define GPIO_SENSOR2_PWR            P_GPIO_40

#define GPIO_SENSOR2_RESET          C_GPIO_4//D_GPIO_1
#define GPIO_SENSOR2_PDN            P_GPIO_25//
#define GPIO_SENSOR2_POWER_EN       x_GPIO_x//P_GPIO_25
#define GPIO_SENSOR2_POWER_MODULE       x_GPIO_x//P_GPIO_26
...
#define GPIO_ETH_GMAC  x_GPIO_x
// RTL 8192/8189
#define GPIO_WIFI_SHDN P_GPIO_34 //WiFi Shut Down

#define GPIO_SOC_ON             P_GPIO_35
#define PAD_SOC_ON              PAD_PIN_PGPIO35
