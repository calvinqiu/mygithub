...
static UINT32 VolDet_GetKey2Level(void)
{
    ...
    if (uiKey1ADC < 100)
    {
        ...
        //   debug_msg("VOLDET_KEY_LVL_MENU \r\n");
        return VOLDET_KEY_LVL_4;
    }
    else if ((uiKey1ADC > 650)
             && (uiKey1ADC < 850))
    {

        //   debug_msg("VOLDET_KEY_LVL_SOS \r\n");
        return VOLDET_KEY_LVL_5;
    }
    else
    {
...
UINT32 DrvKey_DetNormalKey(void)
{
    ...
    switch(uiKey1Lvl)
    {
        ...
        default:
            break;
        case VOLDET_KEY_LVL_0:  //SW2
           //debug_err(("====FLGKEY_DEL press\r\n"));
            uiKeyCode |= FLGKEY_DEL;
            break;
        case VOLDET_KEY_LVL_1:  //SW3
          //debug_err(("====FLGKEY_UP press\r\n"));
            uiKeyCode |= FLGKEY_UP;
            break;
        case VOLDET_KEY_LVL_2:  //SW3
          //debug_err(("====FLGKEY_DOWN press\r\n"));
    ...
    default:
        break;
        case VOLDET_KEY_LVL_3:  //SW3
         //debug_err(("====FLGKEY_ENTER press\r\n"));
            uiKeyCode |= FLGKEY_RIGHT;
            break;
        case VOLDET_KEY_LVL_4:  //SW4
         //debug_err(("====FLGKEY_MENU press\r\n"));
            //uiKeyCode |= FLGKEY_MENU;
            break;
        case VOLDET_KEY_LVL_5:  //SW5
            //uiKeyCode |= FLGKEY_MODE;
         //debug_err(("====FLGKEY_MODE press\r\n"));
            break;
    }
#endif
