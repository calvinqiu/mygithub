...
GPIO_INIT_OBJ uiGPIOMapInitTab[] = {
...
#endif
    {  GPIO_SENSOR1_1V2,       GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,   PAD_PIN_NOT_EXIST      },
    {  GPIO_SENSOR1_1V8,       GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,   PAD_PIN_NOT_EXIST      },
    {  GPIO_SENSOR1_2V8,       GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,   PAD_PIN_NOT_EXIST      },


    //{  GPIO_PM25_POWER,      GPIO_DIR_OUTPUT,     GPIO_SET_OUTPUT_HI,           PAD_PIN_NOT_EXIST       },
    //{  GPIO_PM25_RESET,      GPIO_DIR_OUTPUT,     GPIO_SET_OUTPUT_HI,           PAD_PIN_NOT_EXIST       },
    ...
    {  GPIO_GSENSOR_POWER,      GPIO_DIR_OUTPUT,     GPIO_SET_OUTPUT_LOW,           PAD_PIN_NOT_EXIST       },
