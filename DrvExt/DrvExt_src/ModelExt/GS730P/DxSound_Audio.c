...
void DrvSound_SetAudioFeature(void)
{
    ...
    #if 1
    /*
    //aud_setDefaultSettings(AUDIO_DEFSET_10DB);
    ...
    aud_setParameter(AUDIO_PARAMETER_NOISEGATE_TIME_RESOLUTION, EAC_ALC_TRESO_BASIS_10000US);
    aud_setParameter(AUDIO_PARAMETER_ALC_TIME_RESOLUTION,        EAC_ALC_TRESO_BASIS_800US);
    aud_setParameter(AUDIO_PARAMETER_ALC_ATTACK_TIME,                                   0x4);
    aud_setParameter(AUDIO_PARAMETER_ALC_DECAY_TIME,                                    0x5);
    aud_setParameter(AUDIO_PARAMETER_RECORD_DIGITAL_GAIN,  0xe0);
    ...
    aud_setParameter(AUDIO_PARAMETER_ALC_MINGAIN,                   EAC_ALC_MINGAIN_P9P0_DB);

    aud_setFeature(AUDIO_FEATURE_NG_WITH_MICBOOST,                                     FALSE);
    aud_setFeature(AUDIO_FEATURE_MICBOOST,                                             TRUE);

    aud_setParameter(AUDIO_PARAMETER_NOISETHD_WITH_BOOST,         EAC_NG_THRESHOLD_N61P5_DB);
    aud_setParameter(AUDIO_PARAMETER_ALC_MAXGAIN,                   EAC_ALC_MAXGAIN_P1P5_DB);
    ...
    //       For audio recording quaility fine-tuning request, please help to connect Novatek Engineer.
    // Enable ALC/Noise Gate function
    aud_setParameter(AUDIO_PARAMETER_NOISEGAIN,                                         0x5);
    aud_setParameter(AUDIO_PARAMETER_NOISEGATE_TIME_RESOLUTION, EAC_ALC_TRESO_BASIS_45000US);
    aud_setParameter(AUDIO_PARAMETER_ALC_TIME_RESOLUTION,        EAC_ALC_TRESO_BASIS_5000US);
    aud_setParameter(AUDIO_PARAMETER_ALC_ATTACK_TIME,                                   0x4);
    aud_setParameter(AUDIO_PARAMETER_ALC_DECAY_TIME,                                    0x5);
    aud_setParameter(AUDIO_PARAMETER_RECORD_DIGITAL_GAIN,                               0xD0);//0xCF



    //#NT#2013/6/6#Philex Lin-begin
    // for improving audio quality
    aud_setParameter(AUDIO_PARAMETER_BOOST_GAIN,                      EAC_PGABOOST_SEL_30DB);//EAC_PGABOOST_SEL_10DB
    aud_setParameter(AUDIO_PARAMETER_ALC_MINGAIN,                   EAC_ALC_MINGAIN_N1P5_DB);

    aud_setFeature(AUDIO_FEATURE_NG_WITH_MICBOOST,                                     TRUE);
    aud_setFeature(AUDIO_FEATURE_MICBOOST,                                             TRUE);

    aud_setParameter(AUDIO_PARAMETER_NOISETHD_WITH_BOOST,         EAC_NG_THRESHOLD_N60P0_DB);//EAC_NG_THRESHOLD_N48P0_DB
    aud_setParameter(AUDIO_PARAMETER_ALC_MAXGAIN,                   EAC_ALC_MAXGAIN_N15P0_DB);
    ...
    aud_setParameter(AUDIO_PARAMETER_ALC_ATTACK_TIME,                                   0x4);
    aud_setParameter(AUDIO_PARAMETER_ALC_DECAY_TIME,                                    0x5);
    aud_setParameter(AUDIO_PARAMETER_RECORD_DIGITAL_GAIN,  0xd5);
...
UINT32 DrvSound_Getcaps(UINT32 CapID, UINT32 Param1)
{
    ...
    case DXSOUND_CAP_GET_AUDOUTDEV:
        retV = (UINT32)GPIOMap_DetAudioOutDevice();
        break;
