...
static SENSOR_INIT_OBJ Sensor_GetObj(void)
{
    ...
    InitObj.CmdInfo.INFO.I2C.extSlaveAddrEnable = FALSE;
InitObj.ChgMclkEn = ENABLE;
#if 1//defined(YQCONFIG_COMB_SENSOR_ROTATE_OPTION_MIRROR)
...
static SENSOR_INIT_OBJ Sensor_GetObj(void)
{
    SENSOR_INIT_OBJ InitObj = {0};
    InitObj.CmdInfo.CmdType = SENSOR_CMD_I2C;
    #if 1//defined(YQCONFIG_PLATFORM_NAME_K40)
...
static void SenPowerOff2(void)
{
    ...
    gpio_clearPin(GPIO_SENSOR2_PWR);
    Delay_DelayMs(20);
    #endif
}
...
static void SenPowerOn(void)
{
    debug_msg("IMX290 sensor power on ..\r\n");
    gpio_setDir(GPIO_SENSOR_PWREN1_2V, GPIO_DIR_OUTPUT);
    gpio_setPin(GPIO_SENSOR_PWREN1_2V);
    Delay_DelayMs(10);
    gpio_setDir(GPIO_SENSOR_PWREN1_8V, GPIO_DIR_OUTPUT);
...
static void SenPowerOn2(void)
{
    debug_msg("IMX290LQR SenPowerOn2...\r\n");
...
static void SenPowerOff2(void)
{
    debug_msg("IMX290LQR SenPowerOff2...\r\n");
    pll_setClkEn(PLL_CLK_SIEMCLK2, DISABLE);
...
static SEN_GET_DRV SenDrvTab[SENSOR_ID_MAX_NUM] =
{
    Sensor_GetDrvTab_IMX290LQR,   Sensor_GetDrvTab_IMX322LQJVX1,   NULL,   NULL,
};
...
static void SenPowerOn(void)
{
    debug_msg("IMX323 sensor power on ..\r\n");
    gpio_setDir(GPIO_SENSOR_PWREN1_2V, GPIO_DIR_OUTPUT);
    gpio_setPin(GPIO_SENSOR_PWREN1_2V);
    Delay_DelayMs(10);
    gpio_setDir(GPIO_SENSOR_PWREN1_8V, GPIO_DIR_OUTPUT);
...
static void SenPowerOn2(void)
{
    ...
    gpio_setPin(GPIO_SENSOR2_PWR_OUT);
    Delay_DelayMs(1);
