...
#define VOLDET_KEY_ADC_LVL2         (528-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL3         (697-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL4     (1018-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_TH           (1020)
#else
#define VOLDET_KEY_ADC_RANGE        (20)
#define VOLDET_KEY_ADC_LVL0         (0)
#define VOLDET_KEY_ADC_LVL1         (220-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL2         (422-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL3         (595-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_TH           (595+VOLDET_KEY_ADC_RANGE)
#endif
...
static UINT32 VolDet_GetKey1Level(void)
{
    ...
    {
        if ((uiKey1ADC >= VOLDET_KEY_ADC_LVL4) && (uiKey1ADC <= VOLDET_KEY_ADC_TH))
        {
             uiCurKey2Lvl = VOLDET_KEY_LVL_MODE;//VOLDET_KEY_LVL_MODE

        }
        else if ((uiKey1ADC >= VOLDET_KEY_ADC_LVL3) && (uiKey1ADC <= VOLDET_KEY_ADC_LVL4))
        {
