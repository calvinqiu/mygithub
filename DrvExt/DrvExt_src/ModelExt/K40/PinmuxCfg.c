...
const PIN_GROUP_CONFIG vTopConfig[] =
{
    ...
    #elif ((_SENSORLIB_ == _SENSORLIB_CMOS_IMX322LQJ_ || _SENSORLIB_ == _SENSORLIB_CMOS_IMX322LQJVX1_) && (_SENSORLIB2_ == _SENSORLIB2_CMOS_TVP5150_) && (_SENSORLIB3_ == _SENSORLIB3_OFF_) && (_SENSORLIB4_ == _SENSORLIB4_OFF_))
    {PIN_FUNC_SENSOR,           PIN_SENSOR_CFG_12BITS|PIN_SENSOR_CFG_MCLK},
    ...
    (_SENSORLIB_ == _SENSORLIB_CMOS_OV4689_||_SENSORLIB_ == _SENSORLIB_CMOS_IMX291M_||_SENSORLIB_ == _SENSORLIB_CMOS_IMX290LQR_) && (_SENSORLIB2_ == _SENSORLIB2_CMOS_IMX322LQJ_ || _SENSORLIB2_ == _SENSORLIB2_CMOS_IMX322LQJVX1_|| _SENSORLIB2_ == _SENSORLIB2_CMOS_OV9712VX1_|| _SENSORLIB2_ == _SENSORLIB2_CMOS_OV2710VX1_) && (_SENSORLIB3_ == _SENSORLIB3_OFF_) && (_SENSORLIB4_ == _SENSORLIB4_OFF_))
    ...
    */
    {
        PIN_FUNC_I2C,              PIN_I2C_CFG_NONE |
                                ...
                                PIN_I2C_CFG_CH2 |
#endif
        #if (_SENSORLIB_ == _SENSORLIB_CMOS_IMX291M_||_SENSORLIB_ ==_SENSORLIB_CMOS_IMX290LQR_)
