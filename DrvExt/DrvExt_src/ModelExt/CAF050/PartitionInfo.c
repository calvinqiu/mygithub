...
EMB_PARTITION gPartition[EMB_PARTITION_INFO_COUNT] _SECTION(".partitioninfo_data") = {
    ...
    [1] = {EMBTYPE_FAT,     0,  0x00600000, 0x00000000, 0x00000000},
    [2] = {EMBTYPE_PSTORE,  0,  0x00600000, 0x00200000, 0x00000000},
    #else
...
#if (_DSP_TYPE_ == _DSP_NONE_)
     [0] = {EMBTYPE_UITRON,  0,  0x00000000, 0x00300000, 0x00000000},
    [1] = {EMBTYPE_ECOS,    0,  0x00300000, 0x001CB000, 0x00000000},
    [2] = {EMBTYPE_FAT,     0,  0x004CB000, 0x00000000, 0x00000000},
    [3] = {EMBTYPE_PSTORE,  0,  0x004CB000, 0x00335000, 0x00000000},
#else
    [0] = {EMBTYPE_UITRON,  0,  0x00000000, 0x00300000, 0x00000000},
    [1] = {EMBTYPE_ECOS,    0,  0x00300000, 0x00200000, 0x00000000},
    [2] = {EMBTYPE_DSP,     0,  0x00500000, 0x00300000, 0x00000000},
    [3] = {EMBTYPE_FAT,     0,  0x00800000, 0x00000000, 0x00000000},
    [4] = {EMBTYPE_PSTORE,  0,  0x00800000, 0x00000000, 0x00000000},
#endif
#endif
