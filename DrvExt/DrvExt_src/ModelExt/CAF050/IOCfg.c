...
GPIO_INIT_OBJ uiGPIOMapInitTab[] = {
     ...
     //{  GPIO_SENSOR_28EN,       GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,   PAD_PIN_NOT_EXIST      },
     ...
     {  PGPIO_SENSOR_EN1,      GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,   PAD_PIN_NOT_EXIST      },
     {  PGPIO_SENSOR_EN2,      GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,   PAD_PIN_NOT_EXIST      },
     {  PGPIO_SENSOR_EN3,      GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,   PAD_PIN_NOT_EXIST      },
     {  S_GPIO_9,              GPIO_DIR_INPUT,     PAD_PULLUP,           PAD_PIN_SGPIO9        },
     {  S_GPIO_10,             GPIO_DIR_INPUT,     PAD_PULLUP,           PAD_PIN_SGPIO10       },
#if (_SENSORLIB2_ != _SENSORLIB2_OFF_)
     {  PGPIO_SENSOR2_PWR,       GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,   PAD_PIN_NOT_EXIST      },
#endif
