...
#define PGPIO_SENSOR_EN1            P_GPIO_36
#define PGPIO_SENSOR_EN2            P_GPIO_37
#define PGPIO_SENSOR_EN3            P_GPIO_40
...
// SENSOR2
#define PGPIO_SENSOR2_PWR           P_GPIO_18
#define SGPIO_SENSOR2_EXTCLK        S_GPIO_4
