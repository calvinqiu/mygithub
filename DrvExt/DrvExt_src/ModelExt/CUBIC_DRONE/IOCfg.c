...
GPIO_INIT_OBJ uiGPIOMapInitTab[] = {
     ...
     /* LED control */
     {  GPIO_GREEN_LED,         GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_LOW,   PAD_GREEN_LED         },
     {  GPIO_GREEN_LED_PWON,    GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_LOW,   PAD_GREEN_LED_PWON    },
     {  GPIO_RED_LED_STATUS4,   GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_LOW,   PAD_RED_LED_STATUS4   },
...
void Dx_InitIO(void)  // Config IO for external device
{
    ...
    ChargeIC_Open();    // Enable I2C I/F of Charge IC.
}

void Dx_UninitIO(void)  // Config IO for external device
{
    ChargeIC_Close();    // Disable I2C I/F of Charge IC.
}
