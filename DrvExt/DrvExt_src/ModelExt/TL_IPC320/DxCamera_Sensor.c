...
static SEN_PLUG_IN SenDetPlugInOnTab[SENSOR_ID_MAX_NUM] =
{
    NULL,   NULL,   NULL,   NULL,
        ...
        (_SENSORLIB_ == _SENSORLIB_CMOS_AR0330P_) &&      \
       (_SENSORLIB2_ == _SENSORLIB2_OFF_) &&            \
       (_SENSORLIB3_ == _SENSORLIB3_OFF_) &&            \
       (_SENSORLIB4_ == _SENSORLIB_OFF_))
...
static void SenPowerOn(void)
{
    ...
    {
        //pll_setPLL(PLL_ID_5, 0x90000);//54MHz
        //pll_setPLL(PLL_ID_5, 0x3c000); //25fps
        pll_setPLL(PLL_ID_5, 0x168000); //25fps
        pll_setPLLEn(PLL_ID_5, ENABLE);
    }
...
#elif ( (_MODEL_DSC_ != _MODEL_TL_IPC330_) &&            \
        (_SENSORLIB_ == _SENSORLIB_CMOS_AR0330M_) &&      \
       (_SENSORLIB2_ == _SENSORLIB2_OFF_) &&            \
       (_SENSORLIB3_ == _SENSORLIB3_OFF_) &&            \
       (_SENSORLIB4_ == _SENSORLIB_OFF_))
...
static SEN_PLUG_IN SenDetPlugInOnTab[SENSOR_ID_MAX_NUM] =
{
    ...
    NULL,   NULL,   NULL,   NULL,
        ...
        (_SENSORLIB_ == _SENSORLIB_CMOS_OV4689_) &&      \
        (_SENSORLIB2_ == _SENSORLIB2_OFF_) &&            \
        (_SENSORLIB3_ == _SENSORLIB3_OFF_) &&            \
        (_SENSORLIB4_ == _SENSORLIB_OFF_))
...
#elif ((_MODEL_DSC_ == _MODEL_TL_IPC321_) &&            \
       (_SENSORLIB_ == _SENSORLIB_CMOS_IMX291M_) &&     \
       (_SENSORLIB2_ == _SENSORLIB2_OFF_) &&            \
       (_SENSORLIB3_ == _SENSORLIB3_OFF_) &&            \
       (_SENSORLIB4_ == _SENSORLIB_OFF_))
...
static SENSOR_INIT_OBJ Sensor_GetObj(void)
{
    ...
    InitObj.Sen2LVDSPinMap[3] = 1;
    // MAGIC!
    static UINT32 lane_adj[6] = {76, 65, 71, 74, 67, 33};
    UINT32 i;
    for(i=0; i<6; i++){
        InitObj.Sen2LVDSPinMap[i+4] = lane_adj[i];
    }
...
static void SenPowerOn(void)
{
    ...
    gpio_setDir(GPIO_SENSOR_12V, GPIO_DIR_OUTPUT);
    gpio_setDir(GPIO_SENSOR_18V, GPIO_DIR_OUTPUT);
    gpio_setDir(GPIO_SENSOR_28V, GPIO_DIR_OUTPUT);
    Delay_DelayMs(5);
    gpio_setPin(GPIO_SENSOR_12V);
    Delay_DelayMs(5);
    gpio_setPin(GPIO_SENSOR_18V);
    Delay_DelayMs(5);
    gpio_setPin(GPIO_SENSOR_28V);
    Delay_DelayMs(5);
...
static void SenPowerOn(void)
{
    if (pll_getPLLEn(PLL_ID_5) == DISABLE)
    {
        pll_setPLL(PLL_ID_5, 0x40000/*0x90000*/);//54MHz
        pll_setPLLEn(PLL_ID_5, ENABLE);
    }
...
#elif ( (_MODEL_DSC_ == _MODEL_TL_IPC350_) &&            \
        (_SENSORLIB_ == _SENSORLIB_CMOS_OV5658M_) &&      \
        (_SENSORLIB2_ == _SENSORLIB2_OFF_) &&            \
        (_SENSORLIB3_ == _SENSORLIB3_OFF_) &&            \
        (_SENSORLIB4_ == _SENSORLIB_OFF_))
...
static void SenPowerOn(void)
{
    ...
    pll_selectClkSrc(PLL_CLK_SIEMCLK, PLL_CLKSRC_PLL5);
    pll_setClkFreq(PLL_CLK_SIEMCLK, 2400000);
    pll_setClkEn(PLL_CLK_SIEMCLK, ENABLE);
...
static SEN_GET_DRV SenDrvTab[SENSOR_ID_MAX_NUM] =
{
    Sensor_GetDrvTab_OV5658M,   NULL,   NULL,   NULL,
};
