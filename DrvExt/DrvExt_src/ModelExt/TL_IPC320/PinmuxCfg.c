...
const PIN_GROUP_CONFIG vTopConfig[] =
{
    ...
    {PIN_FUNC_MIPI_LVDS,        PIN_MIPI_LVDS_CFG_CLK0 | PIN_MIPI_LVDS_CFG_DAT0 | PIN_MIPI_LVDS_CFG_DAT1 | PIN_MIPI_LVDS_CFG_DAT2 | PIN_MIPI_LVDS_CFG_DAT3},
       ...
       ((_SENSORLIB_ == _SENSORLIB_CMOS_OV5658M_)  && (_SENSORLIB2_ == _SENSORLIB2_OFF_) && (_SENSORLIB3_ == _SENSORLIB3_OFF_) && (_SENSORLIB4_ == _SENSORLIB4_OFF_)))
    {PIN_FUNC_SENSOR,           PIN_SENSOR_CFG_MIPI|PIN_SENSOR_CFG_MCLK},
    {PIN_FUNC_SENSOR2,          PIN_SENSOR2_CFG_NONE},
    {PIN_FUNC_SENSOR3,          PIN_SENSOR3_CFG_NONE},
    {PIN_FUNC_SENSOR4,          PIN_SENSOR4_CFG_NONE},
    ...
    */
    {PIN_FUNC_I2C,              PIN_I2C_CFG_NONE |
     ...
     (_SENSORLIB_ == _SENSORLIB_CMOS_AR0230CS_) || (_SENSORLIB_ == _SENSORLIB_CMOS_IMX179_) || (_SENSORLIB_ == _SENSORLIB_CMOS_AR0237CS_) ||(_SENSORLIB_ == _SENSORLIB_CMOS_AR0237CSP_) ||(_SENSORLIB_ == _SENSORLIB_CMOS_AR0330P_)  || \
    ...
    //#NT#Add UART3/4 for Linux application
    {PIN_FUNC_UART,             PIN_UART_CFG_CH1 | PIN_UART_CFG_CH2 | PIN_UART_CFG_CH3 | PIN_UART_CFG_CH4},
...
void IO_InitPinmux(void)
{
    ...
    {
        PIN_GROUP_CONFIG* pConfig = (PIN_GROUP_CONFIG*)vTopConfig;
        if(pConfig[i].pinFunction == PIN_FUNC_SENSOR)
        {
            pConfig[i].config |= PIN_SENSOR_CFG_SPCLK;
            break;
        }
    }
#endif
