...
EMB_PARTITION gPartition[EMB_PARTITION_INFO_COUNT] _SECTION(".partitioninfo_data") = {
...
#if (_DSP_TYPE_ == _DSP_NONE_)
    #if (_INTERSTORAGE_ == _INTERSTORAGE_SPI_)
    //uITRON must start at 64K, all partition size must be 64K alignment.
    [0] = {EMBTYPE_UITRON,  0,  0x00010000, 0x002C0000, 0x00000000},
    [1] = {EMBTYPE_UENV,    0,  0x002D0000, 0x00040000, 0x00000000},
    [2] = {EMBTYPE_UBOOT,   0,  0x00310000, 0x00070000, 0x00000000},
    [3] = {EMBTYPE_LINUX,   0,  0x00380000, 0x00240000, 0x00000000},
    [4] = {EMBTYPE_UBIFS,   0,  0x005C0000, 0x00700000, 0x00000000},
    [5] = {EMBTYPE_PSTORE,  0,  0x00CC0000, 0x00340000, 0x00000000},
    #else
    [0] = {EMBTYPE_UITRON,  0,  0x00000000, 0x00900000, 0x00000000},
    ...
    [5] = {EMBTYPE_PSTORE,  0,  0x07B40000, 0x004C0000, 0x00100000},
    #endif
#else
    [0] = {EMBTYPE_UITRON,  0, 0x00010000, 0x00280000, 0x00000000},
    [1] = {EMBTYPE_DSP,     0, 0x00290000, 0x00040000, 0x00000000},
    [2] = {EMBTYPE_UENV,    0, 0x002D0000, 0x00040000, 0x00000000},
    [3] = {EMBTYPE_UBOOT,   0, 0x00310000, 0x00070000, 0x00000000},
    [4] = {EMBTYPE_LINUX,   0, 0x00380000, 0x00240000, 0x00000000},
    [5] = {EMBTYPE_UBIFS,   0, 0x005C0000, 0x00700000, 0x00000000},
#endif
#endif
