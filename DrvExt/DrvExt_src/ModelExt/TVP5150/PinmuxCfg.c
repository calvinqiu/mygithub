...
#endif
#if ((_SENSORLIB_ == _SENSORLIB_CMOS_OV4689_) || (_SENSORLIB_ == _SENSORLIB_CMOS_AR0330M_) || (_SENSORLIB_ == _SENSORLIB_CMOS_AR0230CS_) || (_SENSORLIB2_ == _SENSORLIB2_CMOS_TVP5150_) || \
     (_SENSORLIB_ == _SENSORLIB_CMOS_TVP5150_))
                                PIN_I2C_CFG_CH1_2ND_PINMUX |
#endif
