...
//#define GPIO_LCD_RESET              P_GPIO_1 //FPGA not support
...
#define PWMID_LCD_BLG_PCTL          PWMID_x
        ...
        #define GPIO_LCD_BLG_PCTL           P_GPIO_15 //P_GPIO_16
        #define PAD_LCD_BLG_PCTL            PAD_PIN_PGPIO15//PAD_PIN_PGPIO16
    #else
...
#define	GPIO_4G_WAKE_UP				L_GPIO_27
#define	GPIO_4G_MODE0				L_GPIO_26

#define	GPIO_MCU_RESET				P_GPIO_4
...
#define GPIO_SENSOR_PWREN1_2V       P_GPIO_8
#define GPIO_SENSOR_PWREN1_8V       P_GPIO_9
#define GPIO_SENSOR_PWREN2_8V       P_GPIO_10
...
#define GPIO_WIFI_SHDN C_GPIO_12 //WiFi Shut Down
    ...
    #define GPIO_MCU2NTK_GSENSOR_STATUS             P_GPIO_36
    #define PAD_MCU2NTK_GSENSOR_STATUS              PAD_PIN_PGPIO36
#endif
...
#define GPIO_GSENSOR_POWERON		P_GPIO_7
#define PAD_GSENSOR_POWERON			PAD_PIN_PGPIO7
extern BOOL  GPIO_GSENSOR_POWERON_ANDROID(void);	//yliu_add_for_GSENSOR_POWER
#endif
