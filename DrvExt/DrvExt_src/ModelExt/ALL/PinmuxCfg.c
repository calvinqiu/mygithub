...
const PIN_GROUP_CONFIG vTopConfig[] =
{
    ...
    (_SENSORLIB_ == _SENSORLIB_CMOS_OV4689_||_SENSORLIB_ == _SENSORLIB_CMOS_IMX291M_) && (_SENSORLIB2_ == _SENSORLIB2_CMOS_IMX322LQJ_ || _SENSORLIB2_ == _SENSORLIB2_CMOS_IMX322LQJVX1_|| _SENSORLIB2_ == _SENSORLIB2_CMOS_OV9712VX1_|| _SENSORLIB2_ == _SENSORLIB2_CMOS_OV2710VX1_) && (_SENSORLIB3_ == _SENSORLIB3_OFF_) && (_SENSORLIB4_ == _SENSORLIB4_OFF_))
    ...
    {PIN_FUNC_SENSOR4,          PIN_SENSOR4_CFG_NONE},
    {PIN_FUNC_MIPI_LVDS,        PIN_MIPI_LVDS_CFG_NONE},
    #elif ((_SENSORLIB_ == _SENSORLIB_CMOS_AR0238CSP_) && (_SENSORLIB2_ == _SENSORLIB2_OFF_) && (_SENSORLIB3_ == _SENSORLIB3_OFF_) && (_SENSORLIB4_ == _SENSORLIB4_OFF_))
    {PIN_FUNC_SENSOR,           PIN_SENSOR_CFG_12BITS|PIN_SENSOR_CFG_MCLK},
    {PIN_FUNC_SENSOR2,          PIN_SENSOR2_CFG_NONE},
    {PIN_FUNC_SENSOR3,          PIN_SENSOR3_CFG_NONE},
    {PIN_FUNC_SENSOR4,          PIN_SENSOR4_CFG_NONE},
    {PIN_FUNC_MIPI_LVDS,        PIN_MIPI_LVDS_CFG_NONE},
    #elif ((_SENSORLIB_ == _SENSORLIB_CMOS_AR0238CSP_) && (_SENSORLIB2_ == _SENSORLIB2_CMOS_IMX322LQJVX1_) && (_SENSORLIB3_ == _SENSORLIB3_OFF_) && (_SENSORLIB4_ == _SENSORLIB4_OFF_))
    {PIN_FUNC_SENSOR,           PIN_SENSOR_CFG_12BITS|PIN_SENSOR_CFG_MCLK},
    {PIN_FUNC_SENSOR2,          PIN_SENSOR2_CFG_NONE},
    {PIN_FUNC_SENSOR3,          PIN_SENSOR3_CFG_NONE},
    {PIN_FUNC_SENSOR4,          PIN_SENSOR4_CFG_NONE},
    ...
    */
    {
        ...
        #endif
        #if ((_SENSORLIB_ == _SENSORLIB_CMOS_IMX291M_)||(_SENSORLIB_ == _SENSORLIB_CMOS_OV4689_) || (_SENSORLIB_ == _SENSORLIB_CMOS_AR0330M_) || (_SENSORLIB_ == _SENSORLIB_CMOS_AR0230CS_) || (_SENSORLIB_ == _SENSORLIB_CMOS_AR0238CS_))
        PIN_I2C_CFG_CH1_2ND_PINMUX |
        #endif
		#if(_SENSORLIB_ == _SENSORLIB_CMOS_AR0238CSP_)
		PIN_I2C_CFG_CH1_2ND_PINMUX |
		#endif
    ...
    //
    {
        ...
        PINMUX_DISPMUX_SEL_LCD | PINMUX_DSI_2_LANE_VDO_SYNC_EVENT_RGB888 |
//      #if defined(YQCONFIG_CHANGE_NEW_LCD_OR_NOT)
	 #elif (_LCDTYPE_ == _LCDTYPE_XJ040WV1402C_R61408_DSI_ && defined(YQCONFIG_CHANGE_NEW_LCD_OR_NOT))
       // PINMUX_DISPMUX_SEL_LCD | PINMUX_DSI_2_LANE_CMD_MODE_RGB888 |
               PINMUX_DISPMUX_SEL_LCD | PINMUX_DSI_2_LANE_VDO_SYNC_EVENT_RGB888|//modify LCD by qiuhan on 20171123 
        #elif (_LCDTYPE_ == _LCDTYPE_XJ040WV1402C_R61408_DSI_ && !defined(YQCONFIG_CHANGE_NEW_LCD_OR_NOT))
		 PINMUX_DISPMUX_SEL_LCD | PINMUX_DSI_2_LANE_CMD_MODE_RGB888 |//old LCD
        #else
