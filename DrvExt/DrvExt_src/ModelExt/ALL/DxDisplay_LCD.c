...
#define LCD_MAX_W                       ALIGN_CEIL_16(864)  //device w of DISP_LCDMODE_xxx, to support rotate, it must align to 16
...
#elif (_LCDTYPE_ == _LCDTYPE_TWJ50IP008_ILI9806E_)
#define LCD_MAX_W                       ALIGN_CEIL_16(864)  //device w of DISP_LCDMODE_xxx, to support rotate, it must align to 16
#define LCD_MAX_H                       ALIGN_CEIL_16(480)  //device h of DISP_LCDMODE_xxx, to support rotate, it must align to 16
#define LCD_ASPECT_W                    16
#define LCD_ASPECT_H                    9
...
#elif (_LCDTYPE_ == _LCDTYPE_XJ040WV1402C_R61408_DSI_)
...
#define LCD_MAX_W                       ALIGN_CEIL_16(YQCONFIG_LCD_WIDTH_CUST)  //device w of DISP_LCDMODE_xxx, to support rotate, it must align to 16
#define LCD_MAX_H                       ALIGN_CEIL_16(YQCONFIG_LCD_HEIGHT_CUST)  //device h of DISP_LCDMODE_xxx, to support rotate, it must align to 16
#define LCD_ASPECT_W                    16
#define LCD_ASPECT_H                    9
#else
...
{
    // Reset LCD
#if defined(YQCONFIG_LCD_RESET_REVERSE_SUPPORT)    
    // Reset LCD
