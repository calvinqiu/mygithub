...
static void SenPowerOn(void)
{
    debug_msg("IMX322 sensor power on ..\r\n");
    #if defined(YQCONFIG_PLATFORM_NAME_LINGMU)
    gpio_setDir(GPIO_SENSOR_PWREN1_2V, GPIO_DIR_OUTPUT);
    gpio_setPin(GPIO_SENSOR_PWREN1_2V);
    Delay_DelayMs(10);
    gpio_setDir(GPIO_SENSOR_PWREN1_8V, GPIO_DIR_OUTPUT);
    gpio_setPin(GPIO_SENSOR_PWREN1_8V);
    Delay_DelayMs(10);
    gpio_setDir(GPIO_SENSOR_PWREN2_8V, GPIO_DIR_OUTPUT);
    gpio_setPin(GPIO_SENSOR_PWREN2_8V);
    Delay_DelayMs(20);
...
static SENSOR_INIT_OBJ Sensor_GetObj(void)
{
    ...
    InitObj.CmdInfo.INFO.I2C.extSlaveAddrEnable = FALSE;
    InitObj.ChgMclkEn = ENABLE;
#if defined(YQCONFIG_COMB_SENSOR_ROTATE_OPTION_MIRROR)
    InitObj.Option = SENSOR_OPTION_MIRROR;
#elif defined(YQCONFIG_COMB_SENSOR_ROTATE_OPTION_FLIP)
	InitObj.Option = SENSOR_OPTION_FLIP;
#else
#error (YQCONFIG_COMB_SENSOR_ROTATE_OPTION NOT DEFINED)
#endif
    return InitObj;
}
...
static void SenPowerOn(void)
{
    ...
    Delay_DelayMs(10);
    gpio_setDir(P_GPIO_2, GPIO_DIR_OUTPUT);
...
#elif ((_SENSORLIB_ == _SENSORLIB_CMOS_OV4689_) &&      \
       (_SENSORLIB2_ == _SENSORLIB2_CMOS_OV9712VX1_) &&            \
       (_SENSORLIB3_ == _SENSORLIB3_OFF_) &&            \
       (_SENSORLIB4_ == _SENSORLIB_OFF_))
#if _FPGA_EMULATION_
#include "pll_protected.h"
...
static SEN_GET_DRV SenDrvTab[SENSOR_ID_MAX_NUM] =
{
    Sensor_GetDrvTab_OV4689,   Sensor_GetDrvTab_OV9712VX1,   NULL,   NULL,
};
...
#elif ((_SENSORLIB_ == _SENSORLIB_CMOS_OV4689_) &&      \
       (_SENSORLIB2_ == _SENSORLIB2_CMOS_OV2710VX1_) &&            \
       (_SENSORLIB3_ == _SENSORLIB3_OFF_) &&            \
       (_SENSORLIB4_ == _SENSORLIB_OFF_))
#if _FPGA_EMULATION_
#include "pll_protected.h"
...
static SEN_GET_DRV SenDrvTab[SENSOR_ID_MAX_NUM] =
{
    Sensor_GetDrvTab_OV4689,   Sensor_GetDrvTab_OV2710VX1,   NULL,   NULL,
};
...
#if defined(YQCONFIG_COMB_SENSOR_ROTATE_OPTION_FLIP_MIRROR)
InitObj.Option = SENSOR_OPTION_FLIP_MIRROR;
#elif defined(YQCONFIG_COMB_SENSOR_ROTATE_OPTION_FLIP)
InitObj.Option = SENSOR_OPTION_FLIP;
#elif defined(YQCONFIG_COMB_SENSOR_ROTATE_OPTION_MIRROR)
InitObj.Option = SENSOR_OPTION_MIRROR;
#elif defined(YQCONFIG_COMB_SENSOR_ROTATE_OPTION_NONE)
...
static void SenPowerOn(void)
{
    debug_msg("IMX291 sensor power on ..\r\n");
    gpio_setDir(GPIO_SENSOR_PWREN1_2V, GPIO_DIR_OUTPUT);
    gpio_setPin(GPIO_SENSOR_PWREN1_2V);
    Delay_DelayMs(10);
    gpio_setDir(GPIO_SENSOR_PWREN1_8V, GPIO_DIR_OUTPUT);
...
static SENSOR_INIT_OBJ Sensor_GetObj2(void)
{
    ...
    InitObj.CmdInfo.INFO.I2C.I2c = SENSOR_I2C3_Vx1;
    InitObj.CmdInfo.INFO.I2C.extSlaveAddrEnable = FALSE;
#if defined(YQCONFIG_COMB_SENSOR_2_ROTATE_OPTION_FLIP_MIRROR)
InitObj.Option = SENSOR_OPTION_FLIP_MIRROR;
#elif defined(YQCONFIG_COMB_SENSOR_2_ROTATE_OPTION_FLIP)
InitObj.Option = SENSOR_OPTION_FLIP;
#elif defined(YQCONFIG_COMB_SENSOR_2_ROTATE_OPTION_MIRROR)
InitObj.Option = SENSOR_OPTION_MIRROR;
#elif defined(YQCONFIG_COMB_SENSOR_2_ROTATE_OPTION_NONE)
InitObj.Option = SENSOR_OPTION_NONE;
#else
#error(YQCONFIG_COMB_SENSOR_2_ROTATE_OPTION NOT DEFINED)
#endif
    InitObj.ChgMclkEn = ENABLE;
    return InitObj;
}
...
static SEN_GET_DRV SenDrvTab[SENSOR_ID_MAX_NUM] =
{
    Sensor_GetDrvTab_IMX291M,   Sensor_GetDrvTab_IMX322LQJVX1,   NULL,   NULL,
};
...
#elif ((_SENSORLIB_ == _SENSORLIB_CMOS_AR0238CSP_) &&      \
       (_SENSORLIB2_ == _SENSORLIB2_OFF_) &&            \
       (_SENSORLIB3_ == _SENSORLIB3_OFF_) &&            \
       (_SENSORLIB4_ == _SENSORLIB4_OFF_))
static SENSOR_INIT_OBJ Sensor_GetObj(void)
...
debug_msg("IMX0238 sensor power on ..\r\n");
//Step1. (Set default) S_GPIO7=1
    gpio_setDir(GPIO_SENSOR_RESET,GPIO_DIR_OUTPUT);
    gpio_setPin(GPIO_SENSOR_RESET);

//Step2. (Enable MCLK) Wait 1ms, enable SN_MCLK(24MHz)
    gpio_setDir(GPIO_SENSOR_PWREN1_2V, GPIO_DIR_OUTPUT);
    gpio_setPin(GPIO_SENSOR_PWREN1_2V);
    Delay_DelayMs(10);
    gpio_setDir(GPIO_SENSOR_PWREN1_8V, GPIO_DIR_OUTPUT);
    ...
    gpio_setDir(GPIO_SENSOR_STANDBY, GPIO_DIR_OUTPUT);
    gpio_setPin(GPIO_SENSOR_STANDBY);
//Step3. (Enable MCLK) Wait 1ms, enable SN_MCLK(24MHz)
    Delay_DelayMs(1);
...
//Step4. (Reset sensor) Wait 1ms, S_GPIO7=0. Wait 2ms, S_GPIO7=1.
    Delay_DelayMs(10);
...
static SEN_GET_DRV SenDrvTab[SENSOR_ID_MAX_NUM] =
{
    Sensor_GetDrvTab_AR0238CSP,  NULL,   NULL,   NULL,
};
...
static SEN_GET_DRV SenDrvTab[SENSOR_ID_MAX_NUM] =
{
    Sensor_GetDrvTab_OV4689,   Sensor_GetDrvTab_IMX322LQJVX1,   NULL,   NULL,
};
...
static SENSOR_INIT_OBJ Sensor_GetObj2(void)
	{
		...
		static SEN_GET_DRV SenDrvTab[SENSOR_ID_MAX_NUM] =
		{
			Sensor_GetDrvTab_AR0238CSP,	Sensor_GetDrvTab_IMX322LQJVX1,	 NULL,	 NULL,
		};
