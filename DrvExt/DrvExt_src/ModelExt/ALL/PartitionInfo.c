...
#if (_DSP_TYPE_ == _DSP_NONE_)
 #if (_INTERSTORAGE_ == _INTERSTORAGE_SPI_)
    [0] = {EMBTYPE_UITRON,  0,  SIZE_UNIT(0x00000000), SIZE_UNIT(0x00400000), SIZE_UNIT(0x00000000)},
    [1] = {EMBTYPE_ECOS,    0,  SIZE_UNIT(0x00400000), SIZE_UNIT(0x00200000), SIZE_UNIT(0x00000000)},
    [2] = {EMBTYPE_FAT,     0,  SIZE_UNIT(0x00600000), SIZE_UNIT(0x00000000), SIZE_UNIT(0x00000000)},
    [3] = {EMBTYPE_PSTORE,  0,  SIZE_UNIT(0x00600000), SIZE_UNIT(0x00200000), SIZE_UNIT(0x00080000)},
    #else
    [0] = {EMBTYPE_UITRON,  0,  SIZE_UNIT(0x00000000), SIZE_UNIT(0x00900000), SIZE_UNIT(0x00000000)},
    [1] = {EMBTYPE_ECOS,    0,  SIZE_UNIT(0x00900000), SIZE_UNIT(0x00200000), SIZE_UNIT(0x00000000)},
    [2] = {EMBTYPE_FAT,     0,  SIZE_UNIT(0x00B00000), SIZE_UNIT(0x07000000), SIZE_UNIT(0x00200000)},
    [3] = {EMBTYPE_PSTORE,  0,  SIZE_UNIT(0x07B00000), SIZE_UNIT(0x00500000), SIZE_UNIT(0x00080000)},
    #endif
/*
    [0] = {EMBTYPE_UITRON,  0,  0x00000000, 0x00400000, 0x00000000},
    [1] = {EMBTYPE_ECOS,    0,  0x00400000, 0x00200000, 0x00000000},
    [2] = {EMBTYPE_FAT,     0,  0x00600000, 0x00000000, 0x00000000},
    [3] = {EMBTYPE_PSTORE,  0,  0x00600000, 0x00200000, 0x00080000},
*/
#else
    [0] = {EMBTYPE_UITRON,  0,  SIZE_UNIT(0x00000000), SIZE_UNIT(0x00400000), SIZE_UNIT(0x00000000)},
    [1] = {EMBTYPE_ECOS,    0,  SIZE_UNIT(0x00400000), SIZE_UNIT(0x00130000), SIZE_UNIT(0x00000000)},
    [2] = {EMBTYPE_DSP,     0,  SIZE_UNIT(0x00530000), SIZE_UNIT(0x00200000), SIZE_UNIT(0x00000000)},
    [3] = {EMBTYPE_FAT,     0,  SIZE_UNIT(0x00730000), SIZE_UNIT(0x00000000), SIZE_UNIT(0x00000000)},
    [4] = {EMBTYPE_PSTORE,  0,  SIZE_UNIT(0x00730000), SIZE_UNIT(0x000D0000), SIZE_UNIT(0x00000000)},
#endif
#endif
