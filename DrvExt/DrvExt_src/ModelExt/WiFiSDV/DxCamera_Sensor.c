...
#elif ((_SENSORLIB_ == _SENSORLIB_CMOS_MN34120_) &&   \
     (_SENSORLIB2_ == _SENSORLIB2_OFF_) &&          \
     (_SENSORLIB3_ == _SENSORLIB3_OFF_) &&          \
     (_SENSORLIB4_ == _SENSORLIB4_OFF_))
static SENSOR_INIT_OBJ Sensor_GetObj(void)
{
    ...
    Sensor pin                   LVDS pin
    0   ch 1 port 0  SDOD0 ->    0
    1   ch 1 port 1  SDOD1 ->    2
    2   ch 1 port 2  SDOD3 ->    4
    3   ch 1 port 3  SDOD4 ->    6
    4   ch 2 port 3  SDOD6 ->    7
    5   ch 2 port 2  SDOD7 ->    5
    6   ch 2 port 1  SDOD9 ->    3
...
#if 0
    InitObj.Sen2LVDSPinMap[0] = 0;
    InitObj.Sen2LVDSPinMap[1] = 2;
    InitObj.Sen2LVDSPinMap[2] = 4;
    InitObj.Sen2LVDSPinMap[3] = 6;
    InitObj.Sen2LVDSPinMap[4] = 7;
    InitObj.Sen2LVDSPinMap[5] = 5;
    InitObj.Sen2LVDSPinMap[6] = 3;
...
#if 0
    InitObj.Sen2LVDSPinMap[0] = 0;
    InitObj.Sen2LVDSPinMap[1] = 10;
    InitObj.Sen2LVDSPinMap[2] = 1;
    InitObj.Sen2LVDSPinMap[3] = 9;
    InitObj.Sen2LVDSPinMap[4] = 3;
    InitObj.Sen2LVDSPinMap[5] = 7;
    InitObj.Sen2LVDSPinMap[6] = 4;
...
static void SenPowerOn(void)
{
    ...
    gpio_setPin(GPIO_SENSOR_PWM2);// 1.2 EN // P_GPIO_36
    Delay_DelayMs(10);
    gpio_setPin(GPIO_SENSOR_PWM1);// 1.8 EN // P_GPIO_37
    Delay_DelayMs(10);
    gpio_setPin(GPIO_SENSOR_PWM0);// 3.3 EN // P_GPIO_40
    ...
    pll_selectClkSrc(PLL_CLK_SIEMCLK, PLL_CLKSRC_PLL5);
    pll_setClkFreq(PLL_CLK_SIEMCLK, 54000000);//.54MHz
...
static SEN_GET_DRV SenDrvTab[SENSOR_ID_MAX_NUM] =
{
    Sensor_GetDrvTab_MN34120,   NULL,   NULL,   NULL,
};
...
#ifdef DoubleSDCardEN  //lim20150921
...
#elif ((_SENSORLIB_ == _SENSORLIB_CMOS_OV12895M_) &&   \
     (_SENSORLIB2_ == _SENSORLIB2_OFF_) &&          \
     (_SENSORLIB3_ == _SENSORLIB3_OFF_) &&          \
     (_SENSORLIB4_ == _SENSORLIB4_OFF_))
...
static SENSOR_INIT_OBJ Sensor_GetObj(void)
{
    ...
    InitObj.CmdInfo.CmdType = SENSOR_CMD_I2C;
    InitObj.CmdInfo.INFO.I2C.I2c = SENSOR_I2C1_2ND;
    InitObj.CmdInfo.INFO.I2C.extSlaveAddrEnable = TRUE;
...
static void SenPowerOn(void)
{
    if (pll_getPLLEn(PLL_ID_5) == DISABLE)
    {
        pll_setPLL(PLL_ID_5, 0x40000);//24MHz
        pll_setPLLEn(PLL_ID_5, ENABLE);
    }
...
static SEN_GET_DRV SenDrvTab[SENSOR_ID_MAX_NUM] =
{
    Sensor_GetDrvTab_OV12895M,   NULL,   NULL,   NULL,
};
