...
#define GPIO_LCD_BLG_PCTL           P_GPIO_33
#define PAD_LCD_BLG_PCTL            PAD_PIN_PGPIO33
#endif

#define GPIO_GPS_PWR 	P_GPIO_8
#define PAD_GPS_PWR           PAD_PIN_PGPIO8

#define GPIO_REC_LED	P_GPIO_2
#define PAD_REC_LED		PAD_PIN_PGPIO2
#define GPIO_MUTE_LED	P_GPIO_9
#define PAD_MUTE_LED	PAD_PIN_PGPIO9
...
#define GPIO_SENSOR_PWR0            P_GPIO_36  //1.2V
#define GPIO_SENSOR_PWR1            P_GPIO_37  //1.8V
#define GPIO_SENSOR_PWR2            P_GPIO_40  //2.9V

#define GPIO_SENSOR2_PWR            P_GPIO_15  // maybe  VX1_PWR_ON
...
#define GPIO_WIFI_SHDN 		C_GPIO_6 //WiFi Shut Down
#define PAD_WIFI_SHDN 		PAD_PIN_CGPIO6//WiFi Shut Down
