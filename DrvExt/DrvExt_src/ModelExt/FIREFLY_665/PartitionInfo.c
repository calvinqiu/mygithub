...
#if (_DSP_TYPE_ == _DSP_NONE_)
    [0] = {EMBTYPE_UITRON,  0,  0x00000000, 0x002AF000, 0x00000000},
    [1] = {EMBTYPE_ECOS,    0,  0x002AF000, 0x00121000, 0x00000000},
    [2] = {EMBTYPE_PSTORE,  0,  0x003D0000, 0x00030000, 0x00000000},
#else
    [0] = {EMBTYPE_UITRON,  0,  0x00000000, 0x002AF000, 0x00000000},
    [1] = {EMBTYPE_ECOS,    0,  0x002AF000, 0x00121000, 0x00000000},
    [2] = {EMBTYPE_DSP,     0,  0x003D0000, 0x00360000, 0x00000000},
    [3] = {EMBTYPE_FAT,     0,  0x00730000, 0x00000000, 0x00000000},
    [4] = {EMBTYPE_PSTORE,  0,  0x00730000, 0x00030000, 0x00000000},
#endif
#endif
