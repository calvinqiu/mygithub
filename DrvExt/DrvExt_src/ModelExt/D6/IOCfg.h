...
#define GPIO_LCD_RESET              P_GPIO_2 //FPGA not support

#define HIGHT_LOW_HIGH   0
#define LOW_HIGH_LOW   1

#define LCD_RESET_MODE  LOW_HIGH_LOW
...
#define GPIO_SENSOR2_PWR            C_GPIO_12//P_GPIO_2
...
// RTL 8192/8189
#define GPIO_WIFI_SHDN  P_GPIO_3//C_GPIO_12 //WiFi Shut Down

#define GPIO_WIFI_PWR_EN   P_GPIO_7
//--------------------------------------------------------------------
// Storbe device
//--------------------------------------------------------------------
// STROBE
