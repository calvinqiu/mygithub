...
EMB_PARTITION gPartition[EMB_PARTITION_INFO_COUNT] _SECTION(".partitioninfo_data") = {
	...
	[2] = {EMBTYPE_UENV,    0,  SIZE_UNIT(0x00B00000), SIZE_UNIT(0x00040000), SIZE_UNIT(0x00000000)},
    [3] = {EMBTYPE_LINUX,   0,  SIZE_UNIT(0x00B40000), SIZE_UNIT(0x00500000), SIZE_UNIT(0x00000000)},
    [4] = {EMBTYPE_UBIFS,   0,  SIZE_UNIT(0x01040000), SIZE_UNIT(0x05600000), SIZE_UNIT(0x00000000)},
    [5] = {EMBTYPE_DSP,     0,  SIZE_UNIT(0x06640000), SIZE_UNIT(0x00500000), SIZE_UNIT(0x00000000)},
    [6] = {EMBTYPE_PSTORE,  0,  SIZE_UNIT(0x06B40000), SIZE_UNIT(0x014C0000), SIZE_UNIT(0x00100000)},
#endif
#endif
