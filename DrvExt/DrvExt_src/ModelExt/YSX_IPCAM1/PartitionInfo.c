...
EMB_PARTITION gPartition[EMB_PARTITION_INFO_COUNT] _SECTION(".partitioninfo_data") = {
    ...
    #else
    [0] = {EMBTYPE_UITRON,  0,  0x00000000, 0x00900000, 0x00000000},
    [1] = {EMBTYPE_ECOS,    0,  0x00900000, 0x00300000, 0x00000000},
    [2] = {EMBTYPE_FAT,     0,  0x00C00000, 0x06F00000, 0x00200000},
    [3] = {EMBTYPE_PSTORE,  0,  0x07B00000, 0x00500000, 0x00080000},
    #endif
#else
    [0] = {EMBTYPE_UITRON,  0,  0x00000000, 0x00900000, 0x00000000},
    [1] = {EMBTYPE_ECOS,    0,  0x00900000, 0x00300000, 0x00000000},
    [2] = {EMBTYPE_DSP,     0,  0x00C00000, 0x00500000, 0x00000000},
    [3] = {EMBTYPE_FAT,     0,  0x01100000, 0x06A00000, 0x00200000},
...
#if (_DSP_TYPE_ == _DSP_NONE_)
	#if (_INTERSTORAGE_ == _INTERSTORAGE_SPI_)
		[0] = {EMBTYPE_UITRON,  0,  0x00000000, 0x002C0000, 0x00000000},
		[1] = {EMBTYPE_UBOOT,   0,  0x002C0000, 0x00070000, 0x00000000},
    	[2] = {EMBTYPE_UENV,    0,  0x00330000, 0x00040000, 0x00000000},
    	[3] = {EMBTYPE_LINUX,   0,  0x00370000, 0x002C0000, 0x00000000},
    	[4] = {EMBTYPE_UBIFS,   0,  0x00630000, 0x00700000, 0x00000000},
    	[5] = {EMBTYPE_PSTORE,  0,  0x00E30000, 0x00100000, 0x00100000},
	#else
    	[0] = {EMBTYPE_UITRON,  0,  0x00000000, 0x00900000, 0x00000000},
