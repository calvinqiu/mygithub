...
const PIN_GROUP_CONFIG vTopConfig[] =
{
...
#elif ((_SENSORLIB_ == _SENSORLIB_OFF_)  && (_SENSORLIB2_ == _SENSORLIB2_CMOS_NT99141_) && (_SENSORLIB3_ == _SENSORLIB3_OFF_) && (_SENSORLIB4_ == _SENSORLIB4_OFF_))
    {PIN_FUNC_SENSOR,           PIN_SENSOR_CFG_NONE},
    {PIN_FUNC_SENSOR2,          PIN_SENSOR2_CFG_CCIR8BITS|PIN_SENSOR_CFG_MCLK}, //ipl tmp, special case for FPGA, Sensor 2 need use MCLK replace MCLK2
    {PIN_FUNC_SENSOR3,          PIN_SENSOR2_CFG_NONE},
    {PIN_FUNC_SENSOR4,          PIN_SENSOR2_CFG_NONE},
    {PIN_FUNC_MIPI_LVDS,        PIN_SENSOR_CFG_NONE},
#endif
    ...
    */
    {PIN_FUNC_I2C,              PIN_I2C_CFG_NONE |
                                ...
                                PIN_I2C_CFG_CH1 |
#endif
#if (_SENSORLIB_ == _SENSORLIB_CMOS_IMX124LQT_)
                                PIN_I2C_CFG_CH1 |
#endif
#if (_SENSORLIB_ == _SENSORLIB_CMOS_OV4689_)
                                PIN_I2C_CFG_CH1 |
#endif
...
#if ((_LENSMOTORLIB_ == _LENSMOTORLIB_G2007_) || (_SENSORLIB_ == _SENSORLIB_CMOS_MN34110_))
                                PIN_SIF_CFG_CH2 |
#endif
