...
#define LCD_COMM_CTRL               LCD_COMM_BY_GPIO //FPGA
#if (LCD_COMM_CTRL == LCD_COMM_BY_GPIO)
#define GPIO_LCD_SIF_SEN            S_GPIO_4 //FPGA
#define GPIO_LCD_SIF_SCK            S_GPIO_5 //FPGA
#define GPIO_LCD_SIF_SDA            S_GPIO_6 //FPGA
#endif
