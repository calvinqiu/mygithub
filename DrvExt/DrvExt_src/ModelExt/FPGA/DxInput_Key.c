...
#if (ADC_KEY == ENABLE)
#define VOLDET_KEY_ADC_RANGE         (240)
#define VOLDET_KEY_ADC_LVL0          (0)
#define VOLDET_KEY_ADC_LVL1          (1048-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL2          (2100-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL3          (3152-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_TH            (3152+VOLDET_KEY_ADC_RANGE)
...
static UINT32 VolDet_GetKey1Level(void)
{
    ...
    if (uiKey1ADC < VOLDET_KEY_ADC_TH) //768+30
    {
        ...
        else if (uiKey1ADC < VOLDET_KEY_ADC_TH) //<30
        {
...
#if (ADC_KEY == ENABLE)
    if (VolDet_GetKey1Level() == VOLDET_KEY_LVL_3)
    {
        uiKeyCode |= FLGKEY_UP;
    }
    if (VolDet_GetKey1Level() == VOLDET_KEY_LVL_2)
    {
        uiKeyCode |= FLGKEY_LEFT;
    }
    if (VolDet_GetKey1Level() == VOLDET_KEY_LVL_1)
    {
        uiKeyCode |= FLGKEY_DOWN;
    }
    if (VolDet_GetKey1Level() == VOLDET_KEY_LVL_0)
    {
