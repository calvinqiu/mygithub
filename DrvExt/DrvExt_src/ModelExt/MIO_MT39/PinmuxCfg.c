...
const PIN_GROUP_CONFIG vTopConfig[] =
{
    ...
    {PIN_FUNC_SDIO3,            PIN_SDIO_CFG_NONE}, //it conflict with SPI4_1, UART2_2
    ...
    //
#if ((_SENSORLIB_ == _SENSORLIB_CMOS_IMX322LQJ_)  && (_SENSORLIB2_ == _SENSORLIB2_CMOS_ISX016VX1_ ||_SENSORLIB2_ == _SENSORLIB2_CMOS_ISX016VX1_HDP60_) && (_SENSORLIB3_ == _SENSORLIB3_OFF_) && (_SENSORLIB4_ == _SENSORLIB4_OFF_))
...
#endif
                                0},
    {PIN_FUNC_UART,             PIN_UART_CFG_CH1 | PIN_UART_CFG_CH2 | PIN_UART_CFG_CH2_CTSRTS},
...
#endif
                                //PIN_SPI_CFG_CH2 | PIN_SPI_CFG_CH2_2BITS |  // by jack for inova
                                0},
...
#if (_LCDTYPE_ == _LCDTYPE_M935UX01M_SN75LVDS83B_)
                                PINMUX_DISPMUX_SEL_LCD | PINMUX_LCDMODE_RGB_PARALL |
#elif (_LCDTYPE_ == _LCDTYPE_TG078UW006A0_DSI_)
