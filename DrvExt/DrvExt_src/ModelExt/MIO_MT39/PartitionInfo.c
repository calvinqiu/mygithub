...
EMB_PARTITION gPartition[EMB_PARTITION_INFO_COUNT] _SECTION(".partitioninfo_data") = {
...
#if (_DSP_TYPE_ == _DSP_NONE_)
    #if (_INTERSTORAGE_ == _INTERSTORAGE_SPI_)
    [0] = {EMBTYPE_UITRON,  0,  0x00000000, 0x002CD000, 0x00000000},
    [1] = {EMBTYPE_ECOS,    0,  0x002CD000, 0x0010E000, 0x00000000},
    [2] = {EMBTYPE_FAT,     0,  0x003DB000, 0x00000000, 0x00000000},
    [3] = {EMBTYPE_PSTORE,  0,  0x003DB000, 0x00025000, 0x00000000},
    #else
    [0] = {EMBTYPE_UITRON,  0,  0x00000000, 0x00900000, 0x00000000},
    ...
    [6] = {EMBTYPE_PSTORE,  0,  0x07B40000, 0x004C0000, 0x00100000},
#endif
#endif
