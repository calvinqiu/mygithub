...
const int als_intt_value[] = {2, 3, 4, 6, 8, 10, 15, 20, 35, 50, 70, 100, 150, 250, 350, 500, 750, 1000, 2000, 3000, 4000, 6000, 8000, 12000, 16000};
...
const int ps_intt_value[] = {4, 6, 8, 10, 16, 20, 26, 30, 40, 56, 70, 90, 110, 150, 200, 250, 350, 450, 550};
...
const int wait_value[] = {0, 2, 4, 8, 12, 20, 30, 40, 50, 75, 100, 150, 200, 300, 400};
...
const int adc_value[] = {128, 256, 512, 1024};
...
const int cycle_value[] = {1, 2, 4, 8, 16, 32, 64};
