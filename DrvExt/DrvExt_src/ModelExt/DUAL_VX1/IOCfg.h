...
#define LCD_COMM_CTRL          LCD_COMM_BY_GPIO    //    LCD_COMM_DUMMY //@X801
...
#define GPIO_LCD_POWER             P_GPIO_17    
#define GPIO_LCD_RESET              L_GPIO_30     
