...
const PIN_GROUP_CONFIG vTopConfig[] =
{
    ...
    {PIN_FUNC_MIPI_LVDS,        PIN_MIPI_LVDS_CFG_CLK0 | PIN_MIPI_LVDS_CFG_DAT0 |
       ...
       ((_SENSORLIB_ == _SENSORLIB_CMOS_IMX322LQJ_ ) && (_SENSORLIB2_ == _SENSORLIB_CMOS_IMX322LQJVX1_) && (_SENSORLIB3_ == _SENSORLIB3_OFF_) && (_SENSORLIB4_ == _SENSORLIB4_OFF_)))
    {PIN_FUNC_SENSOR,           PIN_SENSOR_CFG_12BITS},
    {PIN_FUNC_SENSOR2,          PIN_SENSOR2_CFG_NONE},
    {PIN_FUNC_SENSOR3,          PIN_SENSOR3_CFG_NONE},
    {PIN_FUNC_SENSOR4,          PIN_SENSOR4_CFG_NONE},
    ...
    {PIN_FUNC_SENSOR4,          PIN_SENSOR4_CFG_NONE},
    {PIN_FUNC_MIPI_LVDS,        PIN_MIPI_LVDS_CFG_CLK0 | PIN_MIPI_LVDS_CFG_DAT0 | PIN_MIPI_LVDS_CFG_DAT1 | PIN_MIPI_LVDS_CFG_DAT2 | PIN_MIPI_LVDS_CFG_DAT3},
#elif ((_SENSORLIB_ == _SENSORLIB_CMOS_IMX322LQJ_THCV236_)  && (_SENSORLIB2_ == _SENSORLIB2_CMOS_IMX322LQJVX1_) && (_SENSORLIB3_ == _SENSORLIB3_OFF_) && (_SENSORLIB4_ == _SENSORLIB4_OFF_))
    {PIN_FUNC_SENSOR,           PIN_SENSOR_CFG_12BITS},
    {PIN_FUNC_SENSOR2,          PIN_SENSOR2_CFG_NONE},
    {PIN_FUNC_SENSOR3,          PIN_SENSOR3_CFG_NONE},
    {PIN_FUNC_SENSOR4,          PIN_SENSOR4_CFG_NONE},
    ...
    */
    {PIN_FUNC_I2C,              PIN_I2C_CFG_NONE |
#if (_SENSORLIB_ == _SENSORLIB_CMOS_IMX322LQJ_THCV236_)
                                PIN_I2C_CFG_CH1 |
#endif
                                ...
                                PIN_I2C_CFG_CH1 |
#endif
#if ((_SENSORLIB_ == _SENSORLIB_CMOS_IMX322LQJ_ || _SENSORLIB_ == _SENSORLIB_CMOS_IMX322LQJVX1_|| _SENSORLIB_ == _SENSORLIB_CMOS_IMX322LQJ_THCV236_) || (_SENSORLIB_ == _SENSORLIB_CMOS_IMX124LQT_) || (_SENSORLIB_ == _SENSORLIB_CMOS_IMX123LQT_))
