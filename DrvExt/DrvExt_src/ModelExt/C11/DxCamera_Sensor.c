...
static SEN_GET_DRV SenDrvTab[SENSOR_ID_MAX_NUM] =
{
    Sensor_GetDrvTab_AR0238CS,   Sensor_GetDrvTab_OV9750VX1,   NULL,   NULL,
};
...
static BOOL SenDetPlugIn2(void)
{
    ...
    if ( vx1_checkSublinkReady() == FALSE )
        return FALSE;
#endif
//#NT#2016/03/09#Bowen Li -begin
//#NT# VX1 check ready flow
    return TRUE;
//#NT#2016/03/09#Bowen Li -end
}
