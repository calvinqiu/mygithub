...
const PIN_GROUP_CONFIG vTopConfig[] =
{
    ...
    {PIN_FUNC_MIPI_LVDS,        PIN_MIPI_LVDS_CFG_CLK0 | PIN_MIPI_LVDS_CFG_DAT0 | PIN_MIPI_LVDS_CFG_DAT1 | PIN_MIPI_LVDS_CFG_DAT2 | PIN_MIPI_LVDS_CFG_DAT3},
       ...
       ((_SENSORLIB_ == _SENSORLIB_CMOS_AR0238CS_)  && (_SENSORLIB2_ == _SENSORLIB2_CMOS_OV9750VX1_) && (_SENSORLIB3_ == _SENSORLIB3_OFF_) && (_SENSORLIB4_ == _SENSORLIB4_OFF_)))
    {PIN_FUNC_SENSOR,           PIN_SENSOR_CFG_MIPI|PIN_SENSOR_CFG_MCLK},
    {PIN_FUNC_SENSOR2,          PIN_SENSOR2_CFG_NONE},
    {PIN_FUNC_SENSOR3,          PIN_SENSOR3_CFG_NONE},
    {PIN_FUNC_SENSOR4,          PIN_SENSOR4_CFG_NONE},
...
#endif
#if ((_SENSORLIB_ == _SENSORLIB_CMOS_OV4689_) || (_SENSORLIB_ == _SENSORLIB_CMOS_AR0330M_) || (_SENSORLIB_ == _SENSORLIB_CMOS_AR0230CS_) || (_SENSORLIB_ == _SENSORLIB_CMOS_AR0238CS_))
                                PIN_I2C_CFG_CH1_2ND_PINMUX |
#endif
...
#endif
                                0},
    {PIN_FUNC_UART,             PIN_UART_CFG_CH1 | PIN_UART_CFG_CH2 | PIN_UART_CFG_CH3 | PIN_UART_CFG_CH2_CTSRTS},
