...
#define VOLDET_BATTERY_420V         651
#define VOLDET_BATTERY_415V         643
#define VOLDET_BATTERY_410V         635
#define VOLDET_BATTERY_405V         628
#define VOLDET_BATTERY_400V         620
#define VOLDET_BATTERY_390V         604
#define VOLDET_BATTERY_380V         589
#define VOLDET_BATTERY_378V
#define VOLDET_BATTERY_377V
#define VOLDET_BATTERY_376V
#define VOLDET_BATTERY_375V         581
#define VOLDET_BATTERY_374V
#define VOLDET_BATTERY_373V
#define VOLDET_BATTERY_372V
#define VOLDET_BATTERY_371V
#define VOLDET_BATTERY_370V         573
#define VOLDET_BATTERY_369V
#define VOLDET_BATTERY_367V
#define VOLDET_BATTERY_366V
#define VOLDET_BATTERY_360V         558// 538
...
static void DrvPower_ChargeBattEn(BOOL bCharge)
{
    ...
    if(bCharge)
    {
        PwrIC_DoCmd(cmd_Charge_en, CHARGE_EN_ON, 0);
    }
    else
    {
        PwrIC_DoCmd(cmd_Charge_en, CHARGE_EN_OFF, 0);
    }
    */
}
...
{
    /*
    if (BATTERY_CHARGE_CURRENT_HIGH == Current)
    {
        PwrIC_DoCmd(cmd_Charge_setCurrent, INPUT_CURRENT_LIMIT_1A, 0);
    }
    else if (BATTERY_CHARGE_CURRENT_MEDIUM == Current)
    {
        PwrIC_DoCmd(cmd_Charge_setCurrent, INPUT_CURRENT_LIMIT_475mA, 0);
    }
    else
    {
        PwrIC_DoCmd(cmd_Charge_setCurrent, INPUT_CURRENT_LIMIT_95mA, 0);
    }
    */
