...
#define GPIO_LCD_SIF_SEN            L_GPIO_28
#define GPIO_LCD_SIF_SCK            L_GPIO_29
#define GPIO_LCD_SIF_SDA            L_GPIO_30
#endif
...
#define GPIO_LCD_BLG_PCTL           P_GPIO_17
#define PAD_LCD_BLG_PCTL            PAD_PIN_PGPIO17
#endif
...
#define TV_DET_CTRL                 TV_DET_DUMMY //EVB
...
// CARD
// card power
#define GPIO_CARD_POWER             P_GPIO_9
#define PAD_CARD_POWER              PAD_PIN_PGPIO9
// SD card detect
...
// audio power
#define GPIO_AUDIO_POWER            P_GPIO_19
...
#endif
// IR CUT
#define GPIO_IRCUT_CTRL1            P_GPIO_25
#define GPIO_IRCUT_CTRL2            P_GPIO_26
//--------------------------------------------------------------------
// Power device
//--------------------------------------------------------------------
//Battery
...
#define GPIO_SENSOR2_PWR            P_GPIO_15
...
// BCM43455
#define GPIO_WIFI_SHDN  P_GPIO_4  //WiFi Shut Down => useless in C11, config it as input pull high
#define PAD_WIFI_SHDN   PAD_PIN_PGPIO4
#define GPIO_WIFI_PWREN P_GPIO_3  //WiFi Power Enable (low enable) => useless in C11
#define GPIO_WIFI_CS    P_GPIO_7  //WiFi CS Enable (High enable)
