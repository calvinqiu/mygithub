...
#endif
     //{  GPIO_WIFI_SHDN,         GPIO_DIR_INPUT,     PAD_PULLUP,             PAD_WIFI_SHDN       }, //WiFi Shut Down => useless in C11, config it as input pull high
     //{  GPIO_WIFI_PWREN,        GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,     PAD_PIN_NOT_EXIST   }, //WiFi Power Enable (low enable) => useless in C11
