...
#elif ((_SENSORLIB_ == _SENSORLIB_CMOS_IMX206CQC_DUAL_) &&      \
       (_SENSORLIB2_ == _SENSORLIB2_CMOS_IMX206CQC_DUAL_) &&            \
       (_SENSORLIB3_ == _SENSORLIB3_OFF_) &&            \
       (_SENSORLIB4_ == _SENSORLIB4_OFF_))
...
static SEN_GET_DRV SenDrvTab[SENSOR_ID_MAX_NUM] =
{
    Sensor_GetDrvTab_IMX206CQC_DUAL,   Sensor_GetDrvTab_IMX206CQC_DUAL,   NULL,   NULL,
};
