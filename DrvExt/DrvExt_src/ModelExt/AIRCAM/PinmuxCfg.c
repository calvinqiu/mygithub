...
const PIN_GROUP_CONFIG vTopConfig[] =
{
    ...
    {PIN_FUNC_MIPI_LVDS,        PIN_MIPI_LVDS_CFG_CLK0 | PIN_MIPI_LVDS_CFG_DAT0 |
                                ...
                                PIN_MIPI_LVDS_CFG_DAT7 | PIN_MIPI_LVDS_CFG_DAT8 |
                                PIN_MIPI_LVDS_CFG_DAT9},
#elif ((_SENSORLIB_ == _SENSORLIB_CMOS_IMX206CQC_DUAL_) && (_SENSORLIB2_ == _SENSORLIB2_CMOS_IMX206CQC_DUAL_) && (_SENSORLIB3_ == _SENSORLIB3_OFF_) && (_SENSORLIB4_ == _SENSORLIB4_OFF_))
    {PIN_FUNC_SENSOR,           PIN_SENSOR_CFG_LVDS|PIN_SENSOR_CFG_MCLK|PIN_SENSOR_CFG_LVDS_VDHD},
    {PIN_FUNC_SENSOR2,          PIN_SENSOR2_CFG_LVDS|PIN_SENSOR2_CFG_MCLK2|PIN_SENSOR2_CFG_LVDS_VDHD},
    {PIN_FUNC_SENSOR3,          PIN_SENSOR3_CFG_NONE},
    {PIN_FUNC_SENSOR4,          PIN_SENSOR4_CFG_NONE},
