...
#define GPIO_SENSOR_RESET_3V        P_GPIO_17
#define GPIO_SENSOR_1V              P_GPIO_18
#define GPIO_SENSOR_18V             P_GPIO_19
#define GPIO_SENSOR_29V             P_GPIO_20
// SENSOR
#define SENSOR_DET_DUMMY            0
#define SENSOR_DET_BY_VIO           1
#define SENSOR_DET_BY_GPIO          2
#define SENSOR_DET_BY_VX1           3
#define SENSOR_DET_CTRL             SENSOR_DET_BY_VIO
...
#define GPIO_ETH_GMAC  P_GPIO_33
