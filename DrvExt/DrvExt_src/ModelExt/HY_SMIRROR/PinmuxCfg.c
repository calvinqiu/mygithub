...
const PIN_GROUP_CONFIG vTopConfig[] =
{
    ...
    {PIN_FUNC_SENSOR4,          PIN_SENSOR4_CFG_NONE},
    {PIN_FUNC_MIPI_LVDS,        PIN_MIPI_LVDS_CFG_NONE},
#elif (((_SENSORLIB_ == _SENSORLIB_OFF_)  && (_SENSORLIB2_ == _SENSORLIB2_CMOS_ISX016VX1_) && (_SENSORLIB3_ == _SENSORLIB3_OFF_) && (_SENSORLIB4_ == _SENSORLIB4_OFF_))|| \
	   ((_SENSORLIB_ == _SENSORLIB_OFF_)  && (_SENSORLIB2_ == _SENSORLIB2_CMOS_ISX016P_) && (_SENSORLIB3_ == _SENSORLIB3_OFF_) && (_SENSORLIB4_ == _SENSORLIB4_OFF_)))
    {PIN_FUNC_SENSOR,           PIN_SENSOR_CFG_NONE},
    {PIN_FUNC_SENSOR2,          PIN_SENSOR2_CFG_CCIR16BITS|PIN_SENSOR2_CFG_MCLK2},
    {PIN_FUNC_SENSOR3,          PIN_SENSOR3_CFG_NONE},
    {PIN_FUNC_SENSOR4,          PIN_SENSOR4_CFG_NONE},
