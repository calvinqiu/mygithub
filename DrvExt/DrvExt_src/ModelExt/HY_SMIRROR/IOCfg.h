...
#define GPIO_LCD_RESET              C_GPIO_10 // for ILI9341 + touch panel TEST!!!
//#endif
#define GPIO_LCD_POWER                       C_GPIO_12
// LCD backlight
#define LCD_BACKLIGHT_DUMMY         0
#define LCD_BACKLIGHT_BY_GPIO       1
#define LCD_BACKLIGHT_BY_PWM        2
#define LCD_BACKLIGHT_BY_PWRIC      3
#define LCD_BACKLIGHT_CTRL          LCD_BACKLIGHT_BY_PWM//LCD_BACKLIGHT_BY_PWM //EVB
#if (LCD_BACKLIGHT_CTRL == LCD_BACKLIGHT_BY_PWM)
#define GPIO_PWM_LCD_BLG_PCTL       0//x
#define PWMID_LCD_BLG_PCTL          PWMID_0//PWMID_x
#define PINMUX_PWM_LCD_BLG_PCTL  PIN_PWM_CFG_PWM0
#elif (LCD_BACKLIGHT_CTRL == LCD_BACKLIGHT_BY_GPIO)
#define GPIO_LCD_BLG_PCTL           x_GPIO_x//P_GPIO_0//x_GPIO_x
#define PAD_LCD_BLG_PCTL            PAD_PIN_xGPIOx//PAD_PIN_PGPIO0//PAD_PIN_xGPIOx
#endif
...
#define GPIO_LCD2_SIF_SDA           P_GPIO_27 //EVB --- NOTE! it will conflict with PIN_SIF_CFG_CH2
#endif
...
#define GPIO_KEY_MENU               C_GPIO_29
#define PAD_KEY_MENU                PAD_PIN_CGPIO29

#define GPIO_KEY_UP              C_GPIO_30
#define PAD_KEY_UP               PAD_PIN_CGPIO30

#define GPIO_KEY_DOWN               C_GPIO_31
#define PAD_KEY_DOWN                PAD_PIN_CGPIO31

#define GPIO_KEY_RIGHT              C_GPIO_32
#define PAD_KEY_RIGHT               PAD_PIN_CGPIO32

#define GPIO_KEY_LEFT              C_GPIO_33
#define PAD_KEY_LEFT               PAD_PIN_CGPIO33
/*
...
#define GPIO_VX1_POWER           P_GPIO_26
...
//--------------------------------------------------------------------
// EMIENT ePL8975 and ePL2219 Gesture Sensor
//--------------------------------------------------------------------
#define GESTURE_KEY DISABLE

#define GESTURE_CHIP_UNKNOWN 0
#define GESTURE_CHIP_EPL2219 1
#define GESTURE_CHIP_EPL8975 2
#define GESTURE_CHIP GESTURE_CHIP_EPL8975

#define GESTURE_MODE_UNKNOWN 0
#define GESTURE_MODE_POLLING 1
#define GESTURE_MODE_INTERRUPT 2 //NOT SUPPORT, or will cause losing event
#define GESTURE_MODE GESTURE_MODE_POLLING
#endif
