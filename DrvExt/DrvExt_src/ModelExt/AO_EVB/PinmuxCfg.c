...
const PIN_GROUP_CONFIG vTopConfig[] =
{
    ...
    {PIN_FUNC_SDIO3,            PIN_SDIO_CFG_NONE},//PIN_SDIO_CFG_4BITS|PIN_SDIO_CFG_1ST_PINMUX}, //it conflict with SPI4_1, UART2_2
    ...
    //
#if ((_SENSORLIB_ == _SENSORLIB_CMOS_IMX206CQC_) && (_SENSORLIB2_ == _SENSORLIB2_OFF_) && (_SENSORLIB3_ == _SENSORLIB3_OFF_) && (_SENSORLIB4_ == _SENSORLIB4_OFF_))
