...
#define GPIO_PWM_LCD_BLG_PCTL       13
#define PWMID_LCD_BLG_PCTL          PWMID_13
//#elif (LCD_BACKLIGHT_CTRL == LCD_BACKLIGHT_BY_GPIO)
#define GPIO_LCD_BLG_PCTL           P_GPIO_13
#define PAD_LCD_BLG_PCTL            PAD_PIN_PGPIO13
//#endif
...
// LCD2 backlight
#define LCD2_BACKLIGHT_CTRL         LCD_BACKLIGHT_BY_PWM //EVB
#if (LCD2_BACKLIGHT_CTRL == LCD_BACKLIGHT_BY_PWM)
#define GPIO_PWM_LCD2_BLG_PCTL      13
#define PWMID_LCD2_BLG_PCTL         PWMID_13
...
#define GPIO_TV_PLUG                P_GPIO_18
#define PAD_TV_PLUG                 PAD_PIN_PGPIO18
#endif
...
//WIFI
#define GPIO_WIFI_CS           		P_GPIO_9
#define PAD_WIFI_CS            		PAD_PIN_PGPIO9

#define GPIO_WIFI_SHND            	C_GPIO_12
#define PAD_WIFI_SHND             	PAD_PIN_CGPIO12

//charge battery
#define GPIO_CHARGE_FULL            P_GPIO_27
#define PAD_CHARGE_FULL             PAD_PIN_PGPIO27

#define GPIO_CHARGE_EN            C_GPIO_28
#define PAD_CHARGE_EN             PAD_PIN_CGPIO28


//dif hardware version
#define GPIO_DET_HW_VER                C_GPIO_13
#define PAD_DET_HW_VER                 PAD_PIN_CGPIO13


#define LCD_BL_CTRL_PWM		3
#define LCD_BL_CTRL_GPIO	4

extern void SetLcdBlCtrlType(unsigned char en) ;
extern unsigned char GetLcdBlCtrlType(void);

extern BOOL IsChargeFull(void);
extern BOOL IsNew_HW_VER(void);

extern void IO_InitPinmuxPWM(void);
...
#define GPIO_RED_LED                C_GPIO_32  
#define PAD_RED_LED                 PAD_PIN_CGPIO32
...
#define GPIO_SENSOR_12EN P_GPIO_40
#define GPIO_SENSOR_18EN P_GPIO_37
#define GPIO_SENSOR_28EN P_GPIO_36
#define GPIO_SENSOR_RESET S_GPIO_7
