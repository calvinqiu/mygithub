...
const PIN_GROUP_CONFIG vTopConfig[] =
{
    ...
    {PIN_FUNC_MIPI_LVDS,        PIN_MIPI_LVDS_CFG_CLK0 | PIN_MIPI_LVDS_CFG_CLK1 | PIN_MIPI_LVDS_CFG_DAT0 |
       ...
       ((_SENSORLIB_ == _SENSORLIB_CMOS_IMX326LQC_) && (_SENSORLIB2_ == _SENSORLIB2_OFF_) && (_SENSORLIB3_ == _SENSORLIB3_OFF_) && (_SENSORLIB4_ == _SENSORLIB4_OFF_)))
    {PIN_FUNC_SENSOR,           PIN_SENSOR_CFG_LVDS|PIN_SENSOR_CFG_MCLK},
    ...
    {PIN_FUNC_MIPI_LVDS,        PIN_MIPI_LVDS_CFG_CLK0 | PIN_MIPI_LVDS_CFG_DAT0 |
                                ...
                                PIN_MIPI_LVDS_CFG_DAT7 | PIN_MIPI_LVDS_CFG_DAT8 |
                                PIN_MIPI_LVDS_CFG_DAT9},
#elif ((_SENSORLIB_ == _SENSORLIB_CMOS_IMX206CQC_) && (_SENSORLIB2_ == _SENSORLIB2_CMOS_IMX206CQC_) && (_SENSORLIB3_ == _SENSORLIB3_OFF_) && (_SENSORLIB4_ == _SENSORLIB4_OFF_))
    {PIN_FUNC_SENSOR,           PIN_SENSOR_CFG_LVDS|PIN_SENSOR_CFG_MCLK|PIN_SENSOR_CFG_LVDS_VDHD},
    {PIN_FUNC_SENSOR2,          PIN_SENSOR2_CFG_LVDS|PIN_SENSOR2_CFG_MCLK2|PIN_SENSOR2_CFG_LVDS_VDHD},
    {PIN_FUNC_SENSOR3,          PIN_SENSOR3_CFG_NONE},
    {PIN_FUNC_SENSOR4,          PIN_SENSOR4_CFG_NONE},
    {PIN_FUNC_MIPI_LVDS,        PIN_MIPI_LVDS_CFG_CLK0 | PIN_MIPI_LVDS_CFG_DAT0 |
                                PIN_MIPI_LVDS_CFG_DAT1 | PIN_MIPI_LVDS_CFG_DAT2 |
    ...
    */
    ...
    {PIN_FUNC_I2C,              PIN_I2C_CFG_NONE |
                                ...
                                PIN_I2C_CFG_CH1 |
#endif
#if ((_SENSORLIB_ == _SENSORLIB_CMOS_IMX322LQJ_) || (_SENSORLIB_ == _SENSORLIB_CMOS_IMX124LQT_) || (_SENSORLIB_ == _SENSORLIB_CMOS_IMX123LQT_) || (_SENSORLIB_ == _SENSORLIB_CMOS_IMX326LQC_))
   ...
   // {PIN_FUNC_UART,             PIN_UART_CFG_CH1 | PIN_UART_CFG_CH2},
    {PIN_FUNC_UART,             PIN_UART_CFG_NONE | PIN_UART_CFG_CH1 | PIN_UART_CFG_CH3},
...
//@liangfu 20161009 delete it.
#if 1

#if (LCD_BACKLIGHT_CTRL == LCD_BACKLIGHT_BY_PWM)

    {PIN_FUNC_PWM,              PIN_PWM_CFG_NONE | PIN_PWM_CFG_PWM13 |
#else
...
#if (_LCDTYPE_ == _LCDTYPE_T15P00_OTA5182A_)
...
#if 0
//@liangfu 20161009  .
const PIN_GROUP_CONFIG vTopPWMConfig[] =
{
    // Module name              pinmux config
...
//@liangfu 20161009
void IO_InitPinmuxPWM(void) {

	//pinmux_init((PIN_GROUP_CONFIG *)vTopPWMConfig);
}
