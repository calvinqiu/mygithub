...
const PIN_GROUP_CONFIG vTopConfig[] =
{
...
#elif ((_SENSORLIB_ == _SENSORLIB_CMOS_IMX225LQR_)  && (_SENSORLIB2_ == _SENSORLIB2_OFF_) && (_SENSORLIB3_ == _SENSORLIB3_OFF_) && (_SENSORLIB4_ == _SENSORLIB4_OFF_))
            {PIN_FUNC_SENSOR,           PIN_SENSOR_CFG_MIPI|PIN_SENSOR_CFG_MCLK},
            {PIN_FUNC_SENSOR2,          PIN_SENSOR2_CFG_NONE},
            {PIN_FUNC_SENSOR3,          PIN_SENSOR3_CFG_NONE},
            {PIN_FUNC_SENSOR4,          PIN_SENSOR4_CFG_NONE},
...
#elif ((_SENSORLIB_ == _SENSORLIB_CMOS_IMX225LQR_)  && (_SENSORLIB2_ == _SENSORLIB_CMOS_IMX225LQRVX1_) && (_SENSORLIB3_ == _SENSORLIB3_OFF_) && (_SENSORLIB4_ == _SENSORLIB4_OFF_))
            {PIN_FUNC_SENSOR,           PIN_SENSOR_CFG_MIPI|PIN_SENSOR_CFG_MCLK},
            {PIN_FUNC_SENSOR2,          PIN_SENSOR2_CFG_NONE},
            {PIN_FUNC_SENSOR3,          PIN_SENSOR3_CFG_NONE},
            {PIN_FUNC_SENSOR4,          PIN_SENSOR4_CFG_NONE},
...
#elif ((_SENSORLIB_ == _SENSORLIB_OFF_)  && (_SENSORLIB2_ == _SENSORLIB_CMOS_IMX225LQRVX1_) && (_SENSORLIB3_ == _SENSORLIB3_OFF_) && (_SENSORLIB4_ == _SENSORLIB4_OFF_))
            {PIN_FUNC_SENSOR,           PIN_SENSOR_CFG_MIPI|PIN_SENSOR_CFG_MCLK},
            {PIN_FUNC_SENSOR2,          PIN_SENSOR2_CFG_NONE},
            {PIN_FUNC_SENSOR3,          PIN_SENSOR3_CFG_NONE},
            {PIN_FUNC_SENSOR4,          PIN_SENSOR4_CFG_NONE},
    ...
    */
    {PIN_FUNC_I2C,              PIN_I2C_CFG_NONE |
     ...
     (_SENSORLIB_ == _SENSORLIB_CMOS_AR0230CS_) || (_SENSORLIB_ == _SENSORLIB_CMOS_IMX179_) || (_SENSORLIB_ == _SENSORLIB_CMOS_IMX225LQR_))
                                PIN_I2C_CFG_CH1_2ND_PINMUX |
#endif

#if((_SENSORLIB2_ == _SENSORLIB2_CMOS_IMX225LQR_))
