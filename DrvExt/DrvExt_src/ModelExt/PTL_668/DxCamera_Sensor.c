...
#elif ((_SENSORLIB_ == _SENSORLIB_CMOS_IMX225LQR_) &&      \
       (_SENSORLIB2_ == _SENSORLIB2_OFF_) &&            \
       (_SENSORLIB3_ == _SENSORLIB3_OFF_) &&            \
       (_SENSORLIB4_ == _SENSORLIB_OFF_))
...
{
    pll_setPLLEn(PLL_ID_5, DISABLE);
    pll_setPLL(PLL_ID_5, 0x63000);//37.125MHz
    pll_setPLLEn(PLL_ID_5, ENABLE);
    ...
    /* This pin is for sensor 2
    gpio_setDir(GPIO_SENSOR_RESET_2, GPIO_DIR_OUTPUT);
    gpio_clearPin(GPIO_SENSOR_RESET_2);
    Delay_DelayMs(20);
    gpio_setPin(GPIO_SENSOR_RESET_2);
    */
...
static SEN_GET_DRV SenDrvTab[SENSOR_ID_MAX_NUM] =
{
    Sensor_GetDrvTab_IMX225LQR,   NULL,   NULL,   NULL,
};
...
#elif ((_SENSORLIB_ == _SENSORLIB_CMOS_IMX225LQR_) &&      \
       (_SENSORLIB2_ == _SENSORLIB_CMOS_IMX225LQRVX1_) &&            \
       (_SENSORLIB3_ == _SENSORLIB3_OFF_) &&            \
       (_SENSORLIB4_ == _SENSORLIB_OFF_))
...
static SEN_GET_DRV SenDrvTab[SENSOR_ID_MAX_NUM] =
{
    Sensor_GetDrvTab_IMX225LQR,   Sensor_GetDrvTab_IMX225LQRVX1,   NULL,   NULL,
};
...
static SEN_GET_DRV SenDrvTab[SENSOR_ID_MAX_NUM] =
{
    NULL,   Sensor_GetDrvTab_IMX225LQRVX1,   NULL,   NULL,
};
