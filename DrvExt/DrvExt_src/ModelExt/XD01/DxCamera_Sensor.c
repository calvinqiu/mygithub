...
static void SenPowerOn(void)
{
    ...
    gpio_setDir(P_GPIO_36, GPIO_DIR_OUTPUT);  //1.2V
    gpio_setDir(P_GPIO_37, GPIO_DIR_OUTPUT);  //1.8V
    gpio_setDir(P_GPIO_40, GPIO_DIR_OUTPUT); //2.7V
...
#elif ((_SENSORLIB_ == _SENSORLIB_CMOS_IMX117_) &&   \
     (_SENSORLIB2_ == _SENSORLIB2_OFF_) &&          \
     (_SENSORLIB3_ == _SENSORLIB3_OFF_) &&          \
     (_SENSORLIB4_ == _SENSORLIB4_OFF_))
static SENSOR_INIT_OBJ Sensor_GetObj(void)
...
static void SenPowerOn(void)
{
    ...
    */
    ...
    gpio_setDir(P_GPIO_36, GPIO_DIR_OUTPUT);  //2.8V
    gpio_setDir(P_GPIO_37, GPIO_DIR_OUTPUT);  //1.8V
    gpio_setDir(P_GPIO_40, GPIO_DIR_OUTPUT); //1.2V
...
static SEN_GET_DRV SenDrvTab[SENSOR_ID_MAX_NUM] =
{
    Sensor_GetDrvTab_IMX117CQT,   NULL,   NULL,   NULL,
};
...
static void SenPowerOn(void)
{
    gpio_setDir(P_GPIO_40, GPIO_DIR_OUTPUT); //2.8v
    gpio_setPin(P_GPIO_40);
    gpio_setDir(P_GPIO_37, GPIO_DIR_OUTPUT); //1.8v
    gpio_setPin(P_GPIO_37);
    Delay_DelayMs(1);
...
static SENSOR_INIT_OBJ Sensor_GetObj(void)
{
    ...
    InitObj.CmdInfo.INFO.I2C.extSlaveAddrEnable = FALSE;
    InitObj.ChgMclkEn = ENABLE;
    InitObj.Option = (SENSOR_OPTION_FLIP | SENSOR_OPTION_MIRROR)  ;// | SENSOR_OPTION_FLIP); //SENSOR_OPTION_FLIP;
