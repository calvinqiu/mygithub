...
#if (ADC_KEY == ENABLE)
#define VOLDET_KEY_ADC_RANGE        (30)
...
#define VOLDET_KEY_ADC_LVL3         (520-VOLDET_KEY_ADC_RANGE)
#define VOLDET_KEY_ADC_LVL4         (648-VOLDET_KEY_ADC_RANGE)
...
static UINT32 VolDet_GetKey1Level(void)
{
    ...
    if (uiKey1ADC < VOLDET_KEY_ADC_TH)
    {
        ...
        else// if (uiKey1ADC >= VOLDET_KEY_ADC_LVL0)   //VOLDET_KEY_ADC_LVL0=0
        {
