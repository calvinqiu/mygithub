...
GPIO_INIT_OBJ uiGPIOMapInitTab[] = {
     ...
     //{  GPIO_SENSOR_PWR0,       GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_LOW,   PAD_PIN_NOT_EXIST      },
     //{  GPIO_SENSOR_PWR1,       GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_LOW,   PAD_PIN_NOT_EXIST      },
     //{  GPIO_SENSOR_PWR2,       GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_LOW,   PAD_PIN_NOT_EXIST      },
     ...
     {  GPIO_LCD_RESET,      GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,  PAD_LCD_BLG_PCTL      },
     {  GPIO_AHD_RESET   ,   GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,   PAD_PIN_NOT_EXIST      },
     {  GPIO_LCD_VG_EN,   	GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,   PAD_PIN_NOT_EXIST      },
     //{  GPIO_AHD_DETECT,      GPIO_DIR_INPUT,     PAD_PULLUP,           PAD_AHD_DETECT       },
     //{  GPIO_AHD_XTALI,      GPIO_DIR_INPUT,     PAD_PULLUP,           PAD_PIN_SGPIO4       },
     {  GPIO_AHD_POWER_ON,   GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,   PAD_PIN_NOT_EXIST      },
     {  GPIO_AHD_30_EN,      GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,   PAD_PIN_NOT_EXIST      },
     {  GPIO_AHD_12_EN,      GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,   PAD_PIN_NOT_EXIST      },
     {  GPIO_LCD_POWER_EN,      GPIO_DIR_OUTPUT,    GPIO_SET_OUTPUT_HI,   GPIO_SET_NONE      },
...
#endif
    {  GPIO_AHD_DETECT,      GPIO_DIR_INPUT,    PAD_PULLDOWN,   PAD_AHD_DETECT      },
};
