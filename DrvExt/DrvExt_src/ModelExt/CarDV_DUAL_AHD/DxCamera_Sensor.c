...
#elif ((_SENSORLIB_ == _SENSORLIB_CMOS_OV2710VX1_) &&      \
...
static SEN_GET_DRV SenDrvTab[SENSOR_ID_MAX_NUM] =
{
    Sensor_GetDrvTab_OV2710VX1,   Sensor_GetDrvTab_TVP5150,   NULL,   NULL,
};
...
#elif ((_SENSORLIB_ == _SENSORLIB_CMOS_OV4689_) &&      \
       (_SENSORLIB2_ == _SENSORLIB2_CMOS_AHD_) &&      \
       (_SENSORLIB3_ == _SENSORLIB3_OFF_) &&               \
       (_SENSORLIB4_ == _SENSORLIB_OFF_))
...
static SENSOR_INIT_OBJ Sensor_GetObj2(void)
{
    ...
    SENSOR_INIT_OBJ InitObj = {0};
    InitObj.CmdInfo.CmdType = SENSOR_CMD_I2C;
    InitObj.CmdInfo.INFO.I2C.I2c = SENSOR_I2C1_1ST;//SENSOR_I2C1_2ND;
    InitObj.CmdInfo.INFO.I2C.extSlaveAddrEnable = FALSE;
    InitObj.CmdInfo.INFO.I2C.extSlaveRAddr = 0x67;
    InitObj.CmdInfo.INFO.I2C.extSlaveWAddr = 0x66;
    InitObj.ChgMclkEn = ENABLE;
    InitObj.Option = SENSOR_OPTION_USER;
    return InitObj;
}

static void SenPowerOn2(void)
{
    gpio_setDir(GPIO_AHD_12_EN, GPIO_DIR_OUTPUT);
    gpio_setPin(GPIO_AHD_12_EN);
    gpio_setDir(GPIO_AHD_30_EN, GPIO_DIR_OUTPUT);
    gpio_setPin(GPIO_AHD_30_EN);

    gpio_setDir(GPIO_AHD_RESET, GPIO_DIR_OUTPUT);
    gpio_clearPin(GPIO_AHD_RESET);
    Delay_DelayMs(20);
    gpio_setPin(GPIO_AHD_RESET);
    Delay_DelayMs(20);
}
...
static SEN_GET_DRV SenDrvTab[SENSOR_ID_MAX_NUM] =
{
    Sensor_GetDrvTab_OV4689,   Sensor_GetDrvTab_AHD,   NULL,   NULL,
};
...
#elif ((_SENSORLIB_ == _SENSORLIB_CMOS_AHD_) &&      \
       (_SENSORLIB2_ == _SENSORLIB2_CMOS_AHD_) &&      \
       (_SENSORLIB3_ == _SENSORLIB3_OFF_) &&               \
       (_SENSORLIB4_ == _SENSORLIB_OFF_))
...
static SENSOR_INIT_OBJ Sensor_GetObj(void)
{
    SENSOR_INIT_OBJ InitObj = {0};
    InitObj.CmdInfo.CmdType = SENSOR_CMD_I2C;
    InitObj.CmdInfo.INFO.I2C.I2c = SENSOR_I2C1_2ND;//SENSOR_I2C1_1ST;//SENSOR_I2C1_2ND;
    InitObj.CmdInfo.INFO.I2C.extSlaveAddrEnable = FALSE;
    InitObj.CmdInfo.INFO.I2C.extSlaveRAddr = 0x67;
    InitObj.CmdInfo.INFO.I2C.extSlaveWAddr = 0x66;
    InitObj.ChgMclkEn = ENABLE;
...
static void SenPowerOn(void)
{
    ...
    //gpio_setDir(GPIO_AHD_30_EN, GPIO_DIR_OUTPUT);
    //gpio_setPin(GPIO_AHD_30_EN);
    gpio_setDir(GPIO_AHD_POWER_ON, GPIO_DIR_OUTPUT);
    gpio_setPin(GPIO_AHD_POWER_ON);
...
static SEN_GET_DRV SenDrvTab[SENSOR_ID_MAX_NUM] =
{
    Sensor_GetDrvTab_AHD,   Sensor_GetDrvTab_AHD,   NULL,   NULL,
};
...
static SEN_GET_DRV SenDrvTab[SENSOR_ID_MAX_NUM] =
{
    Sensor_GetDrvTab_AHD,   NULL,   NULL,   NULL,
};
...
static SENSOR_INIT_OBJ Sensor_GetObj2(void)
{
    SENSOR_INIT_OBJ InitObj = {0};
    InitObj.CmdInfo.CmdType = SENSOR_CMD_I2C;
    InitObj.CmdInfo.INFO.I2C.I2c = SENSOR_I2C1_2ND;//SENSOR_I2C1_2ND;
    InitObj.CmdInfo.INFO.I2C.extSlaveAddrEnable = FALSE;
    InitObj.CmdInfo.INFO.I2C.extSlaveRAddr = 0x67;
    InitObj.CmdInfo.INFO.I2C.extSlaveWAddr = 0x66;
    InitObj.ChgMclkEn = ENABLE;
...
static SEN_GET_DRV SenDrvTab[SENSOR_ID_MAX_NUM] =
{
    NULL,   Sensor_GetDrvTab_AHD,   NULL,   NULL,
};
