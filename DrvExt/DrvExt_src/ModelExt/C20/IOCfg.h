...
// CARD
// card power
#define GPIO_CARD_POWER             P_GPIO_2
#define PAD_CARD_POWER              PAD_PIN_PGPIO2
// SD card detect
...
// RTL 8192/8189
#define GPIO_WIFI_SHDN  P_GPIO_4  //WiFi Shut Down => useless in C10 Lite, config it as input pull high
#define PAD_WIFI_SHDN   PAD_PIN_PGPIO4
#define GPIO_WIFI_PWREN P_GPIO_39 //WiFi Power Enable (low enable)
#define GPIO_WIFI_CS    P_GPIO_3 //WiFi CS Enable (High enable)
