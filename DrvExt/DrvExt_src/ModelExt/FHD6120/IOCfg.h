...
#define GPIO_LCD_BLG_PCTL           P_GPIO_0//P_GPIO_16
#define PAD_LCD_BLG_PCTL            PAD_PIN_PGPIO0//PAD_PIN_PGPIO16
#endif
...
//Watchdog_Timer
#define PWMID_WATCHDOG_PCTL         P_GPIO_15
#define PAD_WATCHDOG_PCTL           PAD_PIN_PGPIO15

#define GPIO_WATCHDOG_EN            P_GPIO_13
#define PAD_GPIO_WATCHDOG_PCTL      PAD_PIN_PGPIO13
...
#define ADC_CH_CARDV_BATTERY       ADC_CHANNEL_3
#define CARDV_BATTERY_ADC_MODE             TRUE
...
#define GPIO_SENSOR_PWREN_1_2V           P_GPIO_8
#define GPIO_SENSOR_PWREN_1_8V           P_GPIO_9
#define GPIO_SENSOR_PWREN_2_8V           P_GPIO_10

#define GPIO_SENSOR2_PWR            P_GPIO_2
...
#define GPIO_WIFI_PWREN     P_GPIO_12 //WiFi Power
...
#define GPIO_WATCH_DOG       P_GPIO_15

#define GPIO_GPS_DET           P_GPIO_14           // Key Shutter2 (ks2)
#define PAD_GPS_DET            PAD_PIN_PGPIO14

extern BOOL  GPIOMap_GPS_Det(void);

#define GPIO_CARD_WP_DET           P_GPIO_3          // Key Shutter2 (ks2)
#define PAD_CARD_WP_DET            PAD_PIN_PGPIO3
extern BOOL  GPIOMap_CardProtect_Det(void);

extern void  GPIOMap_ManualSetTV(BOOL En);
extern BOOL  GPIOMap_GetManualTV(void);
#if 0
...
#define GPIO_WIFI_CLK     C_GPIO_22
#define GPIO_WIFI_DAT     C_GPIO_23
#define GPIO_WIFI_DAT0     C_GPIO_24
#define GPIO_WIFI_DAT1     C_GPIO_25
#define GPIO_WIFI_DAT2     C_GPIO_26
#define GPIO_WIFI_DAT3     C_GPIO_27
