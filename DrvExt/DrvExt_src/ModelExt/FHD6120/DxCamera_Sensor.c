...
static void SenPowerOn(void)
{
    gpio_setDir(GPIO_SENSOR_PWREN_1_2V, GPIO_DIR_OUTPUT);
    gpio_setPin(GPIO_SENSOR_PWREN_1_2V);
    Delay_DelayMs(10);
    gpio_setDir(GPIO_SENSOR_PWREN_1_8V, GPIO_DIR_OUTPUT);
    gpio_setPin(GPIO_SENSOR_PWREN_1_8V);
    Delay_DelayMs(10);
    gpio_setDir(GPIO_SENSOR_PWREN_2_8V, GPIO_DIR_OUTPUT);
    gpio_setPin(GPIO_SENSOR_PWREN_2_8V);
    Delay_DelayMs(20);
    gpio_setDir(GPIO_SENSOR_STANDBY, GPIO_DIR_OUTPUT);
    gpio_setPin(GPIO_SENSOR_STANDBY);
    Delay_DelayMs(20);
