...
#if (_DSP_TYPE_ == _DSP_NONE_)
    [0] = {EMBTYPE_UITRON,  0,  0x00000000, 0x002BC000, 0x00000000},
    [1] = {EMBTYPE_ECOS,    0,  0x002BC000, 0x00121000, 0x00000000},
    [2] = {EMBTYPE_PSTORE,  0,  0x003DD000, 0x00023000, 0x00000000},
#else
    [0] = {EMBTYPE_UITRON,  0,  0x00000000, 0x00900000, 0x00000000},
