...
const PIN_GROUP_CONFIG vTopConfig[] =
{
    ...
    {PIN_FUNC_MIPI_LVDS,        PIN_MIPI_LVDS_CFG_NONE},
       ...
       (_SENSORLIB_ == _SENSORLIB_CMOS_OV4689_) && (_SENSORLIB2_ == _SENSORLIB2_CMOS_IMX322LQJ_ || _SENSORLIB2_ == _SENSORLIB2_CMOS_IMX322LQJVX1_) && (_SENSORLIB3_ == _SENSORLIB3_OFF_) && (_SENSORLIB4_ == _SENSORLIB4_OFF_))
