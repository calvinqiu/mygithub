...
#define PANEL_HEIGHT    800//800//864//848//20171102 qiuhan xiu gai hua mian duan ceng
...
#define DSI_TARGET_CLK            400//480


#if(DSI_PACKET_FORMAT == DSI_FORMAT_RGB888)//66x + 5
#define _IDE_fDCLK      38.33f//50.0f//((((DSI_TARGET_CLK / 8) * 2)/3)+4)//38.33f//
#else
...
*/
	...
	{DSICMD_CMD,0xC1},//C1
	{DSICMD_DATA,0x63},//?y????63,??????62
	{DSICMD_DATA,0x31},
	{DSICMD_DATA,0x00},//?y????00,??????04
	{DSICMD_DATA,0x27},//GSPF
	{DSICMD_DATA,0x27},//GSPS
	{DSICMD_DATA,0x32},
	{DSICMD_DATA,0x12},
	{DSICMD_DATA,0x28},//RTN
	{DSICMD_DATA,0x46},//VBP
	{DSICMD_DATA,0x10},//VFP
	{DSICMD_DATA,0xA5},
	{DSICMD_DATA,0x0F},
	{DSICMD_DATA,0x58},
	{DSICMD_DATA,0x21},
	...
	{DSICMD_CMD,0xC8},//C8
	{DSICMD_DATA,0x02},//255
	{DSICMD_DATA,0x16},//251
	{DSICMD_DATA,0x1F},//247
	{DSICMD_DATA,0x2A},//240
	{DSICMD_DATA,0x39},//224
	{DSICMD_DATA,0x52},//176
	{DSICMD_DATA,0x32},//79
	{DSICMD_DATA,0x1E},//31
	{DSICMD_DATA,0x11},//15
	{DSICMD_DATA,0x09},//8
	...
	{DSICMD_CMD,0xDE},//DE
	{DSICMD_DATA,0x01},
	{DSICMD_DATA,0x5E},//VCOM

	{DSICMD_CMD,0xE6},//E6
	{DSICMD_DATA,0x5E},//VCOM?DEh
	...
	{DSICMD_CMD,0x36},//36
	{DSICMD_DATA,0x00},//??????????????0x08

	{DSICMD_CMD,0x3A},//3
	{DSICMD_DATA,0x77}, 

	{DSICMD_CMD,0x11},//2 ///11
	{CMDDELAY_MS,120},
...
const tLCD_PARAM tModeDSI[] =
{
    /***********       MI Serial Format 1      *************/
    {
        ...
        {
            /* Old prototype */
            PINMUX_DSI_2_LANE_VDO_SYNC_PULSE_RGB888,//PINMUX_DSI_2_LANE_CMD_MODE_RGB888,
            _IDE_fDCLK,                             //!< fDCLK
