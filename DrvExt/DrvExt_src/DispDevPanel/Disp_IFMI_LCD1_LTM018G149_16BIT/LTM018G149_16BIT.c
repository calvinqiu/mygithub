...
*/
//@{
/*Used in MI format-8 RGB565 16bits bus*/
...
{
    mi_setCmd1(WrCMD, (addr&0xffff));
    mi_setCmd2(WrDATA,(value&0xffff));
    mi_setCmdCnt(2);
    mi_waitCmdDone();
}
...
{
    /* Enable AUTO Mode */
    mi_setCmd1(WrCMD, 0x0021);
    mi_setCmd2(WrDATA,0x9F00);
    mi_setCmd3(WrCMD,0x0022);
    mi_setCmdCnt(3);
    mi_waitCmdDone();
}
