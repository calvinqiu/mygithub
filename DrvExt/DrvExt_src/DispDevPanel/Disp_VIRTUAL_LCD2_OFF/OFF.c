...
static ER       dispdev_closeIF8Bits(void) {return E_OK;}
static void     dispdev_writeLcdReg(UINT32 uiAddr, UINT32 uiValue) {}
static UINT32   dispdev_readLcdReg(UINT32 uiAddr) {return 0;}
static void     dispdev_setIF8bitsIOCTRL(FP pIoCtrlFunc);
static ER       dispdev_setDeviceRotate(DISPDEV_LCD_ROTATE Rot) {return E_OK;}
