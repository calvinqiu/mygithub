...
#define __MODULE__          GSensor_ICG20660
...
//
//**********************************************************************************
static UINT32 ICG20660Threshold=0xFF;/*1G= X/16;*/
...
static UINT32 GSensor_GetSensitivityLevel(void)
{
    switch(g_GSensorSensitivity)
    {
        case GSENSOR_SENSITIVITY_OFF:
            ICG20660Threshold =0xFF;
            break;
        case GSENSOR_SENSITIVITY_LOW:
            ICG20660Threshold =0x95;//25
            break;
        case GSENSOR_SENSITIVITY_MED:
            ICG20660Threshold =0x85;//20
            break;
        case GSENSOR_SENSITIVITY_HIGH:
            ICG20660Threshold =0x65;//16
            break;
        default:
            ICG20660Threshold =0xFF;
            break;
    }
    return ICG20660Threshold;
}
...
BOOL GSensor_ParkingMode(void)
{
    ...
    if(G_INT_COUNT>=1)
    {
        DBG_MSG("----------ICG20660 GSensor_ParkingMode----------\n\r");
        return TRUE;
    }
    else
        return FALSE;
