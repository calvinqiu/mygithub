#ifndef _IQS_SETTINGFUNC_IMX123LQT_EVB_FF_C
#define _IQS_SETTINGFUNC_IMX123LQT_EVB_FF_C
...
#if 0
    {
        if     (uiISO1 <= 75)   ui3DNRLevel = H264_3DNR_LV0;
        ...
        else if(uiISO1 <= 2000) ui3DNRLevel = H264_3DNR_LV4;
