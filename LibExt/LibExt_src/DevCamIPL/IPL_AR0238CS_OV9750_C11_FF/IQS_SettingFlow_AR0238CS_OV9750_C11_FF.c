#ifndef _IQS_SETTINGFLOW_AR0238CS_OV9750_C11_FF_C_
#define _IQS_SETTINGFLOW_AR0238CS_OV9750_C11_FF_C_
#include "IPL_AR0238CS_OV9750_C11_FF_Int.h"
...
SR_WDR_CONTRAST_LEVEL IQS_WDR_Contrast[Total_SENIDNum];
...
//                group->ipeUpdate &= ~IPE_RGBGAMMA;
            ...
            if( aLv < 125)
                IQS_WDR_Contrast[SenId_Value] = SR_WDR_CONTRAST_LEVEL03;
            else if( aLv < 140)
                IQS_WDR_Contrast[SenId_Value] = SR_WDR_CONTRAST_LEVEL04;
            else
                IQS_WDR_Contrast[SenId_Value] = SR_WDR_CONTRAST_LEVEL05;
            ExtFunc_SetWDRContrastLevel(SenId_Value, IQS_WDR_Contrast[SenId_Value]);
