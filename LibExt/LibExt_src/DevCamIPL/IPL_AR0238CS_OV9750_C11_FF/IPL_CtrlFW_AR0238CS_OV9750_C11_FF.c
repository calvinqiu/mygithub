...
IPH_CLK IPL_SIEClkCBFlowC(UINT32 Id)
{
    ...
    switch (SenInfo.DataType)
    {
        ...
        case SENSOR_DATA_PARALLEL:
            sieclk = 240000000;//SenInfo.Mode->Pclk * 2;
        break;
...
//#NT#2016/04/06#Bowen Li -begin
//#NT# enable mux flow
//#NT#2016/03/17#Bowen Li -begin
//#NT# disble mux flow
    if (SenInfo.CmdType == SENSOR_CMD_Vx1)
        return IPH_SIEPXCLK_VX1_2X;
//#NT#2016/03/17#Bowen Li -end
//#NT#2016/04/06#Bowen Li -end
    else
