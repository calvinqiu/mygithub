...
//#NT#2017/01/25#Silvia Wu -begin
//#NT# modify sensor mode select
                ...
                case SEL_VIDEOSIZE_1280x720:
					...
					else if ((Video_FPS == SEL_VIDEOFPS_120)||(Video_FPS == SEL_VIDEOFPS_240))
						SenMode = SENSOR_MODE_4;
                    else
                        SenMode = SENSOR_MODE_1;
                    break;
//#NT#2017/01/25#Silvia Wu -end

    //#NT#2016/04/11#Harry Tsai -begin
    //#NT# Modify default sensor mode to mode 1
                default:
                    SenMode = SENSOR_MODE_1;
                    break;
