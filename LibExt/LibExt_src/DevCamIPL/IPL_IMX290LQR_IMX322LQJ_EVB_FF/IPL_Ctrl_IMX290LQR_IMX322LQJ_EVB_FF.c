...
#include "ipl_cal_datapassing_IMX290LQR_IMX322LQJ_EVB_FF_int.h"
#endif
...
void IPL_CtrlInitIpc_IMEPxOutPPB_Stitch(UINT32 Id, UINT32 PathEnIdx, IPL_YCC_IMG_INFO *Px_PPB0, STITCH_IMG *StitchImg)
{
    ...
    UINT32 PxIdx[3][8] =
    {
        {IPLCTRL_IME_P1_FMT, IPLCTRL_IME_P1_OUT_SIZE_H, IPLCTRL_IME_P1_OUT_SIZE_V, IPLCTRL_IME_P1_OUT_SIZE_HLOS, IPLBUF_IMEP1_1, IPLCTRL_IME_P1_SPRT_YBUFOFS, IPLCTRL_IME_P1_SPRT_CBUFOFS, IPLBUF_IMEP1_SPRT},
        {IPLCTRL_IME_P2_FMT, IPLCTRL_IME_P2_OUT_SIZE_H, IPLCTRL_IME_P2_OUT_SIZE_V, IPLCTRL_IME_P2_OUT_SIZE_HLOS, IPLBUF_IMEP2_1, IPLCTRL_IME_P2_SPRT_YBUFOFS, IPLCTRL_IME_P2_SPRT_CBUFOFS, IPLBUF_IMEP2_SPRT},
        {IPLCTRL_IME_P3_FMT, IPLCTRL_IME_P3_OUT_SIZE_H, IPLCTRL_IME_P3_OUT_SIZE_V, IPLCTRL_IME_P3_OUT_SIZE_HLOS, IPLBUF_IMEP3_1, IPLCTRL_IME_P3_SPRT_YBUFOFS, IPLCTRL_IME_P3_SPRT_CBUFOFS, IPLBUF_IMEP3_SPRT},
    };
...
void IPL_CtrlInitIpc_DispPxPPB_Stitch(UINT32 Id, UINT32 PathEnIdx)
{
    ...
    UINT32 PxIdx[3][7] =
    {
        {IPLCTRL_IME_P1_BUFNUM, IPLCTRL_IME_P1_FMT, IPLBUF_IMEP1_1, IPLCTRL_IME_P1_OUT_SIZE_H, IPLCTRL_IME_P1_OUT_SIZE_V, IPLCTRL_IME_P1_SPRT_YBUFOFS, IPLCTRL_IME_P1_SPRT_CBUFOFS},
        {IPLCTRL_IME_P2_BUFNUM, IPLCTRL_IME_P2_FMT, IPLBUF_IMEP2_1, IPLCTRL_IME_P2_OUT_SIZE_H, IPLCTRL_IME_P2_OUT_SIZE_V, IPLCTRL_IME_P2_SPRT_YBUFOFS, IPLCTRL_IME_P2_SPRT_CBUFOFS},
        {IPLCTRL_IME_P3_BUFNUM, IPLCTRL_IME_P3_FMT, IPLBUF_IMEP3_1, IPLCTRL_IME_P3_OUT_SIZE_H, IPLCTRL_IME_P3_OUT_SIZE_V, IPLCTRL_IME_P3_SPRT_YBUFOFS, IPLCTRL_IME_P3_SPRT_CBUFOFS},
    };
...
void IPL_CtrlInitCapIpcInfo(IPL_GET_CAP_RAW_DATA *CapInfo, IPC_SIE_Info *Info, IPLCTRL_CAP_EXT_INFO *ExtInfo)
{
    ...
    else
    {
        ...
        {
            UINT32 Ch1HSize, Ch1VSize,Ch2HSize, Ch2VSize;
            ...
            if ((Info->psie->IMG_Window.Crop.SizeH != (Ch1HSize*2)) || (Info->psie->IMG_Window.Crop.SizeV != Ch1VSize))
            {
        ...
        else // capture raw image
        {
            ...
            //DBG_ERR("ID=%d type=%d\r\n",CapInfo->Id, SenObj.CmdInfo.CmdType);
            IPL_CtrlInitIpc_SIEAct_Cap(CapInfo->Id, &Info->sieUpdate, &Info->psie->ActMode);
...
//#NT#2016/03/30#Harry Tsai -end
    ...
    if (IPL_CtrlGetInfor(Id, IPLCTRL_CFMODE) == IPL_CF_CCIR)
    {
	    IPL_CtrlSetInfor(Id, IPLCTRL_SIE_CH0_CAP_RAW_SIZE_H, Width/2);
	    IPL_CtrlSetInfor(Id, IPLCTRL_SIE_CH0_CAP_RAW_SIZE_HLOS, Width/2);
    }
	else
	{
	    IPL_CtrlSetInfor(Id, IPLCTRL_SIE_CH0_CAP_RAW_SIZE_H, Width);
