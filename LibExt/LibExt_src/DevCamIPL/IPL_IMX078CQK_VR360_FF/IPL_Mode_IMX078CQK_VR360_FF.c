...
UINT32 IPL_SetSensorMode(IPL_PROC_ID Id, IPL_MODE Mode, BOOL SetFlg)
{
    ...
    {
        case IPL_MODE_INIT:
            // Set sensor mode 10 in VR360 case
            SenMode = SENSOR_MODE_10;
            break;

        case IPL_MODE_VIDEO:
            /*switch(Video_SIZE)
            {
                case SEL_VIDEOSIZE_2880x2160:   // 2880x2160P24
                case SEL_VIDEOSIZE_2560x1440:   // 2560x1440P30
                    SenMode = SENSOR_MODE_10;
                    break;

                case SEL_VIDEOSIZE_1280x720:
                    if (Video_FPS == SEL_VIDEOFPS_120)      // 1280x720P120
                        SenMode = SENSOR_MODE_3;
                    else                                    // 1280x720P60 & P30
                        SenMode = SENSOR_MODE_9;
                    break;

                case SEL_VIDEOSIZE_1920x1080:   // 1920x1080P60 & P30
                case SEL_VIDEOSIZE_848x480:     // 848x480P30
                case SEL_VIDEOSIZE_640x480:     // 640x480P240 & P30
                default:
                    SenMode = SENSOR_MODE_9;
                    break;
            }*/
        ...
        case IPL_MODE_VIDEOREC:
            ...
            switch(Video_SIZE)
            {
                ...
                case SEL_VIDEOSIZE_1920x1080:
                    if (Video_FPS == SEL_VIDEOFPS_60)   // 1920x1080P60
                ...
                case SEL_VIDEOSIZE_1280x720:
                    if (Video_FPS == SEL_VIDEOFPS_120)      // 1280x720P120
                        SenMode = SENSOR_MODE_3;
                    else if (Video_FPS == SEL_VIDEOFPS_60)  // 1280x720P60
                        SenMode = SENSOR_MODE_8;
                    else                                    // 1280x720P30
                        SenMode = SENSOR_MODE_9;
                    break;
...
static ER IPL_Init(IPL_CHGMODE_DATA *ChgMode, IPL_CHGMODE_DATA *PrvMode)
{
    ...
    IPL_CtrlSetInfor(ChgMode->ProcSenId, IPLCTRL_PRVFLOW, ICF_FLOW_DEWARP); // Dewarp flow
    //decide sensor mode
