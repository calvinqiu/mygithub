...
#include "IPL_OV4689_730P_FF_Int.h"
...
UINT32 IPL_SetSensorMode(IPL_PROC_ID Id, IPL_MODE Mode, BOOL SetFlg)
{
    ...
    if (Id == IPL_ID_1 || (Id == IPL_ID_2 && IPL_CtrlGetInfor(IPL_ID_1, IPLCTRL_EXT_FUNC_EN) == ICF_FUNC_SHDR) )    //OV4689 Sensor Mode
    {
        ...
        switch(Mode)
        {
            ...
            case IPL_MODE_VIDEO:
                ...
                {
                    //#NT#2016/05/24#Jarkko Chang#[0060868] -begin
                    //#NT# fixed warning for remove unused code
                    /*
                    ...
                    */
                    //#NT#2016/05/24#Jarkko Chang[0060868] -end
    ...
    else if (Id == IPL_ID_2) //OV9712 Sensor Mode
    {
        //#NT#2016/05/24#Jarkko Chang#[0060866] -begin
        //#NT# fixed warning for remove unused code
        //Video_FPS = IPL_AlgGetUIInfo(Id, IPL_SEL_VIDEO_FPS);
        //#NT#2016/05/24#Jarkko Chang#[60866] -end
