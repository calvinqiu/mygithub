...
void IPL_CtrlPrvInitFlowC(UINT32 Id, IPLCTRL_INFO *CtrlInfo)
{
    ...
    //#NT#2016/06/22#Jarkko Chang -begin
    //#NT# update for frame sync flow
    IPL_CtrlSetInfor(Id, IPLCTRL_CFMODEEXT, IPL_CFEXT_SYNCTRIG);
    //#NT#2016/06/22#Jarkko Chang -end
    //#NT#2016/02/18#Jarkko Chang -begin
    //#NT# add support dsp flip
	...
	//#NT#2017/02/23#Jarkko Chang -begin
	//#NT# add for backward compensation
	IPL_AlgSetUIInfo(Id, IPL_SEL_SBS, SEL_SBS_LR);
	//#NT#2017/02/23#Jarkko Chang -end
