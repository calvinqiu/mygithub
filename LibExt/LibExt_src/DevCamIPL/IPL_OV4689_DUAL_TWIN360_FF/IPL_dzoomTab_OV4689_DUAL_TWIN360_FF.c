...
//#NT# fixed side-by-side crop ratio isuue
const UINT32 VDOZOOM_INFOR_MODE_3SSTRP_HALF_TABLE[1][DZOOM_ITEM_MAX] =
{
    {2688, 1508, 1920, 1080, 1920, 1080, 2688, 1508}, //1
};
...
//#NT# fixed side-by-side crop ratio isuue
        case SENSOR_MODE_3:
                Ptr = (UINT32*)&VDOZOOM_INFOR_MODE_3SSTRP_HALF_TABLE[0][0];
                *DzMaxidx = (sizeof(VDOZOOM_INFOR_MODE_3SSTRP_HALF_TABLE) / 4 / DZOOM_ITEM_MAX) - 1;
            break;
//#NT#2016/09/20#Silvia Wu -end
        case SENSOR_MODE_4:
