...
//#NT#2016/12/23#Bowen Li -begin
//#NT# clear coverity warnning message
/*
...
//#NT# add suppor vr360 flow
    //decide preview flow
	if ((ChgMode->FuncEn & IPL_FUNC_VR360) == IPL_FUNC_VR360)
	{
		IPL_AlgSetUIInfo(ChgMode->ProcSenId, IPL_SEL_CTRLFLOW, SEL_CTRLFLOW_DEWARP);
	}
	else
	{
		IPL_AlgSetUIInfo(ChgMode->ProcSenId, IPL_SEL_CTRLFLOW, SEL_CTRLFLOW_COMMON);
	}
//#NT#2016/12/23#Bowen Li -end
