/**
    ...
    @file       IPL_Ctrl_CCIR601A_EVB_FF.c
    @ingroup    mISYSAlg
...
#include "ipl_cal_datapassing_CCIR601A_EVB_FF_int.h"
#endif
...
SIE_DVI DVI_Cap = {SIE_CCIR601,SIE_SDMode,DVIOUT_SWAPVYUY,FALSE,FALSE,TRUE};
