/*
    ...
    @file       IPL_D2DCB_AR0330M_NT99141_EVB_FF.c
    @ingroup    mISYSAlg
    @note       Nothing.
...
static UINT32 IFEIME_CAP_D2D_DCECB(IPL_PROC_ID id, USIZE *pRef_1x,Coordinate *pRef_1xCen,DCE_SUBFUNC* subF, DCE_UPDATE *Update, UINT32 eventID,fpRegDump *fpRegD)
{
    ...
    if(RSC_GetStatus(id) == SEL_RSC_ON)
    {
        ...
        Info.pDce_sub->_2DLutParam = (_2DLUT_PARAM *)(void *)&GET_Dce2DLut;
        Info.pDce_sub->dceFuncEn |= FUNC_DC;
        group.dceUpdate |= (DCE_2DLUT|DCE_SUBFEN);
    }
