#ifndef _IQS_SETTINGFUNC_IMX258_OV7251_EVB_FF_C
#define _IQS_SETTINGFUNC_IMX258_OV7251_EVB_FF_C
...
UINT32 IQS_GetGammaValue(UINT32 Id, UINT32 Data12Bit)
{
    ...
    {
        GammaLUT_128Tab =  IQS_GammaLut_Day[SenId_Value];
...
UINT32 IQS_GetMCTFLevel(UINT32 Id)
{
    ...
    if(Id == 0)
    {
        if     (uiISO1 <= 110)  ui3DNRLevel = H264_3DNR_LV2;
        else if(uiISO1 <= 150)  ui3DNRLevel = H264_3DNR_LV2;
    ...
    {
        if     (uiISO1 <= 110)  ui3DNRLevel = H264_3DNR_LV0;
        else if(uiISO1 <= 301)  ui3DNRLevel = H264_3DNR_LV1;
        else if(uiISO1 <= 600)  ui3DNRLevel = H264_3DNR_LV2;
        else if(uiISO1 <= 1200) ui3DNRLevel = H264_3DNR_LV3;
        else if(uiISO1 <= 3200) ui3DNRLevel = H264_3DNR_LV4;
        else                    ui3DNRLevel = H264_3DNR_LV5;
    }
#else
