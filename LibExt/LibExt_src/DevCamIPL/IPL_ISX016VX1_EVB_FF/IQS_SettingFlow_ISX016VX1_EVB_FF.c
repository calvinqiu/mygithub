#ifndef _IQS_SETTINGFLOW_ISX016VX1_EVB_FF_C
#define _IQS_SETTINGFLOW_ISX016VX1_EVB_FF_C
#include "IPL_ISX016VX1_EVB_FF_Int.h"

#if CAL_ECS
#include "IPL_Cal_DataPassing_ISX016VX1_EVB_FF_Int.h"
#endif
...
static ER IFE_IQparam(UINT32 Id, IQS_FLOW_MSG MsgID, IFE_SUBFUNC *subf,IPL_HAL_GROUP* group)
{
    ...
    switch((UINT32)MsgID)
    {
        ...
        case IQCB_PREIME_D2D_IFE_SUB:
            ...
            // IFE-Gbalance
            //////////////////
            IQS_Gbal_Buf[SenId_Value].pGbalStab = IQS_Gbal_Stab[SenId_Value];
