/**
    ...
    @file       IPL_CtrlFW_ISX016VX1_EVB_FF.c
    @ingroup    mISYSAlg
...
void IPL_CtrlPrvInitFlowC(UINT32 Id, IPLCTRL_INFO *CtrlInfo)
{
    ...
    if (CtrlInfo->Info->Mode->ModeType == SENSOR_MODE_CCIR || CtrlInfo->Info->Mode->ModeType == SENSOR_MODE_CCIR_INTERLACE)
    {
        ...
        else//if (CtrlInfo->Info->Mode->ModeType == SENSOR_MODE_CCIR)
        {
			...
			//#NT#2016/09/20#Bowen Li -begin
			//#NT# set modeext value to IPL_CFEXT_SMART_MIRROR
			IPL_CtrlSetInfor(Id, IPLCTRL_CFMODEEXT, IPL_CFEXT_SMART_MIRROR);
			//#NT#2016/09/20#Bowen Li -end
    ...
    else
    {
	    ...
	    //#NT#2016/12/01#Jarkko Chang -end
//#NT#2015/02/09#Spark Chou -begin
//#NT# rewenc
//#NT#2015/02/09#Spark Chou -end
