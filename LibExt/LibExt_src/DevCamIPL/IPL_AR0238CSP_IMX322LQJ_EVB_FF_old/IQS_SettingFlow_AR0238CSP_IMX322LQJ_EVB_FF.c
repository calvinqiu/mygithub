#ifndef _IQS_SETTINGFLOW_AR0238CSP_IMX322LQJ_EVB_FF_C
#define _IQS_SETTINGFLOW_AR0238CSP_IMX322LQJ_EVB_FF_C
#include "IPL_AR0238CSP_IMX322LQJ_EVB_FF_Int.h"

#if CAL_ECS
#include "IPL_Cal_DataPassing_AR0238_EVB_FF_Int.h"
#endif
