#ifndef _IQS_SETTINGFLOW_IMX317CQC_EVB_FF_C
#define _IQS_SETTINGFLOW_IMX317CQC_EVB_FF_C
#include "IPL_IMX317CQC_EVB_FF_Int.h"

#if CAL_ECS
#include "IPL_Cal_DataPassing_IMX317CQC_EVB_FF_Int.h"
#endif
#include "NOTE.h"
