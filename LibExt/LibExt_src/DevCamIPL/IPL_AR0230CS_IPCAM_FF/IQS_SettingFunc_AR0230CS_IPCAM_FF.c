#ifndef _IQS_SETTINGFUNC_AR0230CS_IPCAM_FF_C
#define _IQS_SETTINGFUNC_AR0230CS_IPCAM_FF_C
...
#if 0
    if     (uiISO1 <= 100)   ui3DNRLevel = H264_3DNR_IPCAM_LV1;
    else if(uiISO1 <= 200)   ui3DNRLevel = H264_3DNR_IPCAM_LV2;
    else if(uiISO1 <= 600)   ui3DNRLevel = H264_3DNR_IPCAM_LV3;
    else if(uiISO1 <= 1200)  ui3DNRLevel = H264_3DNR_IPCAM_LV4;
    else if(uiISO1 <= 3300)  ui3DNRLevel = H264_3DNR_IPCAM_LV5;
    else if(uiISO1 <= 6500)  ui3DNRLevel = H264_3DNR_IPCAM_LV6;
    else if(uiISO1 <= 12900) ui3DNRLevel = H264_3DNR_IPCAM_LV7;
    else if(uiISO1 <= 18000) ui3DNRLevel = H264_3DNR_IPCAM_LV8;
    else if(uiISO1 <= 30000) ui3DNRLevel = H264_3DNR_IPCAM_LV9;
    else                     ui3DNRLevel = H264_3DNR_IPCAM_LV10;
