#ifndef _IQS_SETTINGFUNC_IMX291M_SPx_FF_C
#define _IQS_SETTINGFUNC_IMX291M_SPx_FF_C
#include "IPL_IMX291M_SPx_FF_Int.h"
#include "HwMem.h"
...
/*
    ...
    if (SenInfo.Mode->ModeType == SENSOR_MODE_STAGGER_HDR)
        return IQS_SIE_OBSUB;
    else if((IPL_AlgGetUIInfo(Id, IPL_SEL_WDR) != SEL_WDR_OFF) &&
                (IPL_CtrlGetInfor(Id, IPLCTRL_WDR_VER) == WDR_VERSION_2_5))
        return IQS_SIE_OBSUB;
    else
