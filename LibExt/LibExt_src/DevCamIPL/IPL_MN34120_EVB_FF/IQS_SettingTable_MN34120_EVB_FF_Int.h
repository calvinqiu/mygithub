#ifndef IQS_SETTINGTABLE_MN34120_H
#define IQS_SETTINGTABLE_MN34120_H

    // For Vave 1x: QHDp30, UHDp24
    // For Vave 2x: FHDp60
    // For Vave 4x: HDp120
    // For Vave 8x: VGAp240
typedef enum
...
#define IQS_PRV1B2_ISOSTART PRV1B2ISO0050
#define IQS_PRV1B2_ISOEND   PRV1B2ISO6400
#define IQS_PRV1B2_ISOEND_VALUE 6400

#define IQS_PRV1B4_ISOSTART PRV1B4ISO0050
#define IQS_PRV1B4_ISOEND   PRV1B4ISO6400
#define IQS_PRV1B4_ISOEND_VALUE 6400

#define IQS_PRV1B8_ISOSTART PRV1B8ISO0050
#define IQS_PRV1B8_ISOEND   PRV1B8ISO6400
#define IQS_PRV1B8_ISOEND_VALUE 6400
...
extern ISOMAP IQS1B2_ISOMapTab[2][IQS_ISOMAPTAB_NUM];
extern ISOMAP IQS1B4_ISOMapTab[2][IQS_ISOMAPTAB_NUM];
extern ISOMAP IQS1B8_ISOMapTab[2][IQS_ISOMAPTAB_NUM];
