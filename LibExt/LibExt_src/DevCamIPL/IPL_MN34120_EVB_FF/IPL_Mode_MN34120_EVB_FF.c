...
UINT32 IPL_SetSensorMode(IPL_PROC_ID Id, IPL_MODE Mode, BOOL SetFlg)
{
    ...
    switch(Mode)
    {
        case IPL_MODE_INIT: //use largest streaming sensor mode for buffer assign
            SenMode = SENSOR_MODE_8;
            break;
        case IPL_MODE_PREVIEW:
            SenMode = SENSOR_MODE_9;
            break;
        case IPL_MODE_VIDEO:
        case IPL_MODE_VIDEOREC:
            switch(Video_SIZE)
            {
            case SEL_VIDEOSIZE_2880x2160:
                SenMode = SENSOR_MODE_8;
                break;
            case SEL_VIDEOSIZE_2560x1440:
                SenMode = SENSOR_MODE_7;
                break;
            case SEL_VIDEOSIZE_1920x1080:
                if(Video_FPS==SEL_VIDEOFPS_60)
                    SenMode = SENSOR_MODE_3;
                else
                    SenMode = SENSOR_MODE_4;
                break;
            case SEL_VIDEOSIZE_1280x720:
                if(Video_FPS==SEL_VIDEOFPS_120)
                    SenMode = SENSOR_MODE_5;
                else if(Video_FPS==SEL_VIDEOFPS_60)
                    SenMode = SENSOR_MODE_3;
                else // SEL_VIDEOFPS_30
                    SenMode = SENSOR_MODE_4;
                break;
            case SEL_VIDEOSIZE_848x480:
                SenMode = SENSOR_MODE_4;
                break;
            case SEL_VIDEOSIZE_640x480:
                if(Video_FPS==SEL_VIDEOFPS_240)
                    SenMode = SENSOR_MODE_6;
                else // SEL_VIDEOFPS_30
                    SenMode = SENSOR_MODE_9;
                break;
            case SEL_VIDEOSIZE_FULLRES:
                SenMode = SENSOR_MODE_2;
                break;
            }
        ...
        case IPL_MODE_CAP:
            ...
            IPL_AlgSetUIInfo(Id, IPL_SEL_CAPSENMODE, SenMode);
            IPL_AlgSetUIInfo(Id, IPL_SEL_RAW_BITDEPTH_CAP, SEL_RAW_BITDEPTH_12);
            break;
        default:
    ...
    {
    case IPL_MODE_OFF:
        DBG_ERR("IPL_MODE_OFF\r\n");
        break;
    case IPL_MODE_INIT:
        DBG_ERR("IPL_MODE_INIT\r\n");
        break;
    case IPL_MODE_PREVIEW:
        DBG_ERR("IPL_MODE_PREVIEW\r\n");
        break;
    case IPL_MODE_VIDEO:
        DBG_ERR("IPL_MODE_VIDEO\r\n");
        break;
    case IPL_MODE_VIDEOREC:
        DBG_ERR("IPL_MODE_VIDEOREC\r\n");
        break;
    case IPL_MODE_CAP:
        DBG_ERR("IPL_MODE_CAP\r\n");
        break;
    default:
        DBG_ERR("IPL_NONE\r\n");
        break;
    ...
    {
    case SEL_VIDEOSIZE_2880x2160:
        DBG_ERR("SEL_VIDEOSIZE_2880x2160\r\n");
        break;
    case SEL_VIDEOSIZE_2560x1440:
        DBG_ERR("SEL_VIDEOSIZE_2560x1440\r\n");
        break;
    case SEL_VIDEOSIZE_1920x1080:
        DBG_ERR("SEL_VIDEOSIZE_1920x1080\r\n");
        break;
    case SEL_VIDEOSIZE_1280x960:
        DBG_ERR("SEL_VIDEOSIZE_1280x960\r\n");
        break;
    case SEL_VIDEOSIZE_1280x720:
        DBG_ERR("SEL_VIDEOSIZE_1280x720\r\n");
        break;
    case SEL_VIDEOSIZE_848x480:
        DBG_ERR("SEL_VIDEOSIZE_848x480\r\n");
        break;
    case SEL_VIDEOSIZE_640x480:
        DBG_ERR("SEL_VIDEOSIZE_640x480\r\n");
        break;
    case SEL_VIDEOSIZE_FULLRES:
        DBG_ERR("SEL_VIDEOSIZE_FULLRES\r\n");
        break;
    }

    switch(Video_FPS)
    {
    case SEL_VIDEOFPS_10:
        DBG_ERR("SEL_VIDEOFPS_10\r\n");
        break;
    case SEL_VIDEOFPS_15:
        DBG_ERR("SEL_VIDEOFPS_15\r\n");
        break;
    case SEL_VIDEOFPS_20:
        DBG_ERR("SEL_VIDEOFPS_20\r\n");
        break;
    case SEL_VIDEOFPS_24:
        DBG_ERR("SEL_VIDEOFPS_24\r\n");
        break;
    case SEL_VIDEOFPS_25:
        DBG_ERR("SEL_VIDEOFPS_25\r\n");
        break;
    case SEL_VIDEOFPS_30:
        DBG_ERR("SEL_VIDEOFPS_30\r\n");
        break;
    case SEL_VIDEOFPS_45:
        DBG_ERR("SEL_VIDEOFPS_45\r\n");
        break;
    case SEL_VIDEOFPS_50:
        DBG_ERR("SEL_VIDEOFPS_50\r\n");
        break;
    case SEL_VIDEOFPS_60:
        DBG_ERR("SEL_VIDEOFPS_60\r\n");
        break;
    case SEL_VIDEOFPS_100:
        DBG_ERR("SEL_VIDEOFPS_100\r\n");
        break;
    case SEL_VIDEOFPS_120:
        DBG_ERR("SEL_VIDEOFPS_120\r\n");
        break;
    case SEL_VIDEOFPS_150:
        DBG_ERR("SEL_VIDEOFPS_150\r\n");
        break;
    case SEL_VIDEOFPS_200:
        DBG_ERR("SEL_VIDEOFPS_200\r\n");
        break;
    case SEL_VIDEOFPS_240:
        DBG_ERR("SEL_VIDEOFPS_240\r\n");
        break;
    case SEL_VIDEOFPS_FULLRES:
        DBG_ERR("SEL_VIDEOFPS_FULLRES\r\n");
        break;
    }
    ...
    if (SetFlg == TRUE && Mode != IPL_MODE_CAP)
    {
        ...
        IPL_AlgSetUIInfo(Id, IPL_SEL_RAW_BITDEPTH_PRV, SEL_RAW_BITDEPTH_12);
    }
    return SenMode;
}
