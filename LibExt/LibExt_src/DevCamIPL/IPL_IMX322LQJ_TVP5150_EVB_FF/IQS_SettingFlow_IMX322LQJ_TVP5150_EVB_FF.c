#ifndef _IQS_SETTINGFLOW_IMX322LQJ_TVP5150_EVB_FF_C
#define _IQS_SETTINGFLOW_IMX322LQJ_TVP5150_EVB_FF_C
#include "IPL_IMX322LQJ_TVP5150_EVB_FF_Int.h"

#if CAL_ECS
#include "IPL_Cal_DataPassing_IMX322LQJ_TVP5150_EVB_FF_Int.h"
#endif
#include "NOTE.h"
...
static ER RHE_IQparam(UINT32 Id, IQS_FLOW_MSG MsgID, RHE_SUBFUNC *subf,IPL_HAL_GROUP* group)
{
    ...
    static UINT16 uiPointY[4] = {0x0, 0xFFF, 0xFFF, 0xFFF};//
