#ifndef _IQS_SETTINGFUNC_IMX123LQT_IPCAM_FF_C
#define _IQS_SETTINGFUNC_IMX123LQT_IPCAM_FF_C
#include "IPL_IMX123LQT_IPCAM_FF_Int.h"
#include "HwMem.h"
...
UINT32 IQS_GetMCTFLevel(UINT32 Id)
{
    ...
    if     (uiISO1 <= 150)   ui3DNRLevel = H264_3DNR_IPCAM_LV2;
    else if(uiISO1 <= 350)   ui3DNRLevel = H264_3DNR_IPCAM_LV3;
    else if(uiISO1 <= 900)   ui3DNRLevel = H264_3DNR_IPCAM_LV4;
    else if(uiISO1 <= 2500)  ui3DNRLevel = H264_3DNR_IPCAM_LV5;
    else if(uiISO1 <= 5000)  ui3DNRLevel = H264_3DNR_IPCAM_LV5;
    else if(uiISO1 <= 8000)  ui3DNRLevel = H264_3DNR_IPCAM_LV5;
    else if(uiISO1 <= 12000) ui3DNRLevel = H264_3DNR_IPCAM_LV6;
    else if(uiISO1 <= 18000) ui3DNRLevel = H264_3DNR_IPCAM_LV7;
    else                     ui3DNRLevel = H264_3DNR_IPCAM_LV8;
