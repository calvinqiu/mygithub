#ifndef _IQS_SETTINGFUNC_IMX290LQR_EVB_FF_C
#define _IQS_SETTINGFUNC_IMX290LQR_EVB_FF_C
...
UINT32 IQS_GetMCTFLevel(UINT32 Id)
{
...
#if 0
    {
        ...
        else if(uiISO1 <= 1200) ui3DNRLevel = H264_3DNR_LV2;
        else if(uiISO1 <= 3200) ui3DNRLevel = H264_3DNR_LV3;
        else                    ui3DNRLevel = H264_3DNR_LV4;
    }
#else
