#ifndef _IQS_SETTINGFLOW_IMX290LQR_EVB_FF_C
#define _IQS_SETTINGFLOW_IMX290LQR_EVB_FF_C
#include "IPL_IMX290LQR_EVB_FF_Int.h"
...
static ER IFE_IQparam(UINT32 Id, IQS_FLOW_MSG MsgID, IFE_SUBFUNC *subf,IPL_HAL_GROUP* group)
{
    ...
    switch((UINT32)MsgID)
    {
       ...
       //#NT#2016/05/25#Ted -end
            subf->ifeFuncEn = IFE_FuncEn[ISO_Value];
...
/*
            subf->IpeFuncEn |= (
                                ...
                                */
//#NT#2016/05/25#Ted -end
            subf->IpeFuncEn = IPE_FuncEn[ISO_Value] | IPE_YGAMMAEn;
...
static ER IFE2_IQparam(UINT32 Id, IQS_FLOW_MSG MsgID, IFE2_SUBFUNC *subf,IPL_HAL_GROUP* group)
{
    ...
    switch((UINT32)MsgID)
    {
        ...
        case IQS_AE_END:
            ...
            subf->ife2FuncEn = IFE2_FuncEn[ISO_Value];
    ...
    switch((UINT32)MsgID)
    {
        ...
        case IQCB_PREIME_D2D_IME_PRI:
          ...
          /*  subf->imeFuncEn |= (
                                ...
                                */
            subf->imeFuncEn = IME_FuncEn[ISO_Value];
