#ifndef _IQS_SETTINGFLOW_IMX078CQK_JGHT_FF_C
#define _IQS_SETTINGFLOW_IMX078CQK_JGHT_FF_C
#include "IPL_IMX078CQK_JGHT_FF_Int.h"

#if CAL_ECS
#include "IPL_Cal_DataPassing_IMX078CQK_JGHT_FF_Int.h"
#endif
#include "NOTE.h"
...
static ER IFE_IQparam(UINT32 Id, IQS_FLOW_MSG MsgID, IFE_SUBFUNC *subf,IPL_HAL_GROUP* group)
{
    ...
    switch((UINT32)MsgID)
    {
        ...
        case IQCB_PREIME_D2D_IFE_SUB:
            ...
            IQS_Outl[SenId_Value].IFE_OUTLCNT = _7_NB;
