#ifndef _IQS_SETTINGFUNC_OV4689_OV2710_EVB_FF_C
#define _IQS_SETTINGFUNC_OV4689_OV2710_EVB_FF_C
...
UINT32 IQS_GetMCTFLevel(UINT32 Id)
{
    ...
    else
    {
        ...
        else if(uiISO1 <= 800)  ui3DNRLevel = H264_3DNR_LV3;
        else if(uiISO1 <= 1000) ui3DNRLevel = H264_3DNR_LV4;
        else                    ui3DNRLevel = H264_3DNR_LV5;
    }
#else
