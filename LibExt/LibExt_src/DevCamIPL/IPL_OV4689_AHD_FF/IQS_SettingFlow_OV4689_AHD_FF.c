#ifndef _IQS_SETTINGFLOW_OV4689_AHD_FF_C
#define _IQS_SETTINGFLOW_OV4689_AHD_FF_C
#include "IPL_OV4689_AHD_FF_Int.h"

#if CAL_ECS
#include "IPL_Cal_DataPassing_OV4689_AHD_FF_Int.h"
#endif
#include "NOTE.h"
