#ifndef _IQS_SETTINGFUNC_AR0230CS_OV9750_C10_FF_C
#define _IQS_SETTINGFUNC_AR0230CS_OV9750_C10_FF_C
...
UINT32 IQS_GetMCTFLevel(UINT32 Id)
{
    ...
    if(Id == 0)
    {
        ...
        else if(uiISO1 <= 400)  ui3DNRLevel = H264_3DNR_LV2;
        else if(uiISO1 <= 1000) ui3DNRLevel = H264_3DNR_LV3;
        else if(uiISO1 <= 3000) ui3DNRLevel = H264_3DNR_LV4;
        else                    ui3DNRLevel = H264_3DNR_LV5;
    }
    else
    {
        if     (uiISO1 <= 151)  ui3DNRLevel = H264_3DNR_LV1;
        else if(uiISO1 <= 400)  ui3DNRLevel = H264_3DNR_LV2;
        else if(uiISO1 <= 1000) ui3DNRLevel = H264_3DNR_LV3;
        else if(uiISO1 <= 3000) ui3DNRLevel = H264_3DNR_LV4;
        else                    ui3DNRLevel = H264_3DNR_LV5;
