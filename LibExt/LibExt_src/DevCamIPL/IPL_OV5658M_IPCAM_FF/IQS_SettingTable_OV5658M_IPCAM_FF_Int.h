#ifndef IQS_SETTINGTABLE_OV5658M_IPCAM_FF_H
#define IQS_SETTINGTABLE_OV5658M_IPCAM_FF_H
...
#define IQS_PRV1_ISOSTART PRV1ISO0125
#define IQS_PRV1_ISOEND   PRV1ISO25600
#define IQS_PRV1_ISOEND_VALUE 25600

#define IQS_PRV1_IRoff_ISOSTART PRV1ISO0125
#define IQS_PRV1_IRoff_ISOEND   PRV1ISO25600
#define IQS_PRV1_IRoff_ISOEND_VALUE 25600

#define IQS_CAP1_ISOSTART CAP1ISO0125
#define IQS_CAP1_ISOEND   CAP1ISO3200
#define IQS_CAP1_ISOEND_VALUE 3200

#define IQS_PRV2_ISOSTART PRV2ISO0100
#define IQS_PRV2_ISOEND   PRV2ISO3200
#define IQS_PRV2_ISOEND_VALUE 3200

#define IQS_CAP2_ISOSTART CAP2ISO0100
#define IQS_CAP2_ISOEND   CAP2ISO3200
#define IQS_CAP2_ISOEND_VALUE 3200
...
#define IQS_ISOMAPTAB_NUM 11
#define IQS_ISOMAP_END    999999

extern ISOMAP IQS1_ISOMapTab[3][IQS_ISOMAPTAB_NUM];
extern ISOMAP IQS2_ISOMapTab[2][IQS_ISOMAPTAB_NUM];

extern UINT16 IQS_OBSub_BHDR[Total_SENIDNum];
...
extern UINT32 IQS_ECSTab_highISO[Total_SENIDNum][4225];
extern UINT32 IQS_ECSTab_Init[Total_SENIDNum][4225];
...
extern IQS_VIG_SET IQS_Vig_Set_Init[Total_SENIDNum];
...
extern UINT8 IQS_hueTab_5000K[Total_SENIDNum][24];
extern UINT8 IQS_hueTab_3000K[Total_SENIDNum][24];
extern UINT8 IQS_hueTab_H[Total_SENIDNum][24];
extern UINT8 IQS_hueTab_M[Total_SENIDNum][24];
extern UINT8 IQS_hueTab_L[Total_SENIDNum][24];
extern INT32 IQS_satTab[Total_SENIDNum][24];
extern UINT32 IQS_satTab_5000K[Total_SENIDNum][24];
extern UINT32 IQS_satTab_3000K[Total_SENIDNum][24];
extern INT32 IQS_satTab_H[Total_SENIDNum][24];
extern INT32 IQS_satTab_M[Total_SENIDNum][24];
extern INT32 IQS_satTab_L[Total_SENIDNum][24];
extern INT32 IQS_intTab[Total_SENIDNum][24];
extern INT32 IQS_intTab_H[Total_SENIDNum][24];
extern INT32 IQS_intTab_M[Total_SENIDNum][24];
extern INT32 IQS_intTab_L[Total_SENIDNum][24];
...
extern H264Enc3dnrCfg IQS_3DNR_Param_LV6;
extern H264Enc3dnrCfg IQS_3DNR_Param_LV7;
extern H264Enc3dnrCfg IQS_3DNR_Param_LV8;
extern H264Enc3dnrCfg IQS_3DNR_Param_LV9;
extern H264Enc3dnrCfg IQS_3DNR_Param_LV10;
extern H264Enc3dnrCfg IQS_3DNR_Param_LV11;
extern H264Enc3dnrCfg IQS_3DNR_Param_LV12;
extern H264Enc3dnrCfg IQS_3DNR_Param_LV13;
extern H264Enc3dnrCfg IQS_3DNR_Param_LV14;
extern H264Enc3dnrCfg IQS_3DNR_Param_LV15;
extern H264Enc3dnrCfg IQS_3DNR_Param_LV16;
