...
const UINT32 VDOZOOM_INFOR_MODE_13_TABLE[1][DZOOM_ITEM_MAX] =
{
...
UINT32* SenMode2Tbl(UINT32 Id, UINT32 SenMode, UINT32 *DzMaxidx)
{
    ...
    if ( Id == IPL_ID_1 || (Id == IPL_ID_2 && IPL_CtrlGetInfor(IPL_ID_1, IPLCTRL_EXT_FUNC_EN) == ICF_FUNC_SHDR) )
    {
        switch(SenMode)
        {
            ...
            case SENSOR_MODE_13:
                Ptr = (UINT32*)&VDOZOOM_INFOR_MODE_13_TABLE[0][0];
                *DzMaxidx = (sizeof(VDOZOOM_INFOR_MODE_13_TABLE) / 4 / DZOOM_ITEM_MAX) - 1;
                break;
