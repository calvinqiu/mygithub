...
#include "IPL_IMX206CQC_EVB_FF_Int.h"
            ...
            switch(Video_SIZE)
            {
                case SEL_VIDEOSIZE_1920x1080:
                    if (Video_FPS == SEL_VIDEOFPS_60)
                        SenMode = SENSOR_MODE_7; //1920 X 1080 60fps
                    else if (Video_FPS == SEL_VIDEOFPS_120)
                        SenMode = SENSOR_MODE_8; //1920 X 1080 120fps
                    else
                        SenMode = SENSOR_MODE_1; //1920 X 1080 30fps
                    break;
                ...
                case SEL_VIDEOSIZE_1280x720:
                    if(Video_FPS == SEL_VIDEOFPS_60)
                        ...
                        SenMode = SENSOR_MODE_1;
                    break;
//#NT#2016/02/24#Jarkko Chang -begin
//#NT# fixed vga240fps error
                case SEL_VIDEOSIZE_640x480:
                    if (Video_FPS == SEL_VIDEOFPS_240)
                        SenMode = SENSOR_MODE_4; //vga240fps
                    break;
//#NT#2016/02/24#Jarkko Chang -end
        ...
        case IPL_MODE_CAP:
            SenMode = SENSOR_MODE_2; //4000 X 3000 10fps
