...
//#NT#2016/09/22#Jarkko Chang -begin
//#NT# Add 2688x1508 27.5fps and 55fps sensor mode
const UINT32 VDOZOOM_INFOR_MODE_11_TABLE[20][DZOOM_ITEM_MAX] =
{
    {2688, 1508, 2112, 1188, 2112, 1188, 2688, 1508}, //1
    {2608, 1472, 2112, 1188, 2112, 1188, 2608, 1472}, //2
    {2544, 1424, 2112, 1188, 2112, 1188, 2544, 1424}, //3
...
const UINT32 VDOZOOM_INFOR_MODE_12_TABLE[20][DZOOM_ITEM_MAX] =
{
    {2688, 1508, 2112, 1188, 2112, 1188, 2688, 1508}, //1
    {2608, 1472, 2112, 1188, 2112, 1188, 2608, 1472}, //2
    {2544, 1424, 2112, 1188, 2112, 1188, 2544, 1424}, //3
...
//#NT#2016/09/22#Jarkko Chang -end
...
UINT32* SenMode2Tbl(UINT32 Id, UINT32 SenMode, UINT32 *DzMaxidx)
{
    ...
    if ( Id == IPL_ID_1 || (Id == IPL_ID_2 && IPL_CtrlGetInfor(IPL_ID_1, IPLCTRL_EXT_FUNC_EN) == ICF_FUNC_SHDR) )
    {
        switch(SenMode)
        {
			...
			//#NT# Add 2688x1508 27.5fps and 55fps sensor mode
            case SENSOR_MODE_11:
                Ptr = (UINT32*)&VDOZOOM_INFOR_MODE_11_TABLE[0][0];
                *DzMaxidx = (sizeof(VDOZOOM_INFOR_MODE_11_TABLE) / 4 / DZOOM_ITEM_MAX) - 1;
                break;

            case SENSOR_MODE_12:
                Ptr = (UINT32*)&VDOZOOM_INFOR_MODE_12_TABLE[0][0];
                *DzMaxidx = (sizeof(VDOZOOM_INFOR_MODE_12_TABLE) / 4 / DZOOM_ITEM_MAX) - 1;
                break;
			//#NT#2016/09/22#Jarkko Chang -end
            default:
                Ptr = NULL;
