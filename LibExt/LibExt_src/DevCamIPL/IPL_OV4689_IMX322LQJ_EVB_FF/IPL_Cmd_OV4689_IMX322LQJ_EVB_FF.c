...
#include "IPL_OV4689_IMX322LQJ_EVB_FF_Int.h"
//note: do not delete
//avoid compiler optimize "weak function"
//WEAK_DUMMY_CALL(CMD, CTRL1)
//#NT#2017/03/15#Jarkko Chang -begin
//#NT# add debug code
#define IPL_CTRL_DBG DISABLE
#if IPL_CTRL_DBG
...
#endif
//#NT#2017/03/15#Jarkko Chang -end
...
//#NT# add debug code
#if IPL_CTRL_DBG
	DBG_DUMP("SetIPLStop-> Cur->Nxt(Trg): %s->%s(%s) ,%s->%s(%s) ,%s->%s(%s) ,%s->%s(%s)\r\n",
			 ipl_dbg_mode_tbl[IPLModeInfo[0]->Mode], ipl_dbg_mode_tbl[ChgMode[0].Mode], ipl_dbg_trigflg_tbl[TrigFlg[0]],
			 ipl_dbg_mode_tbl[IPLModeInfo[1]->Mode], ipl_dbg_mode_tbl[ChgMode[1].Mode], ipl_dbg_trigflg_tbl[TrigFlg[1]],
			 ipl_dbg_mode_tbl[IPLModeInfo[2]->Mode], ipl_dbg_mode_tbl[ChgMode[2].Mode], ipl_dbg_trigflg_tbl[TrigFlg[2]],
			 ipl_dbg_mode_tbl[IPLModeInfo[3]->Mode], ipl_dbg_mode_tbl[ChgMode[3].Mode], ipl_dbg_trigflg_tbl[TrigFlg[3]]);
#endif
//#NT#2017/03/15#Jarkko Chang -end
...
//#NT# add debug code
#if IPL_CTRL_DBG
	DBG_DUMP("SetIPLResume-> Cur->Nxt(Act): %s->%s(%s), %s->%s(%s) ,%s->%s(%s) ,%s->%s(%s)\r\n",
			 ipl_dbg_mode_tbl[IPLModeInfo[0]->Mode], ipl_dbg_mode_tbl[ChgMode[0].Mode], ipl_dbg_trigflg_tbl[TrigFlg[0]],
			 ipl_dbg_mode_tbl[IPLModeInfo[1]->Mode], ipl_dbg_mode_tbl[ChgMode[1].Mode], ipl_dbg_trigflg_tbl[TrigFlg[1]],
			 ipl_dbg_mode_tbl[IPLModeInfo[2]->Mode], ipl_dbg_mode_tbl[ChgMode[2].Mode], ipl_dbg_trigflg_tbl[TrigFlg[2]],
			 ipl_dbg_mode_tbl[IPLModeInfo[3]->Mode], ipl_dbg_mode_tbl[ChgMode[3].Mode], ipl_dbg_trigflg_tbl[TrigFlg[3]]);
...
//#NT# add debug code
#if IPL_CTRL_DBG
	DBG_DUMP("\r\nSetTrigInfo-> PRV->Nxt(Act)(trig): %s->%s(%d)(%s) ,%s->%s(%d)(%s) ,%s->%s(%d)(%s) ,%s->%s(%d)(%s)\r\n",
			 ipl_dbg_mode_tbl[PRV_MODE[0]], ipl_dbg_mode_tbl[ChgMode[0].Mode], ChgMode[0].ActFlg, ipl_dbg_trigflg_tbl[TrigFlg[0]],
			 ipl_dbg_mode_tbl[PRV_MODE[1]], ipl_dbg_mode_tbl[ChgMode[1].Mode], ChgMode[1].ActFlg, ipl_dbg_trigflg_tbl[TrigFlg[1]],
			 ipl_dbg_mode_tbl[PRV_MODE[2]], ipl_dbg_mode_tbl[ChgMode[2].Mode], ChgMode[2].ActFlg, ipl_dbg_trigflg_tbl[TrigFlg[2]],
			 ipl_dbg_mode_tbl[PRV_MODE[3]], ipl_dbg_mode_tbl[ChgMode[3].Mode], ChgMode[3].ActFlg, ipl_dbg_trigflg_tbl[TrigFlg[3]]);
#endif
//#NT#2017/03/15#Jarkko Chang -end
...
//#NT# add debug code
#if IPL_CTRL_DBG
	DBG_DUMP("\r\nSetTrigInfo end-> PRV->Nxt(Act): %s->%s(%s) ,%s->%s(%s) ,%s->%s(%s) ,%s->%s(%s)\r\n",
			 ipl_dbg_mode_tbl[PRV_MODE[0]], ipl_dbg_mode_tbl[ChgMode[0].Mode], ipl_dbg_trigflg_tbl[TrigFlg[0]],
			 ipl_dbg_mode_tbl[PRV_MODE[1]], ipl_dbg_mode_tbl[ChgMode[1].Mode], ipl_dbg_trigflg_tbl[TrigFlg[1]],
			 ipl_dbg_mode_tbl[PRV_MODE[2]], ipl_dbg_mode_tbl[ChgMode[2].Mode], ipl_dbg_trigflg_tbl[TrigFlg[2]],
			 ipl_dbg_mode_tbl[PRV_MODE[3]], ipl_dbg_mode_tbl[ChgMode[3].Mode], ipl_dbg_trigflg_tbl[TrigFlg[3]]);
#endif
//#NT#2017/03/15#Jarkko Chang -end
