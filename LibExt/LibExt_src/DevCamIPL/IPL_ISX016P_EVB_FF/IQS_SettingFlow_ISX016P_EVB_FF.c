#ifndef _IQS_SETTINGFLOW_ISX016P_EVB_FF_C
#define _IQS_SETTINGFLOW_ISX016P_EVB_FF_C
#include "IPL_ISX016P_EVB_FF_Int.h"

#if CAL_ECS
#include "IPL_Cal_DataPassing_ISX016P_EVB_FF_Int.h"
#endif
