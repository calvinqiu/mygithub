#ifndef IPL_EXT_FUNC_ISX016P_H_
#define IPL_EXT_FUNC_ISX016P_H_
/**
    IPL_ExtFunc_ISX016P_EVB_FF_Int.h


    @file       IPL_ExtFunc_ISX016P_EVB_FF_Int.h
    @ingroup    mISYSAlg
