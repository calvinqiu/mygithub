#ifndef _IQS_SETTINGFLOW_AR0237CS_EVB_FF_C
#define _IQS_SETTINGFLOW_AR0237CS_EVB_FF_C
#include "IPL_AR0237CS_EVB_FF_Int.h"
#if CAL_ECS
#include "IPL_Cal_DataPassing_AR0237CS_EVB_FF_Int.h"
#endif
#include "NOTE.h"
