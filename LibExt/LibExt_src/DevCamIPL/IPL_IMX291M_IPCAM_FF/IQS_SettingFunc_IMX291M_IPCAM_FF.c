#ifndef _IQS_SETTINGFUNC_IMX291M_IPCAM_FF_C
#define _IQS_SETTINGFUNC_IMX291M_IPCAM_FF_C
...
UINT32 IQS_GetMCTFLevel(UINT32 Id)
{
    ...
    else if(uiISO1 <= 20000) ui3DNRLevel = H264_3DNR_IPCAM_LV9;
    else                     ui3DNRLevel = H264_3DNR_IPCAM_LV13;
