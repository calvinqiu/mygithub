...
// IMX078CQK FIREFLY lens shading, skip dp dark calibration
...
static ER DP_Adjust_Bright(IPL_PROC_ID Id, fpUI_cb fpUIcb,UINT32 DmaAddr,UINT32 DmaSize)
{
    ...
    */
    ...
    // IMX078CQK lens shading, cannot calibrate dp dark
#if DP_Bright_only
#else
...
BOOL CAL_ReadDebugConfig_IMX078CQK_EVB_FF(void)
{
...
pCAL_ITEM_OBJ CAL_ITEM_IMX078CQK_EVB_FF(IPL_PROC_ID Id)
{
...
ER Set2Preview_IMX078CQK_EVB_FF(IPL_PROC_ID Id, UINT32 IplNum, UINT32 BufAddr,UINT32 BufSize)
{
    CalBuf buf = {0};
    SENSOR_INFO Drv_Sensor;
    CTRL_PTR CtrlInfo = {0};
