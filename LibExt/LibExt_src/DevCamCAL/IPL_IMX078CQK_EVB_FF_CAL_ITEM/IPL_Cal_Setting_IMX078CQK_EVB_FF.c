#include "IPL_Cal_Setting_IMX078CQK_EVB_FF_Int.h"
...
Cal_SENSOR_INFO SensorMode_ECS_IPL1[] = {
    {SENSOR_MODE_1, FALSE,FALSE,_RISING,_RISING,_RISING,0,0}, // full resolution
    {SENSOR_MODE_UNKNOWN, 0,0,0,0,0,0,0,},
};

Cal_SENSOR_INFO SensorMode_DP_IPL1[] = {
    {SENSOR_MODE_1, FALSE,FALSE,_RISING,_RISING,_RISING,0,0},
    {SENSOR_MODE_2, FALSE,FALSE,_RISING,_RISING,_RISING,0,0}, // same as SENSOR_MODE_4
...
Cal_SENSOR_INFO SensorMode_ISO_IPL1[] = {
    {SENSOR_MODE_1, FALSE,FALSE,_RISING,_RISING,_RISING,0,0}, // can not be binning mode
    {SENSOR_MODE_UNKNOWN, 0,0,0,0,0,0,0,},
};
...
Cal_SECTION CalSection_IPL1[] = {
    ...
    {SEC_ECS_1,         &SensorMode_ECS_IPL1[0],        (65*65*4*1+0x100),    &AeInfo_ECS_IPL1[0],    TRUE},//ECS
