...
#include "IPL_Cal_Ctrl_MN34120_EVB_FF_Int.h"
...
#define AE_TimeOut DISABLE // if ae timeout, cal status result is CAL_AE_TIMEOUT (CAL FAIL)
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
            for(idx_frm_cnt=0; idx_frm_cnt<DPC_SEARCH_FRM_CNT; idx_frm_cnt++)
            {
                //chg sie to capture mode
                CalApi()->fpSetMode(Id,CAL_IPL_CAP,&CtrlPtr,Cal_CtrlInit()->fpDP_CtrlInit);
                Bayer = CalApi()->fpGetRawInfo(Id);
                ...
                TempExpT = SectionInfo.CalAeInfoCon->CalAeInfo.uiExpT[0];
                //SectionInfo.CalAeInfoCon->CalAeInfo.uiExpT[0] = SectionInfo.CalAeInfoCon->CalAeInfo.uiExpT[0]*100/Drv_Sensor.Mode->biningRatio;
                //SectionInfo.CalAeInfoCon->CalAeInfo.uiExpT[0] = SectionInfo.CalAeInfoCon->CalAeInfo.uiExpT[0];
...
BOOL CAL_ReadDebugConfig_MN34120_EVB_FF(void)
{
...
pCAL_ITEM_OBJ CAL_ITEM_MN34120_EVB_FF(IPL_PROC_ID Id)
{
...
ER Set2Preview_MN34120_EVB_FF(IPL_PROC_ID Id, UINT32 IplNum, UINT32 BufAddr,UINT32 BufSize)
{
    CalBuf buf = {0};
    SENSOR_INFO Drv_Sensor;
    CTRL_PTR CtrlInfo = {0};
    ...
    UINT32 TempExpT;
    TempExpT = SectionInfo.CalAeInfoCon->CalAeInfo.uiExpT[0];
    DBG_ERR("TempExpT = %d, Binning = %d\r\n", TempExpT, Drv_Sensor.Mode->biningRatio);
    //SectionInfo.CalAeInfoCon->CalAeInfo.uiExpT[0] = SectionInfo.CalAeInfoCon->CalAeInfo.uiExpT[0]*100/Drv_Sensor.Mode->biningRatio;
    //SectionInfo.CalAeInfoCon->CalAeInfo.uiExpT[0] = SectionInfo.CalAeInfoCon->CalAeInfo.uiExpT[0];
    CalApi()->fp3AEvent()->fpAEStable(&BayerInfo.BaseInfo,SectionInfo.CalAeInfoCon->CalAeInfo,Id);
    SectionInfo.CalAeInfoCon->CalAeInfo.uiExpT[0] = TempExpT;
