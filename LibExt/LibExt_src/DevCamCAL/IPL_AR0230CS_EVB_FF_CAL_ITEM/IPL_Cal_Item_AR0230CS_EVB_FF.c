...
#include "IPL_Cal_Ctrl_AR0230CS_EVB_FF_Int.h"
#include "IPL_Cal_Setting_AR0230CS_EVB_FF_Int.h"
#include "ae_task.h"
#include "awb_task.h"
    ...
    while (SectionInfo.CalAeInfoCon[ConditionCnt].CalConditin != CAL_CONDITION_END)
    {
        ...
        while (SectionInfo.SenModeInfo[SenModeCnt].SenMode != SENSOR_MODE_UNKNOWN)
        {
            ...
            if (DbgIdxMapValue(CALDEBUG_RESULT_DATA)== 1)
            {
                ...
                buf_cnt = snprintf(NULL, 0, "A:\\CALDEBUG_RESULT_DATA_ECS.txt");
                snprintf(g_CalSaveMsgName, buf_cnt+1, "A:\\CALDEBUG_RESULT_DATA_ECS.txt");
    ...
    while (SectionInfo.CalAeInfoCon[ConditionCnt].CalConditin != CAL_CONDITION_END)
    {
        ...
        while (SectionInfo.SenModeInfo[SenModeCnt].SenMode != SENSOR_MODE_UNKNOWN)
        {
            ...
            if (DbgIdxMapValue(CALDEBUG_RESULT_DATA)== 1)
            {
                ...
                buf_cnt = snprintf(NULL, 0, "A:\\CALDEBUG_RESULT_DATA_ISO.txt");
                snprintf(g_CalSaveMsgName, buf_cnt+1, "A:\\CALDEBUG_RESULT_DATA_ISO.txt");
    ...
    while (SectionInfo.CalAeInfoCon[ConditionCnt].CalConditin != CAL_CONDITION_END)
    {
        ...
        while (SectionInfo.SenModeInfo[SenModeCnt].SenMode != SENSOR_MODE_UNKNOWN)
        {
            ...
            if (DbgIdxMapValue(CALDEBUG_RESULT_DATA)== 1)
            {
                ...
                buf_cnt = snprintf(NULL, 0, "A:\\CALDEBUG_RESULT_DATA_AWB.txt");
                snprintf(g_CalSaveMsgName, buf_cnt+1, "A:\\CALDEBUG_RESULT_DATA_AWB.txt");
    ...
    while (SectionInfo.CalAeInfoCon[ConditionCnt].CalConditin != CAL_CONDITION_END)
    {
        ...
        while (SectionInfo.SenModeInfo[SenModeCnt].SenMode != SENSOR_MODE_UNKNOWN)
        {
            ...
            if (DbgIdxMapValue(CALDEBUG_RESULT_DATA)== 1)
            {
                ...
                buf_cnt = snprintf(NULL, 0, "A:\\CALDEBUG_RESULT_DATA_DPD.txt");
                snprintf(g_CalSaveMsgName, buf_cnt+1, "A:\\CALDEBUG_RESULT_DATA_DPD.txt");
    ...
    while (SectionInfo.CalAeInfoCon[ConditionCnt].CalConditin != CAL_CONDITION_END)
    {
        ...
        while (SectionInfo.SenModeInfo[SenModeCnt].SenMode != SENSOR_MODE_UNKNOWN)
        {
            ...
            if (DbgIdxMapValue(CALDEBUG_RESULT_DATA)== 1)
            {
                ...
                buf_cnt = snprintf(NULL, 0, "A:\\CALDEBUG_RESULT_DATA_DPB.txt");
                snprintf(g_CalSaveMsgName, buf_cnt+1, "A:\\CALDEBUG_RESULT_DATA_DPB.txt");
    ...
    while (SectionInfo.CalAeInfoCon[ConditionCnt].CalConditin != CAL_CONDITION_END)
    {
        ...
        while (SectionInfo.SenModeInfo[SenModeCnt].SenMode != SENSOR_MODE_UNKNOWN)
        {
            ...
            if (DbgIdxMapValue(CALDEBUG_RESULT_DATA)== 1)
            {
                ...
                buf_cnt = snprintf(NULL, 0, "A:\\CALDEBUG_RESULT_DATA_LENSCEN.txt");
                snprintf(g_CalSaveMsgName, buf_cnt+1, "A:\\CALDEBUG_RESULT_DATA_LENSCEN.txt");
...
BOOL CAL_ReadDebugConfig_AR0230CS_EVB_FF(void)
{
...
pCAL_ITEM_OBJ CAL_ITEM_AR0230CS_EVB_FF(IPL_PROC_ID Id)
{
...
ER Set2Preview_AR0230CS_EVB_FF(IPL_PROC_ID Id, UINT32 IplNum, UINT32 BufAddr,UINT32 BufSize)
{
    CalBuf buf = {0};
