...
Cal_SECTION CalSection_IPL1[] = {
    ...
    {SEC_DP_1,          &SensorMode_DP_IPL1[0],         (10000*4+0x100),         &AeInfo_DPB_IPL1[0],    TRUE},//DP bright
    {SEC_DP_1,          &SensorMode_DP_IPL1[0],         (10000*4+0x100),         &AeInfo_DPD_IPL1[0],    FALSE},//DP dark
