...
#include "IPL_Cal_Ctrl_MN34110_EVB_FF_Int.h"
...
BOOL CAL_ReadDebugConfig_MN34110_EVB_FF(void)
{
...
pCAL_ITEM_OBJ CAL_ITEM_MN34110_EVB_FF(IPL_PROC_ID Id)
{
...
ER Set2Preview_MN34110_EVB_FF(IPL_PROC_ID Id, UINT32 IplNum, UINT32 BufAddr,UINT32 BufSize)
{
    CalBuf buf = {0};
    SENSOR_INFO Drv_Sensor;
    CTRL_PTR CtrlInfo = {0};
