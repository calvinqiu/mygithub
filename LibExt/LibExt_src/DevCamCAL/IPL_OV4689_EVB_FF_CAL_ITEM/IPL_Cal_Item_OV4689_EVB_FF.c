...
#include "IPL_Cal_Ctrl_OV4689_EVB_FF_Int.h"
#include "IPL_Cal_Setting_OV4689_EVB_FF_Int.h"
#include "ae_task.h"
#include "awb_task.h"
...
BOOL CAL_ReadDebugConfig_OV4689_EVB_FF(void)
{
...
pCAL_ITEM_OBJ CAL_ITEM_OV4689_EVB_FF(IPL_PROC_ID Id)
{
...
ER Set2Preview_OV4689_EVB_FF(IPL_PROC_ID Id, UINT32 IplNum, UINT32 BufAddr,UINT32 BufSize)
{
    CalBuf buf = {0};
    SENSOR_INFO Drv_Sensor;
    CTRL_PTR CtrlInfo = {0};
