...
*/
#ifndef _AE_AR0237CS_TCT_IPCAM_FF_INT_H_
#define _AE_AR0237CS_TCT_IPCAM_FF_INT_H_
...
extern UINT32 ExptY_Mov_OverExpoAdj_WDR[AE_PROC_CNT][AEALG_DYNAMIC_EXPECT_LUM_MAX];
