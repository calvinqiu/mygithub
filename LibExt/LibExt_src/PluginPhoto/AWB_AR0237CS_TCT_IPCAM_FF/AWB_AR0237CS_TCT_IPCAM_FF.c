...
#include "awb_api.h"
#include "awb_task.h"
#include "AWB_AR0237CS_TCT_IPCAM_FF_int.h"
#include "ae_api.h"
#include "NOTE.h"
...
UINT32 AWB_Get_IrcutInfo(void* data)
{
    AWB_IRCUT_INFO* info = (AWB_IRCUT_INFO*)data;
    UINT32 Id = info->Id;
    // Calculate average color by CA
    UINT32 r, g, b;
    AWB_Get_ColorAvg(Id, &r, &g, &b);
    info->color_avg[0] = r;
    info->color_avg[1] = g;
    info->color_avg[2] = b;
    info->color_gain[0] = AwbInfo[Id].AWBGain.RGain;
    info->color_gain[1] = AwbInfo[Id].AWBGain.GGain;
    info->color_gain[2] = AwbInfo[Id].AWBGain.BGain;
