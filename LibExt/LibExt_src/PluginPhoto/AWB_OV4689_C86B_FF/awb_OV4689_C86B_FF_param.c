...
#include "awb_alg.h"
#include "awb_api.h"
#include "awb_OV4689_C86B_FF_int.h"

#define AWB_CT1_8500K_RGAIN 600
#define AWB_CT1_8500K_BGAIN 275

#define AWB_CT1_8000K_RGAIN 604
#define AWB_CT1_8000K_BGAIN 302

#define AWB_CT1_7000K_RGAIN 613
#define AWB_CT1_7000K_BGAIN 355

#define AWB_CT1_5500K_RGAIN 625
#define AWB_CT1_5500K_BGAIN 434

#define AWB_CT1_5000K_RGAIN 537
#define AWB_CT1_5000K_BGAIN 438

#define AWB_CT1_4000K_RGAIN 432
#define AWB_CT1_4000K_BGAIN 597

#define AWB_CT1_2500K_RGAIN 273
#define AWB_CT1_2500K_BGAIN 835
...
{
    {
        ...
        {8000 , {AWB_CT1_8000K_RGAIN, 256, AWB_CT1_8000K_BGAIN}},
...
AWBALG_ELEMET WhiteIndoorElement1[] =
{
    ...
    {AWBALG_TYPE_RG,     268,  95, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_BG,     358, 124, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_RBG,    335,  51, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_RBGSUM, 475, 339, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_RXBG,   453, 296, {  0,  0}, {  0,  0}},
    {AWBALG_TAB_END,       0,   0, {  0,  0}, {  0,  0}}
};
...
{
    {AWBALG_TYPE_Y,      (200<<4),   (4<<4), {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_RG,     268, 189, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_BG,     188, 124, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_RBG,     89,  51, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_RBGSUM, 454, 339, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_RXBG,   453, 296, {  0,  0}, {  0,  0}},
    {AWBALG_TAB_END,       0,   0, {  0,  0}, {  0,  0}}
};
...
{
    {
        105,  95,                                       // HCTRatio; //100~200
        {AWB_CT1_8500K_RGAIN, 256, AWB_CT1_8500K_BGAIN},   // HCTMaxGain;
        {AWB_CT1_8500K_RGAIN, 256, AWB_CT1_8500K_BGAIN},   // HCTMinGain;
        105,  95,                                        // LCTRatio;  //100~200
        {AWB_CT1_8500K_RGAIN, 256, AWB_CT1_8500K_BGAIN},   // LCTMaxGain; 4500K
        {AWB_CT1_8500K_RGAIN, 256, AWB_CT1_8500K_BGAIN}    // LCTMinGain; 2556K
    },
    {
