/**
    ...
    @file       ae_IMX291M_EVB_FF_int.h
    @ingroup    mISYSAlg
    @note       Nothing (or anything need to be mentioned).

    Copyright   Novatek Microelectronics Corp. 2011.  All rights reserved.
*/
#ifndef _AE_IMX291M_IPCAM_FF_INT_H_
#define _AE_IMX291M_IPCAM_FF_INT_H_
...
#define AE_60FREQ_NODE              ((1 << 1) | (1 << 2) | (1 << 4) | (1 << 8))
#define AE_50FREQ_NODE              ((1 << 1) | (1 << 2) | (1 << 4))
