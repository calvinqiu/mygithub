...
#if CAL_ISO
#include "ipl_cal_datapassing_IMX117CQT_EVB_FF_int.h"
#endif
...
void AE_Init (UINT32 Id, UINT32 CurrentStatus)
{
    ...
    if (AE_GetTrigFlagID(IPL_UTI_CONV2_AE_ID(Id), &AEFlagID) != E_OK)
    {
        DBG_ERR("get AE_GetTrigFlagID fail\r\n");
    }
