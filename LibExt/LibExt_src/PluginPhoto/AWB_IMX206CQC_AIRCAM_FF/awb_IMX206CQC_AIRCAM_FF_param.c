/**
    ...
    @file       awb_IMX206CQC_AIRCAM_FF_param.c
    @ingroup    mISYSAlg
...
#include "awb_alg.h"
#include "awb_api.h"
#include "awb_IMX206CQC_AIRCAM_FF_int.h"
...
#define AWB_CT1_6500K_RGAIN 580
#define AWB_CT1_6500K_BGAIN 406

#define AWB_CT1_6000K_RGAIN 600
#define AWB_CT1_6000K_BGAIN 444

#define AWB_CT1_5000K_RGAIN 485
#define AWB_CT1_5000K_BGAIN 460

#define AWB_CT1_4000K_RGAIN 396
#define AWB_CT1_4000K_BGAIN 570
...
AWBALG_ELEMET WhiteIndoorElement1[] =
{
    ...
    {AWBALG_TYPE_RG,     260,  91, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_BG,     317, 129, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_RBG,    310,  58, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_RBGSUM, 451, 326, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_RXBG,   451, 262, {  0,  0}, {  0,  0}},
    {AWBALG_TAB_END,       0,   0, {  0,  0}, {  0,  0}}
};
