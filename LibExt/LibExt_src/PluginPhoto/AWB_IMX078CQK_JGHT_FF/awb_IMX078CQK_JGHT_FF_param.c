...
#include "awb_alg.h"
#include "awb_api.h"
#include "awb_IMX078CQK_JGHT_FF_int.h"

#define AWB_CT1_8500K_RGAIN 387
#define AWB_CT1_8500K_BGAIN 268

#define AWB_CT1_7700K_RGAIN 403
#define AWB_CT1_7700K_BGAIN 287

#define AWB_CT1_7000K_RGAIN 418
#define AWB_CT1_7000K_BGAIN 306

#define AWB_CT1_5500K_RGAIN 457
#define AWB_CT1_5500K_BGAIN 359

#define AWB_CT1_5000K_RGAIN 377
#define AWB_CT1_5000K_BGAIN 368

#define AWB_CT1_4000K_RGAIN 279
#define AWB_CT1_4000K_BGAIN 434

#define AWB_CT1_2500K_RGAIN 212
#define AWB_CT1_2500K_BGAIN 556

#define AWB_CT1_2000K_RGAIN 197
#define AWB_CT1_2000K_BGAIN 611
...
AWB_CAINFO AwbPreWhiteElement[AWB_PROC_CNT] =
{
    {
        32, 32,
        1384,       //UINT32 RGu; (R/G)<<10
        514,        //UINT32 RGl;
        (240<<4),   //UINT32 GGu; G (12Bits)
        (2<<4),     //UINT32 GGl;
        957,        //UINT32 BGu; (B/G)<<10
        432,        //UINT32 BGl;
...
AWBALG_ELEMET WhiteIndoorElement1[] =
{
    ...
    {AWBALG_TYPE_RG,     199,  74, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_BG,     237, 107, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_RBG,    287,  64, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_RBGSUM, 355, 254, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_RXBG,   280, 158, {  0,  0}, {  0,  0}},
    {AWBALG_TAB_END,       0,   0, {  0,  0}, {  0,  0}}
};
...
{
    {AWBALG_TYPE_Y,      (200<<4),   (4<<4), {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_RG,     179, 123, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_BG,     147, 104, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_RBG,    107,  68, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_RBGSUM, 326, 240, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_RXBG,   239, 157, {  0,  0}, {  0,  0}},
    {AWBALG_TAB_END,       0,   0, {  0,  0}, {  0,  0}}
};
...
{
    {
        ...
        {AWB_CT1_5500K_RGAIN, 256, AWB_CT1_8500K_BGAIN},   // HCTMaxGain; 8500K
        (10<<14),                                         // LCTMaxEV; LV14
        (10<<10),                                         // LCTMinEV; LV8
...
UINT32 MwbTAB[AWB_PROC_CNT][AWB_MODE_MAX][3] =
{
    ...
    { AWB_CT2_5000K_RGAIN, 256, AWB_CT2_5000K_RGAIN},//AWB_MODE_FLUORESCENT1
    { 256, 256, 256},
    { 256, 256, 256},
    { 256, 256, 256},
    { 256, 256, 256},
