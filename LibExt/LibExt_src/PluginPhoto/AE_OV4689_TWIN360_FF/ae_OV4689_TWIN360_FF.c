...
#if CAL_ISO
#include "ipl_cal_datapassing_OV4689_TWIN360_FF_int.h"
#endif
...
void AE_SetPLINEInfo(UINT32 Id, AE_EXT_SET_INFO SetInfo)
{
    if (SetInfo.PLineMode == AE_PLINE_AUTOGEN)
    {
        ...
        {
            //#NT#2016/05/25#Jarkko Chang#[60622] -begin
            //#NT# remove used code
            //SetInfo.IrisSetting.IrisMode = AE_IRIS_MODE_OPEN;
            //#NT#2016/05/25#Jarkko Chang#[60622] -end
