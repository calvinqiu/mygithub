...
*/
#ifndef _AE_AR0238CSP_EVB_FF_INT_H_
#define _AE_AR0238CSP_EVB_FF_INT_H_
...
extern UINT32 ExptY_Mov_PrvHDR[AE_PROC_CNT][AEALG_DYNAMIC_EXPECT_LUM_MAX];
...
extern UINT32 ExptY_Mov_OverExpoAdjHDR[AE_PROC_CNT][AEALG_DYNAMIC_EXPECT_LUM_MAX];
