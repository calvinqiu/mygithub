...
#include "awb_alg.h"
#include "awb_api.h"
#include "awb_IMX258_OV7251_EVB_FF_int.h"
...
AWBALG_ELEMET WhiteIndoorElement1[] =
{
    ...
    {AWBALG_TYPE_RG,     255,  97, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_BG,     296, 114, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_RBG,    270,  51, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_RBGSUM, 422, 312, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_RXBG,   386, 252, {  0,  0}, {  0,  0}},
    {AWBALG_TAB_END,       0,   0, {  0,  0}, {  0,  0}}
};
...
{
    {AWBALG_TYPE_Y,      (200<<4),   (8<<4), {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_RG,     255, 175, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_BG,     173, 136, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_RBG,    89, 59, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_RBGSUM, 422, 312, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_RXBG,   386, 266, {  0,  0}, {  0,  0}},
    {AWBALG_TAB_END,       0,   0, {  0,  0}, {  0,  0}}
};
