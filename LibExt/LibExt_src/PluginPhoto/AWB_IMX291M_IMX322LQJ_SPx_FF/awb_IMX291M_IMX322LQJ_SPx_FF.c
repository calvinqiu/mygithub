...
#include "awb_api.h"
#include "awb_task.h"
#include "awb_IMX291M_IMX322LQJ_SPx_FF_int.h"
#include "ae_api.h"
#include "NOTE.h"
...
{
   #define AWB_LV_EVENING_START     80
   #define AWB_LV_EVENING_END    50
   UINT32 aLv = AE_GetPrvLVValue(Id);
   if(aLv >AWB_LV_EVENING_START)
   {
   ...
   else if (aLv <AWB_LV_EVENING_END)
   {
        CAInfo->WinNumX = AwbPreWhiteElement_night.WinNumX;
        CAInfo->WinNumY = AwbPreWhiteElement_night.WinNumY;
        CAInfo->RGl = AwbPreWhiteElement_night.RGl;
        CAInfo->RGu = AwbPreWhiteElement_night.RGu;
        CAInfo->GGl = AwbPreWhiteElement_night.GGl;
        CAInfo->GGu = AwbPreWhiteElement_night.GGu;
        CAInfo->BGl = AwbPreWhiteElement_night.BGl;
        CAInfo->BGu = AwbPreWhiteElement_night.BGu;
        CAInfo->RBGl = AwbPreWhiteElement_night.RBGl;
        CAInfo->RBGu = AwbPreWhiteElement_night.RBGu;
   ...
   }else
   {
        ...
        CAInfo->RGl = AwbPreWhiteElement[Id].RGl;
        CAInfo->RGu = AwbPreWhiteElement[Id].RGu;
        CAInfo->GGl = AWB_Intpl(aLv, AwbPreWhiteElement_night.GGl, AwbPreWhiteElement[Id].GGl, AWB_LV_EVENING_END, AWB_LV_EVENING_START);
        CAInfo->GGu = AWB_Intpl(aLv, AwbPreWhiteElement_night.GGu, AwbPreWhiteElement[Id].GGu, AWB_LV_EVENING_END, AWB_LV_EVENING_START);
        CAInfo->BGl = AwbPreWhiteElement[Id].BGl;
        CAInfo->BGu = AwbPreWhiteElement[Id].BGu;
        CAInfo->RBGl = AwbPreWhiteElement[Id].RBGl;
        CAInfo->RBGu = AwbPreWhiteElement[Id].RBGu;
...
static void AWB_setGain(AWBALG_INFO *Info, UINT32 RG, UINT32 GG, UINT32 BG)
{
    ...
    Info->AWBGain.RGain = (RG>1023)?1023:RG;
    Info->AWBGain.GGain = GG;
    Info->AWBGain.BGain = (BG>1023)?1023:BG;
