...
#define AWB_CT2_7500K_RGAIN 434
#define AWB_CT2_7500K_BGAIN 361

#define AWB_CT2_7000K_RGAIN 455
#define AWB_CT2_7000K_BGAIN 404


#define AWB_CT2_6500K_RGAIN 480
#define AWB_CT2_6500K_BGAIN 454


#define AWB_CT2_6000K_RGAIN 504
#define AWB_CT2_6000K_BGAIN 504

#define AWB_CT2_5500K_RGAIN 452
#define AWB_CT2_5500K_BGAIN 502

#define AWB_CT2_5000K_RGAIN 400
#define AWB_CT2_5000K_BGAIN 500
#define AWB_CT2_4500K_RGAIN 379
#define AWB_CT2_4500K_BGAIN 546
...
#define AWB_CT2_2500K_RGAIN 199
#define AWB_CT2_2500K_BGAIN 924

#define AWB_CT2_2000K_RGAIN 199
#define AWB_CT2_2000K_BGAIN 924
...
AWB_CAINFO AwbPreWhiteElement_night=
    {
        32, 32,
        4095,       //UINT32 RGu; (R/G)<<10
        0,        //UINT32 RGl;
        (255<<4),   //UINT32 GGu; G (12Bits)
        (5<<4),     //UINT32 GGl;
...
AWBALG_ELEMET WhiteIndoorElement_night[] =
{
    ...
    {AWBALG_TYPE_RG,     235,  70, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_BG,     750, 133, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_RBG,    750,  60, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_RBGSUM, 820, 321, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_RXBG,   690, 278, {  0,  0}, {  0,  0}},
    {AWBALG_TAB_END,       0,   0, {  0,  0}, {  0,  0}}
};
...
{
    {AWBALG_TYPE_Y,      (200<<4),   (8<<4), {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_RG,     235, 163, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_BG,     204, 133, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_RBG,    112, 63, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_RBGSUM, 436, 321, {  0,  0}, {  0,  0}},
    {AWBALG_TYPE_RXBG,   430, 278, {  0,  0}, {  0,  0}},
    {AWBALG_TAB_END,       0,   0, {  0,  0}, {  0,  0}}
};
...
AWBALG_TAB AwbWhiteTAB[AWB_PROC_CNT][AWB_MAX_WHITE_TAB] =
{
    ...
    {
        {(10<<5),  (10<<4),  WhiteIndoorElement2,  AWBALG_ENV_InDoor},
