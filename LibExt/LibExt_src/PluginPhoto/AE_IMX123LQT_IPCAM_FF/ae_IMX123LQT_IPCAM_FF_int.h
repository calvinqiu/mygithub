/**
    ...
    @file       ae_IMX123LQT_EVB_FF_int.h
    @ingroup    mISYSAlg
    @note       Nothing (or anything need to be mentioned).

    Copyright   Novatek Microelectronics Corp. 2011.  All rights reserved.
*/
#ifndef _AE_IMX123LQT_IPCAM_FF_INT_H_
#define _AE_IMX123LQT_IPCAM_FF_INT_H_
...
#define AE_COVER_RANGE_H            4                           ///< cover range H
#define AE_COVER_RANGE_L            4                           ///< cover range L
...
//IR CUT PARAM
#define AE_IRCUT_DELAY_CNT          50
#define AE_IRCUT_LV_H               30
#define AE_IRCUT_LV_L               20
