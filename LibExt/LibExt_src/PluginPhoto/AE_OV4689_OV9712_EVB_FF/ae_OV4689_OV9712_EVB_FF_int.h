...
*/
#ifndef _AE_OV4689_OV9712_EVB_FF_INT_H_
#define _AE_OV4689_OV9712_EVB_FF_INT_H_
...
#define AE2_COVER_RANGE_H           8                           ///< cover range H
#define AE2_COVER_RANGE_L           8                           ///< cover range L
...
extern const UINT8 AE_Win_Evaluative[AE_PROC_CNT][AE_WIN_Y][AE_WIN_X];
extern const UINT8 AE_OverExpo_Win_Normal[AE_PROC_CNT][AE_WIN_Y][AE_WIN_X];
