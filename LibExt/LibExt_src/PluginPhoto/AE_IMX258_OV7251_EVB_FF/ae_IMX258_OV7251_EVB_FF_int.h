/**
    ...
    @file       ae_IMX258_OV7251_EVB_FF_int.h
    @ingroup    mISYSAlg
    @note       Nothing (or anything need to be mentioned).

    Copyright   Novatek Microelectronics Corp. 2011.  All rights reserved.
*/
#ifndef _AE_IMX258_OV7251_EVB_FF_INT_H_
#define _AE_IMX258_OV7251_EVB_FF_INT_H_
...
#define AE_NOR_PREDICT_POINT_1     3
#define AE_NOR_PREDICT_POINT_2     1
...
extern const UINT32 AeCurve_Fix_Expt[][AEALG_INFO_MAX];
extern const UINT32 AeCurve_Fix_Gain[][AEALG_INFO_MAX];
...
#endif //_AE_IMX258_OV7251_EVB_FF_INT_H_
