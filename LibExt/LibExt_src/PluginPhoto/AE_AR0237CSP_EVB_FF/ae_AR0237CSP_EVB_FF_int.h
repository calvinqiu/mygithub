/**
    ...
    @file       ae_AR0230CS_EVB_FF_int.h
    @ingroup    mISYSAlg
    @note       Nothing (or anything need to be mentioned).

    Copyright   Novatek Microelectronics Corp. 2011.  All rights reserved.
*/
#ifndef _AE_AR0237CSP_EVB_FF_INT_H_
#define _AE_AR0237CSP_EVB_FF_INT_H_
...
#define AE_COVER_RANGE_H            8//3                           ///< cover range H
#define AE_COVER_RANGE_L            8//3                           ///< cover range L
...
extern UINT32 ExptY_Mov_OverExpoAdj_HDR[AE_PROC_CNT][AEALG_DYNAMIC_EXPECT_LUM_MAX];
extern UINT32 ExptY_Photo_OverExpoAdj[AE_PROC_CNT][AEALG_DYNAMIC_EXPECT_LUM_MAX];
extern UINT32 ExptY_Photo_OverExpoAdj_HDR[AE_PROC_CNT][AEALG_DYNAMIC_EXPECT_LUM_MAX];
...
extern const UINT32 AeCurve_HDR16X_AntiFlicker60[][AEALG_INFO_MAX];
extern const UINT32 AeCurve_HDR8X_AntiFlicker60[][AEALG_INFO_MAX];
extern const UINT32 AeCurve_HDR4X_AntiFlicker60[][AEALG_INFO_MAX];
extern const UINT32 AeCurve_HDR2X_AntiFlicker60[][AEALG_INFO_MAX];
extern const UINT32 AeCurve_HDR1X_AntiFlicker60[][AEALG_INFO_MAX];
