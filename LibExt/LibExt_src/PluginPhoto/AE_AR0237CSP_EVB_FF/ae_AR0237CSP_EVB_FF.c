...
#include "ae_alg.h"
#include "ae_AR0237CSP_EVB_FF_int.h"
#include "ae_task.h"
#include "IPL_Cmd.h"
#include "iqs_api.h"
#include "aeafd_alg.h"
...
void AE_Init (UINT32 Id, UINT32 CurrentStatus)
{
    ...
    IPL_AlgSetUIInfo(Id, IPL_SEL_AEMODE,SEL_AEMODE_EVALUATIVE);
    IPL_AlgSetUIInfo(Id, IPL_SEL_VIDEO_FPS,SEL_VIDEOFPS_30);
...
//vNewAeArg[Id][AEStep[Id]].ExpoTime,
    ...
    if (AEUartMsg == ENABLE || uiAEUartCmd[Id] == ENABLE)
    {
        DBG_DUMP("%d: %3d %3d %3d %8d %8d %3d %3d %3d %3d %3d %3d %3d\r\n", Id, AeInfo[Id].PrvAvgLum.y, AeInfo[Id].CurExpectLum.y, AeInfo[Id].CurLum.y, AeInfo[Id].PrvAvgEV.EVValue, PrvNewAeArg[Id][AEStep[Id]].ExpoTime, PrvNewAeArg[Id][AEStep[Id]].ISOGain, IPL_AlgGetUIInfo(Id, IPL_SEL_WDR), AeInfo[Id].Counter, AeInfo[Id].CounterRF, AEStep[Id],AE_getFlickerType(IPL_AlgGetUIInfo(Id, IPL_SEL_FREQUENCY)),IPL_AlgGetUIInfo(AeInfo->Id, IPL_SEL_VIDEO_FPS));
        //DBG_DUMP("%3d %3d %3d %3d %3d %3d %3d %3d\r\n", AeInfo[Id].PrvAvgEV.EVValue, PrvNewAeArg[Id][AEStep[Id]].ExpoTime, PrvNewAeArg[Id][AEStep[Id]].ISOGain,ISO_NOW, Analog_Gain,Conversion_Gain,Digital_Gain, AE_getWinType(IPL_AlgGetUIInfo(Id, IPL_SEL_AEMODE)));
    }
...
UINT32 AE_getStatisticInfo(AE_INFO *AeInfo, AE_BLK_INFO *AeBlkInfo)
{
...
#if 0
    {
        ...
        //for sensor hdr
        Sensor_GetStatus(IPL_UTI_CONV2_SEN_ID(AeInfo->Id), IPL_AlgGetUIInfo(AeInfo->Id, IPL_SEL_PRVSENMODE), &SenInfo);
        if (SenInfo.Mode->ModeType == SENSOR_MODE_BUILTIN_HDR)
        {
            UINT32 Lum, Lum1;
            SENSOR_CMD Cmd;
            ...
            AeInfo->PrvAvgLum.y = IQS_GetGammaValue(AeInfo->Id, Lum1);
            AeInfo->PrvAvgLum.raw = Lum1;
        }
    }
#endif
    }
...
//    memset((void *)AeInfo, 0, sizeof(AE_INFO));
    ...
    AeInfo->ExtSet.OverExp.UserDefRatio = FALSE;
