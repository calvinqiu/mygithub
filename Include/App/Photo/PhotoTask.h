...
//#NT#2016/02/26#Bowen Li -begin
//#NT#
    PHOTO_ID_DSPH,      ///< photo DSP High priority task
//#NT#2016/02/26#Bowen Li -end
    PHOTO_ID_MAX_NUM,
...
typedef enum
{
    ...
    PHOTO_ISR_SIE_DRAM_OUT3_END,    ///< sie dram out 1
    PHOTO_ISR_SIE_DRAM_OUT4_END,    ///< sie dram out 2
...
/**
   photo hook function ext information list
*/
typedef struct PHOTO_FUNC_INFO2
{
    IPL_PROC_ID Id;
    UINT32 rev[2];
    struct PHOTO_FUNC_INFO2 *pNext;         ///< point next Function Obj, last Function must be set NULL
} PHOTO_FUNC_INFO2;
...
/**
     ...
     @param[in] FuncInfo hook function list
     @param[in, out] BufInfo input/out buffer address/size
     @param[in] FuncInfo2 hook function list

     @return
         - @b E_OK:       command ready
         - @b E_SYS:
*/
extern ER Photo_Open2(PHOTO_FUNC_INFO *FuncInfo, PHOTO_BUF_INFO *BufInfo, PHOTO_FUNC_INFO2 *FuncInfo2);
