...
#include "Debug.h"
//#include "VControl.h"
#include "../../../Include/App/VControl/VControl.h"
...
typedef enum
{
    ...
    NVTEVT_UART_EVT_START       = USER_UART_EVENT_BASE, ///< Min value = 0x110b0000
    NVTEVT_UART_TRANSMIT_BEGIN          = 0x110b0000,	
    NVTEVT_UART_EVT_END       = USER_UART_EVENT_BASE+ 0x1000 -1, ///< Max value = 0x110b0fff  
}
NVT_SYS_EVENT;
