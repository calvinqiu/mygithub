...
#define     SMEDIAREC_EVENT_H264BSCB_P0          MOVREC_EVENT_H264BSCB_P0   ///< path1 video enc ok
...
*/
extern ER SMediaRec_SetVidTBR(UINT32 pathID, UINT32 value);
...
extern void SMediaRec_SetROPercentByFilesavetype(UINT32 percent, UINT32 filesaveStrg);
extern void SMediaRec_2ndPathsaveType(UINT32 filesavetype);
extern void SMediaRec_EnLastQP(UINT32 en);
extern void SMediaRec_SetAACWithHeader(UINT32 value);
