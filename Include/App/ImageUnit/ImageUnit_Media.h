...
#include "movieinterface_def.h" //for media parameters
...
enum
{
    ...
    MEDIA_PARAM_SBS2_TYPE,               // indicate to SBS type (ISF_MEDIA_SEL_SBS).
    MEDIA_PARAM_SBS2_P1,                 // indicate to P1 resolution by SBS view.
    MEDIA_PARAM_SBS2_P2,                 // indicate to P2 resolution by SBS view.
    MEDIA_PARAM_SBS2_P3,                 // indicate to P3 resolution by SBS view.
    MEDIA_PARAM_SBS2_P4,                 // indicate to P4 resolution by SBS view.
};

typedef enum ISF_MEDIA_SEL_SBS
{
    ISF_MEDIA_SEL_SBS_OFF = 0, ///<-normal case, side by side off
    ISF_MEDIA_SEL_SBS_LR, ///<-Left-right side by side
    ISF_MEDIA_SEL_SBS_UD, ///<-up-down side by side
    ISF_MEDIA_SEL_SBS_MAX_CNT,
    ENUM_DUMMY4WORD(ISF_MEDIA_SEL_SBS)
} ISF_MEDIA_SEL_SBS;
