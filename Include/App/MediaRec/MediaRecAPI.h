...
*/
//@{
#define     MEDIAREC_EVENT_RESULT_NORMAL        MOVREC_EVENT_RESULT_NORMAL    ///< Finish normally
#define     MEDIAREC_EVENT_RESULT_HW_ERR        MOVREC_EVENT_RESULT_HW_ERR    ///< Hardware error
#define     MEDIAREC_EVENT_RESULT_FULL          MOVREC_EVENT_RESULT_FULL      ///< Card full
#define     MEDIAREC_EVENT_RESULT_SLOW          MOVREC_EVENT_RESULT_SLOW      ///< Write card too slowly
#define     MEDIAREC_EVENT_RESULT_NOTREADY      MOVREC_EVENT_RESULT_NOTREADY  ///< Not ready
#define     MEDIAREC_EVENT_THRESHOLD            MOVREC_EVENT_THRESHOLD        ///< Threshold meets
#define     MEDIAREC_EVENT_RESULT_OVERTIME      MOVREC_EVENT_RESULT_OVERTIME  ///< Overtime
#define     MEDIAREC_EVENT_RESULT_WRITE_ERR     MOVREC_EVENT_RESULT_WRITE_ERR ///< Filesystem write fails
#define     MEDIAREC_EVENT_STOPPED              MOVREC_EVENT_STOPPED          ///< Callback when stops totally
#define     MEDIAREC_EVENT_FILECOMPLETE         MOVREC_EVENT_FILECOMPLETE     ///< Write file completely
#define     MEDIAREC_EVENT_RESULT_CUT_FAIL      MOVREC_EVENT_RESULT_CUT_FAIL  ///< Cut, overlap fail (write slowly)
#define     MEDIAREC_EVENT_CUSTOM_UDATA         MOVREC_EVENT_CUSTOM_UDATA     ///< Set customized user data
#define     MEDIAREC_EVENT_ENCONE_OK            MOVREC_EVENT_ENCONE_OK        ///< enc one frame

#define     MEDIAREC_EVENT_H264BSCB_P0          MOVREC_EVENT_H264BSCB_P0      ///< path1 video enc ok
#define     MEDIAREC_EVENT_H264BSCB_P1          MOVREC_EVENT_H264BSCB_P1      ///< path2 video enc ok
#define     MEDIAREC_EVENT_RESULT_FLASHSTOP     MOVREC_EVENT_RESULT_FLASHSTOP ///< 30 sec after flash stop
#define     MEDIAREC_EVENT_AUDBSCB              MOVREC_EVENT_AUDBSCB          ///< audio enc ok
#define     MEDIAREC_EVENT_LOOPREC_FULL         MOVREC_EVENT_LOOPREC_FULL     ///< no space for seamless recording
#define     MEDIAREC_EVENT_START                MOVREC_EVENT_START            ///< start recording
#define     MEDIAREC_EVENT_TIMELAPSE_ONESHOT    MOVREC_EVENT_TIMELAPSE_ONESHOT///< timelapse oneshot
#define     MEDIAREC_EVENT_SLOWSTART            MOVREC_EVENT_SLOWSTART        ///< slow stop begins
//@}
...
*/
//@{
#define     MEDIAREC_IMMPROC_CUTFILE_END        MOVREC_IMMPROC_CUTFILE_END  ///< end of one cut file, no parameter
#define     MEDIAREC_IMMPROC_DELETE_FILE        MOVREC_IMMPROC_DELETE_FILE///< end of deleting file, p1: directory ID, p2: file ID
#define     MEDIAREC_IMMPROC_ENC_SETTING        MOVREC_IMMPROC_ENC_SETTING///< special encoding parameters setting, such as H.264 3DNR
//@}
...
*/
//@{
#define MEDIAREC_JPEG_FORMAT_420    MOVREC_JPEG_FORMAT_420  ///< Y:Cb:Cr = 4:1:1
#define MEDIAREC_JPEG_FORMAT_422    MOVREC_JPEG_FORMAT_422  ///< Y:Cb:Cr = 2:1:1
#define MEDIAREC_JPEG_FORMAT_444    MOVREC_JPEG_FORMAT_444  ///< Y:Cb:Cr = 1:1:1
#define MEDIAREC_JPEG_FORMAT_100    MOVREC_JPEG_FORMAT_100///< Y:Cb:Cr = 4:1:1
//@}
...
*/
//@{
#define MEDIAREC_COUNTTYPE_FS    MOVREC_COUNTTYPE_FS  ///< get freespace in storage
#define MEDIAREC_COUNTTYPE_4G    MOVREC_COUNTTYPE_4G  ///< using 4G to calculate
#define MEDIAREC_COUNTTYPE_USER  MOVREC_COUNTTYPE_USER  ///< using given size to calculate
//@}
...
*/
//@{
#define MEDIAREC_ENDTYPE_NORMAL             MOVREC_ENDTYPE_NORMAL ///< normal end, such as press key to stop recording
#define MEDIAREC_ENDTYPE_CUTOVERLAP         MOVREC_ENDTYPE_CUTOVERLAP///< cut file and continue recording automatically; overlap the old files (cyclic recording)
#define MEDIAREC_ENDTYPE_CUT_TILLCARDFULL   MOVREC_ENDTYPE_CUT_TILLCARDFULL///< cut file and continue recording automatically till card full
#define MEDIAREC_ENDTYPE_MAX                MOVREC_ENDTYPE_MAX ///< maximum number of recording end type
//@}
...
*/
//@{
#define MEDIAREC_SRC_NORMAL         MOVREC_SRC_NORMAL     ///< normal source (video: sensor, audio: mic-in)
#define MEDIAREC_SRC_FIXED_YUV      MOVREC_SRC_FIXED_YUV  ///< fixed YUV pattern (for video)
#define MEDIAREC_SRC_BS_ONLY        MOVREC_SRC_BS_ONLY    ///< bitstream only (for video)
#define MEDIAREC_SRC_FIXED_PCM      MOVREC_SRC_FIXED_PCM  ///< fixed PCM pattern (for audio)
//@}
...
*/
//@{
#define MEDIAREC_IPLCHG_PREVIEW     MOVREC_IPLCHG_PREVIEW   ///< Set IPL to preview mode
#define MEDIAREC_IPLCHG_VIDEO       MOVREC_IPLCHG_VIDEO     ///< Set IPL to video mode
//@}
...
*/
//@{
#define MEDIAREC_IPLGET_READYBUF    MOVREC_IPLGET_READYBUF   ///< Get IPL ready buffer
//@}
...
*/
//@{
#define     MEDIAREC_GETINFO_WIDTH_HEIGHT   MOVREC_GETINFO_WIDTH_HEIGHT     ///< p1: width (out), p2: height (out)
#define     MEDIAREC_GETINFO_VIDEO_CODEC    MOVREC_GETINFO_VIDEO_CODEC      ///< p1: videocodec type(out), MEDIAREC_ENC_JPG or others//2012/10/15 Meg
#define     MEDIAREC_GETINFO_AUDIO_SR       MOVREC_GETINFO_AUDIO_SR         ///< p1: audio samplerate(out), AUDIO_SR_32000 or others//2013/01/11 Meg
#define     MEDIAREC_GETINFO_AUDIO_CHS      MOVREC_GETINFO_AUDIO_CHS        ///< p1: audio channels(out), 1 or 2//2013/01/11 Meg
#define     MEDIAREC_GETINFO_AUDIO_BITS     MOVREC_GETINFO_AUDIO_BITS       ///< p1: audio bits per sample, 16
#define     MEDIAREC_GETINFO_H264_SPS       MOVREC_GETINFO_H264_SPS         ///< p1: addr (out), p2: size (out), p3: num(0 or 1)
#define     MEDIAREC_GETINFO_VIDEO_FPS      MOVREC_GETINFO_VIDEO_FPS        ///< p1: v fps (out)
#define     MEDIAREC_GETINFO_WIDTH_HEIGHT_P2 MOVREC_GETINFO_WIDTH_HEIGHT_P2 ///< p1: width of Path2 (out), p2: height of Path2(out)
#define     MEDIAREC_GETINFO_AUDIO_CODEC    MOVREC_GETINFO_AUDIO_CODEC      ///< p1: audio codec type of 1stpath(out), MEDIAREC_ENC_PCM or others
#define     MEDIAREC_GETINFO_SEAMLESSSEC    MOVREC_GETINFO_SEAMLESSSEC      ///< p1: seamless Sec(out),
#define     MEDIAREC_GETINFO_RECFORMAT      MOVREC_GETINFO_RECFORMAT        ///< p1: recformat of 1stpath(out), MEDIAREC_AUD_VID_BOTH or others
//@}
...
*/
//@{
#define     MEDIAREC_AUDTYPE_LEFT   MOVREC_AUDTYPE_LEFT     ///< left
#define     MEDIAREC_AUDTYPE_RIGHT  MOVREC_AUDTYPE_RIGHT    ///< right
#define     MEDIAREC_AUDTYPE_STEREO MOVREC_AUDTYPE_STEREO   ///< stereo
#define     MEDIAREC_AUDTYPE_MONO   MOVREC_AUDTYPE_MONO     ///< mono
//@}
...
*/
//@{
#define     MEDIAREC_MOV_ROTATE_0       MOVREC_MOV_ROTATE_0     ///< angle 0
#define     MEDIAREC_MOV_ROTATE_90      MOVREC_MOV_ROTATE_90    ///< angle 90
#define     MEDIAREC_MOV_ROTATE_180     MOVREC_MOV_ROTATE_180   ///< angle 180
#define     MEDIAREC_MOV_ROTATE_270     MOVREC_MOV_ROTATE_270   ///< angle 270
//@}
//#NT#2013/04/17#Calvin Chang -end
