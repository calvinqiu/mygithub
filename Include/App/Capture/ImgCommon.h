...
extern UINT32 Cap_DecodeSensorIDInfo(UINT32 ID_Code, UINT32 *ID_Array);
extern BOOL Cap_ShowDebugMsg(void);
extern void Cap_SetDebugMsgEn(BOOL Enable);
