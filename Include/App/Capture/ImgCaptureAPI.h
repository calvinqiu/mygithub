...
*/
//@{
typedef INT32 (*IMG_CAP_FSYS_FP2)(UINT32 Addr, UINT32 Size, UINT32 Fmt, INT32 SensorID);
//@}
...
typedef struct _CAP_OBJ_INFO
{
    ...
    IMG_CAP_FSYS_FP2 WriteFileFP_ID;         ///< write file function pointer with sensor ID
} CAP_OBJ_INFO;
