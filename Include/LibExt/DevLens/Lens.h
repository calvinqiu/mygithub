...
typedef enum
{
    ...
    LENS_STATE_IRCUTMOVING,         ///< Lens is in IRCUTMOVING state
...
typedef enum
{
    ...
    //IRCUT
    LENS_CB_IRCUT_START,            ///< Callback to notify IRCUT starts moving
...
/**
     ...
     @param[in] FocalLength             Focal length in um unit
*/
extern void       Lens_Focus_SetFocalLength_um(UINT32 ZoomSection, UINT32 FocalLength);
...
/**
     ...
     @param[in] state     IRCUT segment to be switched       IRCUT_POS_CLOSE to IRCUT_POS_OPEN.

     @return Description of data returned.
         - @b INT32: ERR_OPERATION_FAIL or ERR_OK.
*/
extern INT32      Lens_IRCUT_Move(IRCUT_POS Position);
