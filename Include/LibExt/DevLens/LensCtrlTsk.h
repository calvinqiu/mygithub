...
typedef struct
{
    ...
    MOTOR_IRCUT_ACT        IRCUTState;           ///< IRCUT state
    UINT32                 uiIRCUTParam1;        ///< Parameter used to set IRCUT state
...
/**
    ...
    @param[in] signal MOTOR_IRCUT_OPEN.             ///< Open IRCUT.
                      MOTOR_IRCUT_CLOSE,            ///< Close IRCUT.
