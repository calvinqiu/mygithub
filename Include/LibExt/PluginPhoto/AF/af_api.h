...
/**
     ...
     @return Description of data returned.
         - @b void.
*/
extern void AF_Init(UINT32 id, UINT32 CurrentStatus);
...
/**
     ...
     @return
         - @b void.
*/
extern void AF_Process(UINT32 id, UINT32 CurrentStatus);
...
/**
     ...
     @return
         - @b void.
*/
extern void AF_GetVA_Result(UINT32 *G1H, UINT32 *G1V, UINT32 *G2H, UINT32 *G2V, UINT32 id, VA_WINIDX WinIdx);
...
/**
     ...
     @return
         - @b void.
*/
extern void AF_SetVAparam2IPL(UINT32 id);
...
extern INT32 AF_SearchFullRange(UINT32 id, INT16 startIdx, INT16 endIdx, UINT8 jumpStep, UINT32 *pMaxVA);
...
extern void AF_SetVA_Crop(VACROP win_info);
extern void AF_VA_Release(UINT32 id);
//@}
#endif
