...
#define FDE_INTE_ALL                    0x0000000D  ///< all interrupts
...
*/
//@{
#define FACE_NUM_MAX                    64 //36          ///< max detection number
//@}
...
\n  FD_RSLT_ORI:    {Score1[31..25] Target[24..22] Size[21..16] Sty[15..8] Stx[7..0]}
...
typedef struct
{
    ...
    FDE_TGTSTAT *pTgtStat1;   ///< target 0 statistics
    FDE_TGTSTAT *pTgtStat2;   ///< target 0 statistics
    FDE_TGTSTAT *pTgtStat3;   ///< target 0 statistics
    FDE_TGTSTAT *pTgtStat4;   ///< target 0 statistics
...
extern UINT32   fde_getScaleFactor(FDE_SCLFAC *pFactor);
