...
typedef enum
{
    ...
    GRPH_AOP_ALPHA_SWITCH,      //0x14        ///< (B < 128) ? A : C  -> destination (Not support by NT96660)
    GRPH_AOP_HWORD_TO_BYTE,     //0x15        ///< ( A[15..0] >> SHF ) -> C[7..0] (Not support by NT96660)
...
typedef enum
{
    ...
    GRPH_CMD_VTC_FLIP,                      ///< Vertical flip
                                            ...
                                            ///< - Source image: GRPH_IMG_ID_A
                                            ///< - Destination image: GRPH_IMG_ID_C
    GRPH_CMD_HRZ_CFLT,                      ///< Horizontal chroma filter. (Not support by NT96660)
    GRPH_CMD_VTC_CFLT,                      ///< Vertical chroma filter. (Not support by NT96660)
    GRPH_CMD_WARP,                          ///< Image Warping (Not support by NT96660)
    GRPH_CMD_GOPMAX,                        //< Max GOP count

    // AOP
    GRPH_CMD_A_COPY = 0x10000,              ///< A -> destination
                                            ///< - (GRPH_ID_1, GRPH_ID_2)
                                            ///< - Format: GRPH_FORMAT_8BITS, GRPH_FORMAT_32BITS_ARGB8888_RGB, GRPH_FORMAT_32BITS_ARGB8888_A
                                            ///< - GRPH_ID_1: GRPH_FORMAT_8BITS, GRPH_FORMAT_32BITS_ARGB8888_RGB, GRPH_FORMAT_32BITS_ARGB8888_A
    ...
    GRPH_CMD_COLOR_EQ,                      ///< (B == KEY) ? A:B -> destination with color key (=)
                                            ///< - (GRPH_ID_1 only)
                                            ///< - Format: GRPH_FORMAT_8BITS, GRPH_FORMAT_16BITS, GRPH_FORMAT_16BITS_UVPACK, GRPH_FORMAT_16BITS_UVPACK_U, GRPH_FORMAT_16BITS_UVPACK_V, GRPH_FORMAT_32BITS_ARGB8888_RGB
                                            ///< - Source image A: GRPH_IMG_ID_A
                                            ///< - Source image B: GRPH_IMG_ID_B
                                            ///< - Destination image: GRPH_IMG_ID_C
    ...
    GRPH_CMD_TEXT_COPY,                     ///< text -> destination
                                            ///< - (GRPH_ID_1, GRPH_ID_2)
                                            ///< - Format:
                                            ///< - GRPH_ID_1: GRPH_FORMAT_8BITS, GRPH_FORMAT_16BITS_UVPACK, GRPH_FORMAT_16BITS_UVPACK_U, GRPH_FORMAT_16BITS_UVPACK_V, GRPH_FORMAT_32BITS_ARGB8888_RGB, GRPH_FORMAT_32BITS_ARGB8888_A
                                            ///< - GRPH_ID_2: GRPH_FORMAT_8BITS
                                            ///< - Destination image: GRPH_IMG_ID_C
    ...
    GRPH_CMD_BLENDING,                      ///< ((A * WA) + (B * WB) + 128) >> 8 -> destination
                                            ///< - (GRPH_ID_1 only)
                                            ///< - Format: GRPH_FORMAT_8BITS, GRPH_FORMAT_16BITS_UVPACK, GRPH_FORMAT_16BITS_UVPACK_U, GRPH_FORMAT_16BITS_UVPACK_V, GRPH_FORMAT_16BITS_RGB565, GRPH_FORMAT_32BITS_ARGB8888_RGB
                                            ///< - Source image A: GRPH_IMG_ID_A
                                            ///< - Source image B: GRPH_IMG_ID_B
                                            ///< - Destination image: GRPH_IMG_ID_C
    ...
    GRPH_CMD_TEXT_MUL,                      ///< (A*text + 1<<(SHF-1)) >> SHF -> destination
                                            ///< - (GRPH_ID_1 only)
                                            ///< - Format: GRPH_FORMAT_8BITS, GRPH_FORMAT_16BITS_UVPACK, GRPH_FORMAT_16BITS_UVPACK_U, GRPH_FORMAT_16BITS_UVPACK_V, GRPH_FORMAT_32BITS_ARGB8888_RGB, GRPH_FORMAT_32BITS_ARGB8888_A
                                            ///< - Source image A: GRPH_IMG_ID_A
                                            ///< - Source image B: GRPH_IMG_ID_B
                                            ///< - Destination image: GRPH_IMG_ID_C
    ...
    GRPH_CMD_ALPHA_SWITCH,                  ///< (B < 128) ? A : C  -> destination (Not support by NT96660)
                                            ///< - Format: GRPH_FORMAT_8BITS, GRPH_FORMAT_16BITS_UVPACK, GRPH_FORMAT_16BITS_UVPACK_U, GRPH_FORMAT_16BITS_UVPACK_V
                                            ///< - Source image A: GRPH_IMG_ID_A
                                            ///< - Source image B: GRPH_IMG_ID_B
                                            ///< - Source image C: GRPH_IMG_ID_C
                                            ///< - Destination image: GRPH_IMG_ID_C
                                            ///< - Property: GRPH_ALPHA_CONST() | GRPH_COLOR_CONST() | GRPH_ENABLE_ALPHA_FROM_A | GRPH_ENABLE_ALPHA_FROM_C
    GRPH_CMD_HWORD_TO_BYTE,                 ///< ( A[15..0] >> SHF ) -> C[7..0] (Not support by NT96660)
                                            ///< - Format: GRPH_FORMAT_16BITS
                                            ///< - Source image A: GRPH_IMG_ID_A
                                            ///< - Destination image: GRPH_IMG_ID_C
...
/**
    ...
    - (OBSOLETE) Byte Mode: C[7..0] = A*Text[11..4] >> SHF[3..0]
...
*/
//@{
#define GRPH_TEXTMUL_BYTE         0x00000000    ///< (OBSOLETE) Byte Mode. (Exclusive use with GRPH_TEXTMUL_HWORD)
