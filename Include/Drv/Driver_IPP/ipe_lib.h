...
typedef enum
{
    IPE_ORIGINAL = 0,           ///< original size
    IPE_SUBOUT = 1,             ///< subsampled out
    IPE_DIRECTION = 2,          ///< edge direction
...
typedef enum
{
    CCRANGE_2_8 = 0,    ///< Precision 2.8
    CCRANGE_3_7 = 1,    ///< Precision 3.7
...
typedef struct
{
    ...
    UINT32 uiOfsSub0;
    UINT32 uiOfsSub1;
    IPE_INOUT_FORMAT Omat;
    IPE_HSUB_SEL_ENUM SubHSel;
} IPE_SUB_PARAM;
//@}

/**
    IPE structure - IPE SUB direct to IFE2.
*/
//@{
typedef struct
{
    ...
    UINT32 uiOutSizeH;
    UINT32 uiOutSizeV;
    IPE_ENABLE DirIfe2En;
} IPE_DIRIFE2_PARAM;
//@}


/**
    IPE structure - IPE Gamma.
*/
//@{
typedef struct
{
    UINT32 uiGammaAddr;
    IPE_GAMYRAND *pGamYcurRand;
} IPE_GAMMA_PARAM;
//@}
