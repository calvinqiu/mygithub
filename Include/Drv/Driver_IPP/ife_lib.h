...
#define IFE_FUNC_ALL                    0x0023F000  ///< all func enable mask
//@}
...
#define IFE_INTE_ALL                    0x00000005  ///< all interrupts
//@}
...
#define IFE_INT_ALL                    0x00000005  ///< all interrupts
//@}
...
typedef enum
{
    ...
    IFE_BURST_16W    = 3,       ///< burst length 16 word
...
typedef struct _IFE_CGAINSET
{
    BOOL        bCgainInv;
    BOOL        bCgainHinv;
    IFE_CGRANGE CgainRange;			///< no need, driver auto calculate
    UINT32      uiCgainMask;
    UINT32      *puiCGain;          ///< Color Gain, 0~2046/256,always R/Gr/Gb/B order
...
{
    INT32 iVigXR;        ///< Legal range : -8192~8191,VIG x center of R
    INT32 iVigYR;        ///< Legal range : -8192~8191,VIG y center of R
    INT32 iVigXG;        ///< Legal range : -8192~8191,VIG x center of G
    INT32 iVigYG;        ///< Legal range : -8192~8191,VIG y center of G
    INT32 iVigXB;        ///< Legal range : -8192~8191,VIG x center of B
    INT32 iVigYB;        ///< Legal range : -8192~8191,VIG y center of B
    ...
    UINT32 *puiVigLutR;  ///< Legal range : 0~1023,VIG LUT of R channel
    UINT32 *puiVigLutG;  ///< Legal range : 0~1023,VIG LUT of G channel
    UINT32 *puiVigLutB;  ///< Legal range : 0~1023,VIG LUT of B channel
} IFE_VIG_PARAM;
//@}
