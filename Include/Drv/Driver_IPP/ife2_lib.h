...
{    
    ...
    IFE2_OPMODE_IPP     = 1,    ///< IFE->DCE->IPE->IME(IFE2)
    IFE2_OPMODE_RDE_IPP = 2,    ///< RDE + IFE->DCE->IPE->IME(IFE2)
    IFE2_OPMODE_RHE_IPP = 3,    ///< RDE + IFE->DCE->IPE->IME(IFE2)
    IFE2_OPMODE_SIE_IPP = 4,    ///< SIE + IFE->DCE->IPE->IME(IFE2) (all direct)
    IFE2_OPMODE_UNKNOWN = 5,    ///< Undefined mode
...
typedef enum
{
    ...
    IFE2_DMAHDL_OUT1  = 2,  ///< selection output DMA channel1
...
typedef struct _IFE2_LINEOFFSET
{
    ...
    UINT32 uiLineoffsetC;  ///< lineoffset for UV channels
} IFE2_LINEOFFSET;
//------------------------------------------------------------------
...
typedef struct _IFE2_DMA_ADDR
{
    ...
    UINT32 uiAddrC;  ///< lineoffset for UV channels
} IFE2_DMA_ADDR;
//------------------------------------------------------------------
...
typedef struct _IFE2_BURST_LENGHT
{
    ...
    IFE2_BURST_SEL  BurstLenOutput;      ///< engine output burst lenght
} IFE2_BURST_LENGHT;
...
typedef struct _IFE2_PARAM
{
    ...
    IFE2_ADDR_PARAM         OutAddr1;       ///< output dma address for set1


    IFE2_FUNC_EN            OutPPBEn;       ///< output ping-pong buffer enable
    ...
    IFE2_BURST_LENGHT       BurstSize;      ///< engine burst length
...
/**
  Disable IFE2 Interrupt Enable

  @param[in] uiIntrp disable corresponding interrupt
...
/**
  Enable IFE2 Interrupt Enable

  @param[in] uiIntrp enable corresponding interrupt
...
/**
  Get IFE2 Get Output Ping-Pong Buffer ID

  @param[in] VOID

  @return UINT32 ID value
*/
extern UINT32 ife2_getOutputPPBID(VOID);
//------------------------------------------------------------------
