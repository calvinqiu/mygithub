...
typedef struct _MDS_DIM
{
    ...
    UINT8 uiMdsNum;        ///< MDS number in layer 1
    UINT8  uiMdsL2Num;     ///< MDS number in layer 2
    UPOINT upMdsL1StartPt; ///< starting point of MDS layer 1
    UPOINT upMdsL2StartPt; ///< starting point of MDS layer 2
} MDS_DIM;
//@}
...
extern VOID     dis_getMotionVectorsL2(MOTION_INFOR *pMotResult);
extern VOID     dis_getMotionVectorsAll(MOTION_INFOR *pMotResult);
//get status
