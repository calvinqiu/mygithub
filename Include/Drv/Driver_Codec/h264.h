...
typedef enum
{
    H264_HW_ACTION_OPEN  = 0,
    H264_HW_ACTION_SET   = 1,
    H264_HW_ACTION_LOAD  = 2,
    H264_HW_ACTION_START = 3,
...
typedef struct _H264PicUnit{
    ...
    UINT32 uiVirBsdmaCmdBufAddr[2][4];
    UINT32 uiHwBsAddr[2][4];
    H264YuvAddr eSrcYuvAddr[2][4];
...
extern void         h264_setEncPicReg(H264RegSet *pH264RegSet,UINT32 uiEncNum,H264_HW_ACTION action,
                        UINT32 uiPrepareIdx,UINT32 uiActiveIdx);
extern void         h264_DoAgain(UINT32 uiEncNum);
extern UINT32       h264_exit_isr(void);
// Decode //
extern void         h264_setDecInitReg(H264RegSet *pH264RegSet);
extern void         h264_setDecPicReg(H264RegSet *pH264RegSet,UINT32 uiDecNum, H264_HW_ACTION action, UINT32 uiPrepareIdx,UINT32 uiActiveIdx, UINT32 uiSetBsdma);
...
extern UINT32       h264_getSeq0SrcCheckSum0(void);
extern UINT32       h264_getSeq0SrcCheckSum1(void);
extern UINT32       h264_getDataBurst(void);
extern void         h264_setDirectPath(UINT32 uiEnable);
extern void         H264PrtMem(UINT32 uiMemAddr,UINT32 uiMemLen);
extern void         H264PrtReg(void);
