...
typedef enum
{
    ...
    ADC_CHANNEL_YP,         ///< (OBSOLETE) ADC channel YP
    ADC_CHANNEL_XM,         ///< (OBSOLETE) ADC channel XM
...
typedef enum
{
    ...
    ADC_INTERRUPT_READY_CH4 = 0x00000010,       ///< ADC Channel 4 Data Ready
    ADC_INTERRUPT_READY_CH5 = 0x00000020,       ///< ADC Channel 5 Data Ready
    ADC_INTERRUPT_READY_CH6 = 0x00000040,       ///< ADC Channel 6 Data Ready
    ADC_INTERRUPT_READY_CH7 = 0x00000080,       ///< ADC Channel 7 Data Ready

    ADC_INTERRUPT_VALTRIG_1 = 0x02000000,       ///< ADC Channel 1 Value Trigger Hit
    ADC_INTERRUPT_VALTRIG_2 = 0x04000000,       ///< ADC Channel 2 Value Trigger Hit
    ADC_INTERRUPT_VALTRIG_6 = 0x40000000,       ///< ADC Channel 6 Value Trigger Hit
...
typedef enum
{
    ADC_WAKEUP_SRC_ADCCH_1      = 0x02000000,   ///< Set ADC Wakeup CPU condition as ADC_CHANNEL_1 Value Trigger Interrupt
    ADC_WAKEUP_SRC_ADCCH_2      = 0x04000000,   ///< Set ADC Wakeup CPU condition as ADC_CHANNEL_2 Value Trigger Interrupt
    ADC_WAKEUP_SRC_ADCCH_6      = 0x40000000,   ///< Set ADC Wakeup CPU condition as ADC_CHANNEL_2 Value Trigger Interrupt
    ADC_WAKEUP_SRC_TP_PENDOWN   = 0x00004000,   ///< Set ADC Wakeup CPU condition as Touch Panel Pen-Down interrupt
    ADC_WAKEUP_SRC_TP_PENUP     = 0x00008000,   ///< Set ADC Wakeup CPU condition as Touch Panel Pen-Up interrupt

    ADC_WAKEUP_SRC_MASK         = 0x4600C000,
