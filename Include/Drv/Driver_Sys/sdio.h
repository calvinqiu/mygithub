...
#define SDIO_SRC_CLK_60MHZ      4   ///< Source clock 60Mhz
#define SDIO_SRC_CLK_80MHZ      5   ///< Source clock 80Mhz
...
#define SDIO_SRC_CLK_96MHZ     11   ///< Source clock 96Mhz
...
typedef enum
{
    ...
    SDIO_CONFIG_ID_SRCLK,                   ///< Set source clock for SDIO host
                                            ...
                                            ///< - @b SDIO_SRC_CLK_80MHZ
                                            ///< - @b SDIO_SRC_CLK_96MHZ (Default value)
                                            ///< - @b SDIO_SRC_CLK_PLL4
...
typedef struct
{
    ...
    UINT32          uiSpeedGrade;           ///< SD/MMC speed grade. (0:<10MB, 1: >=10MB)
