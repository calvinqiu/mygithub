...
#define TOP_SPI_SDIO3_2_SWITCH  (0)
...
#if (TOP_SPI_SDIO3_2_SWITCH)                                    
    PIN_SDIO_CFG_SWITCHING = 0x100,
#endif    
...
typedef enum
{
    ...
    PIN_SENSOR_CFG_LOCKN = 0x2000000,    ///< Enable LOCKN on CBCS2 (P_GPIO[23])
...
typedef enum
{
    ...
    PIN_SENSOR2_CFG_CCIR8BITS = 0x08,   ///< CCIR 8 bits sensor. Enable CCIR_YC[0..7]/CCIR_VD/CCIR_HD/CCIR_CLK on HSI_D[5..9]N/HSI_D[5..9]P/SN_DGPIO[4] (S_GPI[12..21]/SN_GPIO[4])
    PIN_SENSOR2_CFG_CCIR16BITS = 0x10,  ///< CCIR 16 bits sensor. Enable CCIR_Y[0..7]/CCIR_C[0..7]/CCIR_VD/CCIR_HD/CCIR_CLK on HSI_D[2..9]N/HSI_D[2..9]P/SN_DGPIO[4] (S_GPI[4..21]/SN_GPIO[4]).
    ...
    PIN_SENSOR2_CFG_CCIR_NOFIELD = 0x4000,  ///< CCIR sensor without field.
...
typedef enum
{
    ...
    PIN_SENSOR3_CFG_8BITS = 0x08,       ///< 8 bits sensor. Enable SIE3[0..7]/SIE3_PXCEL/SIE3_VD/SIE3_HD on P_GPIO[0..10]

    PIN_SENSOR3_CFG_MCLK2 = 0x10,       ///< Enable SN_MCLK2 on SBCS0 (S_GPIO[4])
...
typedef enum
{
    ...
    PIN_SENSOR4_CFG_8BITS = 0x08,       ///< 8 bits sensor. Enable SIE4_PXCEL/SIE4[0..7]/SIE4_VD/SIE4_HD on P_GPIO[11..19]/P_GPIO39/P_GPIO40

    PIN_SENSOR4_CFG_MCLK2 = 0x10,       ///< Enable SN_MCLK2 on SBCS0 (S_GPIO[4])
...
{
    PIN_I2C_CFG_NONE,
    PIN_I2C_CFG_CH1 = 0x01,             ///< Enable channel 1. Enable I2C_SDA/I2C_SCL (P_GPIO[21..22])
    PIN_I2C_CFG_CH1_2ND_PINMUX = 0x02,  ///< Enable 2nd pinmux of channel 1. Enable I2C_SCL/I2C_SDA on SBCK0/SBDAT0 (S_GPIO[5..6])
    PIN_I2C_CFG_CH2 = 0x10,             ///< Enable channel 2. Enable DDC_SDA/DDC_SCL (P_GPIO[44..45])
    PIN_I2C_CFG_CH2_2ND_PINMUX = 0x20,  ///< Enable 2nd pinmux of channel 2. Enable I2C2_SDA/I2C2_SCL on SGPIO[9..10] (S_GPIO[9..10])
...
typedef enum
{
    ...
    PIN_SIF_CFG_CH0 = 0x01,             ///< Enable SIF channel 0. Enable SN_CS/SN_SCK/SN_DAT (S_GPIO[4..6])

    PIN_SIF_CFG_CH1 = 0x02,             ///< Enable SIF channel 1. Enable LCD_CS/LCD_CK/LCD_DAT (P_GPIO[28..30])
    PIN_SIF_CFG_CH1_2ND_PINMUX = 0x04,  ///< Backward compatible

    PIN_SIF_CFG_CH2 = 0x08,             ///< Enable SIF channel 2. Enable SB_CS2/SB_CK23/SB_DAT23 (P_GPIO[23]/P_GPIO[25..26])

    PIN_SIF_CFG_CH3 = 0x10,             ///< Enable SIF channel 3. Enable SB_CS3/SB_CK23/SB_DAT23 (P_GPIO[24..26])

    PIN_SIF_CFG_CH4 = 0x20,             ///< Enable SIF channel 4. Enable SB_CS4/SB_CK45/SB_DAT45 (P_GPIO[27]/P_GPIO[29..30])

    PIN_SIF_CFG_CH5 = 0x40,             ///< Enable SIF channel 5. Enable SB_CS5/SB_CK45/SB_DAT45 (P_GPIO[28..30])
