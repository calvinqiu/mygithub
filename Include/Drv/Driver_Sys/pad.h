...
#define PAD_PIN_PGPIO20         (PAD_PIN_PGPIO_BASE + 20)     ///< PGPIO20 (Double bonding)
...
#define PAD_PIN_PGPIO39         (PAD_PIN_PGPIO_BASE + 39)     ///< PGPIO39 (Double bonding)
...
#define PAD_DS_CGPIO2          ((PAD_DS_CGPIO_BASE + 2) | PAD_DS_GROUP5_20)      ///< CGPIO2
...
#define PAD_DS_CGPIO28         ((PAD_DS_CGPIO_BASE + 28) | PAD_DS_GROUP5_20)     ///< CGPIO28
...
#define PAD_DS_SGPIO0          ((PAD_DS_SGPIO_BASE + 0) | PAD_DS_GROUP5_20)     ///< SGPIO0
#define PAD_DS_SGPIO1          ((PAD_DS_SGPIO_BASE + 1) | PAD_DS_GROUP5_20)     ///< SGPIO1
#define PAD_DS_SGPIO2          (PAD_DS_SGPIO_BASE + 2)      ///< SGPIO2
#define PAD_DS_SGPIO3          (PAD_DS_SGPIO_BASE + 3)      ///< SGPIO3
#define PAD_DS_SGPIO4          ((PAD_DS_SGPIO_BASE + 4) | PAD_DS_GROUP5_20)     ///< SGPIO4
#define PAD_DS_SGPIO5          (PAD_DS_SGPIO_BASE + 5)      ///< SGPIO5
#define PAD_DS_SGPIO6          (PAD_DS_SGPIO_BASE + 5)      ///< SGPIO6
#define PAD_DS_SGPIO7          (PAD_DS_SGPIO_BASE + 5)      ///< SGPIO7
#define PAD_DS_SGPIO8          (PAD_DS_SGPIO_BASE + 5)      ///< SGPIO8
#define PAD_DS_SGPIO9          (PAD_DS_SGPIO_BASE + 5)      ///< SGPIO9
#define PAD_DS_SGPIO10         (PAD_DS_SGPIO_BASE + 5)      ///< SGPIO10
...
#define PAD_DS_PGPIO20         ((PAD_DS_PGPIO_BASE + 20) | PAD_DS_GROUP5_40)     ///< PGPIO20
...
#define PAD_DS_PGPIO39         ((PAD_DS_PGPIO_BASE + 39) | PAD_DS_GROUP5_40)     ///< PGPIO39
...
#define PAD_DS_LGPIO8          ((PAD_DS_LGPIO_BASE + 8) | PAD_DS_GROUP5_20)      ///< LGPIO8
...
#define PAD_DS_LGPIO20         ((PAD_DS_LGPIO_BASE + 20) | PAD_DS_GROUP5_20)     ///< LGPIO20
...
#define PAD_DS_LGPIO28         (PAD_DS_LGPIO_BASE + 28)     ///< LGPIO28
#define PAD_DS_LGPIO29         (PAD_DS_LGPIO_BASE + 29)     ///< LGPIO29
#define PAD_DS_LGPIO30         (PAD_DS_LGPIO_BASE + 30)     ///< LGPIO30
...
#define PAD_DS_DGPIO4          ((PAD_DS_DGPIO_BASE + 4) | PAD_DS_GROUP5_20)     ///< DGPIO4
#define PAD_DS_DGPIO5          ((PAD_DS_DGPIO_BASE + 5) | PAD_DS_GROUP5_20)     ///< DGPIO5
#define PAD_DS_DGPIO6          ((PAD_DS_DGPIO_BASE + 6) | PAD_DS_GROUP5_20)     ///< DGPIO6
#define PAD_DS_DGPIO7          ((PAD_DS_DGPIO_BASE + 7) | PAD_DS_GROUP5_20)     ///< DGPIO7
#define PAD_DS_DGPIO8          ((PAD_DS_DGPIO_BASE + 8) | PAD_DS_GROUP5_20)     ///< DGPIO8
#define PAD_DS_DGPIO9          ((PAD_DS_DGPIO_BASE + 9) | PAD_DS_GROUP5_20)     ///< DGPIO9
#define PAD_DS_DGPIO10         ((PAD_DS_DGPIO_BASE + 10) | PAD_DS_GROUP5_20)    ///< DGPIO10
#define PAD_DS_DGPIO11         (PAD_DS_DGPIO_BASE + 11)     ///< DGPIO11
#define PAD_DS_DGPIO12         (PAD_DS_DGPIO_BASE + 12)     ///< DGPIO12
