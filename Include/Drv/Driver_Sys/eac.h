...
typedef enum
{
    ...
    EAC_CONFIG_AD_12K_RESIST_EN,    ///< Get AD(Record) Analog Block Internal 12K Resistance Enable/Disable.
    EAC_CONFIG_AD_MICBIAS_EN,       ///< Get AD(Record) Analog Block MIC Bias Enable/Disable.
...
typedef enum
{
    ...
    EAC_CONFIG_DA_SILENCE,          ///< Configure DA(Playback) Digital Silence Mode Enable/Disable. Set TRUE/FALSE to Enable/Disable the DA output Silence Mode.
    ...
    EAC_CONFIG_DA_CLSD_SWITCHRATE,  ///< Configure DA(Playback) CLASS-D Output Switch rate as 8X ro 16X of the sampling rate. TRUE is 16X and FALSE is 8X. Default is FLASE(8X).
    EAC_CONFIG_DA_CLSD_SILENCE,     ///< Configure DA(Playback) Digital Class-D Output Silence Mode Enable/Disable. Set TRUE/FALSE to Enable/Disable the DA output Silence Mode.
    ...
    EAC_CONFIG_DA_SPKR_DRVING,      ///< Get DA(Playback) Speaker Output Driving.
    EAC_CONFIG_DA_HP_DRVING,        ///< Get DA(Playback) Headphone Output Driving.
    ...
    EAC_CONFIG_DA_OCP_THRESHOLD,    ///< Configure DA(Playback) ClassD Over-Current-Protect Threshold.
    EAC_CONFIG_DA_OCP_SUM,          ///< Get DA(Playback) ClassD Over-Current-Protect sum.

    EAC_CONFIG_DA_TEST_EN,          ///< Configure DA(Playback) Test Enable Bit. This would also pull down the DA output.

    EAC_CONFIG_DA_OCP_IREF,         ///< Configure DA(Playback) ClassD PHY Over-Current-Protect Reference current. valid settings is 0~3. Default is 0.
...
typedef enum
{
    ...
    EAC_OUTPUT_CLSD_SPK,            ///< DAC output to CLASS-D Speaker
