...
extern void crypto_setKey(UINT32 * Key, UINT32 Len);
extern void crypto_setInput(UINT32 * Input, UINT32 Len);
extern void crypto_getOutput(UINT32 * Output, UINT32 Len);
...
extern ER crypto_decryption(UINT32 uiSrc, UINT32 uiDst, UINT32 size);
