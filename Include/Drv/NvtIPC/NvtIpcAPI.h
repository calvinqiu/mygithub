...
typedef enum _NVTIPC_SENDER{
    NVTIPC_SENDER_CORE1 = 1,                 ///< the core MIPS1
    NVTIPC_SENDER_CORE2 = 2,                 ///< the core MIPS2
    NVTIPC_SENDER_CORE3 = 3,                 ///< DSP
...
*/
typedef struct _NVTIPC_SYS_MSG_EX{
    NVTIPC_SYS_CMD   sysCmdID;           ///< system command ID.
    NVTIPC_U32       DataAddr;           ///< system command Data Address.
    NVTIPC_U32       DataSize;           ///< system command Data Size.
...
typedef struct _NVTIPC_OPEN_OBJ
{
    ...
    BOOL              bIsCpu2Linux;        ///< if CPU2 is linux
} NVTIPC_OPEN_OBJ;
...
#define NVTIPC_SEMID_CRYPTO NVTIPC_SEM_ID_1 ///< Nand semaphore id between multi-cpu
