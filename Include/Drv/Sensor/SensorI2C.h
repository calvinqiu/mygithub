...
typedef enum
{
    ...
    SENSOR_I2C3_Vx1,              ///< I2C channel 3 for vx1 sublink
    SENSOR_I2C_MAX_NUM,
...
void Sensor_I2C_Open(SENSOR_I2C I2cBus, PI2C_SESSION pSection);
void Sensor_I2C_SetClock(SENSOR_I2C I2cBus, I2C_SESSION Section, UINT32 sclk);
void Sensor_I2C_SetConfig(SENSOR_I2C I2cBus, I2C_SESSION Section);
void Sensor_I2C_SetPinmux(SENSOR_I2C I2cBus, I2C_SESSION Section);
void Sensor_I2C_Close(SENSOR_I2C I2cBus, I2C_SESSION Section);
ER Sensor_I2C_Lock(SENSOR_I2C I2cBus, I2C_SESSION Section);
ER Sensor_I2C_Unlock(SENSOR_I2C I2cBus, I2C_SESSION Section);
