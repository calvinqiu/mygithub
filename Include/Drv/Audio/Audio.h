/**
    ...
    for Audio module. The NT966660's audio module is full-duplex capable and allow to transmit
...
/**
    ...
    For embedded audio codec, only the AUDIO_I2SCLKR_256FS_32BIT/AUDIO_I2SCLKR_256FS_64BIT are valid.
    Others options depend on the external audio codec implementation.
...
/*
    This setting is only for backward compatible usage.
...
typedef enum
{
    ...
    */
    AUDIO_FEATURE_CLASSD_OUT_EN,            ///< [For default codec] Enable the ClassD Audio output. TRUE is ClassD. FALSE is default ClassAB.
    ...
    */
    ...
    AUDIO_FEATURE_SPK_LEFT_EN,              //   Obselete. No Supported in current chip version.
    AUDIO_FEATURE_SPK_RIGHT_EN,             //   Obselete. No Supported in current chip version.

    /*
        New Added Feature. New items can only added on the last for compatibility.
    */
    AUDIO_FEATURE_RECORD_PWR_ALWAYSON,      ///< [For default codec] Record power always on (Default disabled)
    AUDIO_FEATURE_RECORD_REGU_PULLDOWN,     ///< [For default codec] Set Record LDO Regulator output pull down control enable/disable. default is disable.
...
typedef enum
{
    ...
    AUDIO_PARAMETER_OCP_IREF,                   ///< [For default codec] Speaker ClassD output OverCurrent Protect Reference Current. valid settings 0~3. Default is 0.
    AUDIO_PARAMETER_OCP_THRESHOLD,              ///< [For default codec] Speaker ClassD output OverCurrent Protect Threshold value.  valid settings 1~255. Default is 1.
...
typedef enum
{
    ...
    AUDIO_DEFSET_10DB_HP,   ///< The Same as AUDIO_DEFSET_10DB but with HighPass-Filter Enabled.
    ...
    AUDIO_DEFSET_20DB_HP,   ///< The Same as AUDIO_DEFSET_20DB but with HighPass-Filter Enabled.
                            ///< HighPass Filter 3dB is about 200Hz for SR48KHz. Acting as Wind-Noise suppress filter.
    ...
    AUDIO_DEFSET_30DB_HP,   ///< The Same as AUDIO_DEFSET_30DB but with HighPass-Filter Enabled.
                            ///< HighPass Filter 3dB is about 200Hz for SR48KHz. Acting as Wind-Noise suppress filter.
...
typedef enum
{
    AUDTS_CH_TX1,   ///< Playback Channel 1
    AUDTS_CH_TX2,   ///< Playback Channel 2
    AUDTS_CH_RX,    ///< Record Channel
...
typedef enum
{
    ...
    */
    AUDTS_FEATURE_AVSYNC,               ///< Set AV SYNC function enable. Only RX channel have this function.
    AUDTS_FEATURE_TIMECODE_LATCH,       ///< Set Time Code Latch Event enable. Only RX channel have this function.
...
/**
    ...
    Set external codec device control interface method and pins source. Used for aud_setDeviceObject(), and aud_getDeviceObject()
*/
typedef struct
{
