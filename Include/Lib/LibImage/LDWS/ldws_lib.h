...
{
    UINT32 uiLdwsSrcBufAddr;        ///<  input buffer address
    UINT32 uiLdwsSrcWidth;          ///<  width of input image
    UINT32 uiLdwsSrcHeight;         ///<  height of input image
    UINT32 uiLdwsSrcLineofs;        ///<  lineofset of input image
    UINT32 uiLdwsRoiWidth;          ///<  width of ROI region for LDWS
    UINT32 uiLdwsRoiHeight;         ///<  height of ROI region for LDWS
    UINT32 uiLdwsRoiSx;             ///<  start x coordinate of ROI region
    UINT32 uiLdwsRoiSy;             ///<  start y coordinate of ROI region
    UINT32 uiLdwsViewAngle;         ///<  view angle of input image
    UINT32 uiVideoWidth;
    UINT32 uiVideoHeight;
} LDWS_SRCIMG_INFO;
//@}
...
//@{
typedef struct _LDWS_RESULT_INFO
{
    LDWS_FAILURE_STATUS      Failure;       ///<  Failure mode
    LDWS_DEPARTURE_DIR       DepartureDir;  ///<  departure direction
    LDWS_DEPARTURE_DIR       DepartureDirVoice;  ///<  departure direction
...
*/
extern UINT32 LDWS_Detection(LDWS_SRCDATA_INFO *LdwsSrcDataInfo, LDWS_RESULT_INFO *LDWS_INFO, LDWS_DEBUG_INFO *LdwsDebugInfo, UINT32 uiFailureTime);

extern UINT32 LDWS_checkInitFlag(void);
extern void LDWS_setInitFlag(UINT32 Flag);
extern LDWS_RESULT_INFO LDWS_getLdwsStatus(void);
