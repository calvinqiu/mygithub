...
*/
#define ROP_BLEND_ALPHA         0x13000000 ///< image rop: BLEND  alpha a constant value
#define ROP_BLEND               0x14000000 ///< image rop: BLEND (Support YUV format only)  sub-type: SRC_ALPHA***
...
#define SRC_ALPHA(a)            (0x00ff0000 | ((a)&0x000000ff)) ///< image src: ALPHA (subtype for ROP_COPY, ROP_KEY with ARGB image)
#define SRC_DIV_1               0x00000000 ///< image src: B = SRC (subtype for ROP_ADD, ROP_SUB, ROP_ABSSUB)
#define SRC_DIV_2               0x00001000 ///< image src: B = SRC / 2 (subtype for ROP_ADD, ROP_SUB, ROP_ABSSUB)
#define SRC_DIV_4               0x00002000 ///< image src: B = SRC / 4 (subtype for ROP_ADD, ROP_SUB, ROP_ABSSUB)
#define SRC_DIV_8               0x00003000 ///< image src: B = SRC / 8 (subtype for ROP_ADD, ROP_SUB, ROP_ABSSUB)
#define SRC_DIV_MASK            0x00003000 ///< image src div mask
#define SRC_DIV_SHIFT           12 ///< image src div shift
#define SRC_ALPHA_012           0x00000000 ///< image src: OUT= 0.88 x A + 0.12 x B (subtype for ROP_BLEND)
#define SRC_ALPHA_025           0x00010000 ///< image src: OUT= 0.75 x A + 0.25 x B (subtype for ROP_BLEND)
#define SRC_ALPHA_038           0x00020000 ///< image src: OUT= 0.62 x A + 0.38 x B (subtype for ROP_BLEND)
#define SRC_ALPHA_050           0x00030000 ///< image src: OUT= 0.50 x A + 0.50 x B (subtype for ROP_BLEND)
#define SRC_ALPHA_062           0x00040000 ///< image src: OUT= 0.38 x A + 0.62 x B (subtype for ROP_BLEND)
#define SRC_ALPHA_075           0x00050000 ///< image src: OUT= 0.25 x A + 0.75 x B (subtype for ROP_BLEND)
#define SRC_ALPHA_088           0x00060000 ///< image src: OUT= 0.50 x A + 0.88 x B (subtype for ROP_BLEND)
#define SRC_ALPHA_100           0x00070000 ///< image src: OUT= B (subtype for ROP_BLEND)
#define SRC_ALPHA_MASK          0x00070000 ///< image src alpha mask
#define SRC_ALPHA_SHIFT         16 ///< image src alpha shift
#define OUT_DIV_1               0x00000000 ///< image out: A' = OUT (subtype for ROP_MUL)
#define OUT_DIV_2               0x00080000 ///< image out: A' = OUT / 2 (subtype for ROP_MUL)
#define OUT_DIV_4               0x00100000 ///< image out: A' = OUT / 4 (subtype for ROP_MUL)
#define OUT_DIV_8               0x00180000 ///< image out: A' = OUT / 8 (subtype for ROP_MUL)
#define OUT_DIV_16              0x00200000 ///< image out: A' = OUT / 16 (subtype for ROP_MUL)
#define OUT_DIV_32              0x00280000 ///< image out: A' = OUT / 32 (subtype for ROP_MUL)
#define OUT_DIV_64              0x00400000 ///< image out: A' = OUT / 64 (subtype for ROP_MUL)
#define OUT_DIV_128             0x00480000 ///< image out: A' = OUT / 128 (subtype for ROP_MUL)
#define OUT_DIV_MASK            0x00480000 ///< image out div mask
#define OUT_DIV_SHIFT           19 ///< image out div shift
