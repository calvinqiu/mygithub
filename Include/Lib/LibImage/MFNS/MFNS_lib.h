...
*/
extern UINT32 MFNS_GetWorkBufSize(UINT32 uiWidth, UINT32 uiHeight);
...
*/
extern NS_STATUS MFNS_DoAllProcess(NS_DATA_INFO *pNsParam);
...
/**
    ...
    0~2 -> Y0 Cb0 Cr0
*/
extern VOID MFNS_GetOutputDataAddr(UINT32 *puiOutputDataAddr);
