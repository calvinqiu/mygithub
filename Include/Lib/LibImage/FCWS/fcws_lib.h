...
*/
//@{
typedef struct _FCWS_INIT_PARMS
{
    INT32 iHorEdgeTh;                        ///<  horizontal edge threshold of fcws
    INT32 iVertEdgeTh;                       ///<  vertical edge threshold of fcws
} FCWS_INIT_PARMS;
//@}
...
//@{
typedef struct _FCWS_RESULT_INFO
{
    UINT32                 uiDist;            ///<  distance to front car
    BOOL                   FCWarning;         ///<  FC warning
    BOOL                   FCSoundWarning;
...
/**
    ROI threshold parameters of IME statistical
*/
//@{
typedef struct _FCWS_ROITH_INFO
{
...
/**
    FCWS Detection
*/
extern UINT32 FCWS_Detection(FCWS_SRCDATA_INFO *FcwsSrcDataInfo, LDWS_INFOFORFCWS *LDWS_INFOFORFCWS, FCWS_RESULT_INFO *FCWS_RSLTINFO, IME_GET_STL_INFO *HistInfo, APPS_FCWS_ALG_INFO *FcwsAlgDebugInfo);
