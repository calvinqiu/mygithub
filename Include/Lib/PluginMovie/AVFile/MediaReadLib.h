...
#define MEDIA_FILFFORMAT_TOTAL  4      ///< Totoal of file format type
//@}
...
*/
//@{
#define MJPG_DECODEID  0x01020304    ///< MJPG decoder
#define H264_DECODEID  0x48323634    ///< H264 decoder
//@}
...
#define MEDIAREADLIB_SETINFO_GPSENTRYBUF  10 ///< param1:address(in), param2:size(in)
//@}
...
#define MEDIAREADLIB_GETINFO_GPSDATAPOSSIZE     0x16///< p1:audio frame num(in), p2:pos(out), p3:size(out)
...
#define MEDIAAUDIO_CODEC_XX    4     ///< Unknown audio format
//@}
