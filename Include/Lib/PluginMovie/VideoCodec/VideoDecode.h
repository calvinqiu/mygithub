...
#define MEDIAVID_CUSTOM_STREAMINIT       0x03    ///< p1:(VIDCODEC_STREAM_INIT *) object(in)
#define MEDIAVID_CUSTOM_STREAMDECODE     0x04    ///< p1:(VIDCODEC_STREAM_INFO *) object(in)
#define MEDIAVID_CUSTOM_STREAMWAITDONE   0x05    ///< p1:(UINT32 *) ER_Code(out)
//@}
...
typedef enum
{
    ...
    MEDIAVID_GETINFO_CURRGOPNUM = 0x06,     ///< p1:Current GOP number(out)
...
/**
    ...
    @note used for CustomizeFunc(MEDIAVID_CUSTOM_STREAMINIT)
*/
typedef struct
{
    UINT32 workbuf;         ///<[in] workbuf       for H264 H/W internal use
    UINT32 workbufsize;     ///<[in] workbufsize for H264 H/W internal use    
    UINT32 rawWidth;        ///<[in] Raw width
    UINT32 rawHeight;       ///<[in] Raw height
    UINT32 h264DescAddr;    ///<[in] H264 description addr
    UINT32 h264DescLen;     ///<[in] H264 description length
} VIDCODEC_STREAM_INIT;
...
/**
    ...
    @note used for CustomizeFunc(MEDIAVID_CUSTOM_STREAMDECODE)
*/
typedef struct
{
