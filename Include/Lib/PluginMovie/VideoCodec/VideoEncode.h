...
#define H264_3DNR_IPCAM_IR_HighISO_LV0          120  ///< H.264 3DNR: IR level 0
#define H264_3DNR_IPCAM_IR_HighISO_LV1          121  ///< H.264 3DNR: IR level 1
#define H264_3DNR_IPCAM_IR_HighISO_LV2          122  ///< H.264 3DNR: IR level 2
#define H264_3DNR_IPCAM_IR_HighISO_LV3          123  ///< H.264 3DNR: IR level 3
#define H264_3DNR_IPCAM_IR_HighISO_LV4          124  ///< H.264 3DNR: IR level 4
#define H264_3DNR_IPCAM_IR_HighISO_LV5          125  ///< H.264 3DNR: IR level 4
#define H264_3DNR_IPCAM_IR_HighISO_LV6          126  ///< H.264 3DNR: IR level 4

#define H264_3DNR_SCENE_CHANGE_LV0              130
...
typedef enum
{
    ...
    MEDIAENC_GETINFO_GOPNUM      = 0x93,    ///< get H.264 gop number (p1)
...
typedef enum
{
    ...
    MEDIAENC_SETINFO_H264_RESET_I   = 0x9F, ///< set H264 3DNR output enable/disable
    ...
    MEDIAENC_SETINFO_CBR_INFO       = 0xA2, ///< set H264 CBR_INFO, p1:SM_H264_CBR_INFO, p2: pathid,
    MEDIAENC_SETINFO_VBR_INFO       = 0xA3, ///< set H264 VBR_INFO, p1:SM_H264_VBR_INFO, p2: pathid,
    MEDIAENC_SETINFO_UNLIMITEDLOWTBR = 0xA4, ///< set unlimited low TBR, p1:en
	MEDIAENC_SETINFO_CBEN           = 0xA5, ///<  set cb ENABLE, p1: en
	MEDIAENC_SETINFO_CBALPHA        = 0xA6, ///<  set cbAlpha, p1: value
	MEDIAENC_SETINFO_CBBETA         = 0xA7, ///<  set cbBeta, p1: value
	MEDIAENC_SETINFO_TBR_BASICRC    = 0xA8, ///<  set BASIC ratecontrol, p1: TBR (bytes per second)
	MEDIAENC_SETINFO_EN_LASTQP      = 0xA9, ///<  enable last QP as init value, p1: value
	MEDIAENC_SETINFO_SHOWQP         = 0xAA, ///<  show last QP, p1: value
	MEDIAENC_SETINFO_MAXBSTEST      = 0xAB, ///<  maxbslen test
...
typedef struct
{
    ...
    UINT32 uiLastIQp;                      ///< last i Qp
    UINT32 uiLastPQp;                      ///< last P Qp
...
typedef struct
{
    void (*MediaRec_3DNRDo)(UINT32 level, UINT32 config);
    UINT32 id;
} V3DNRDOCB, *PV3DNRDOCB;
