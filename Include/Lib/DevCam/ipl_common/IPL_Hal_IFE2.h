...
typedef enum _IPH_IFE2_QUE
{
    ...
    IFE2_Q_OUTADDR1         = 0x00000009,   ///< read Input addr from reg.      Data type: IFE2_ADDR
    IFE2_Q_PPBID            = 0x0000000A,   ///< read Input addr from reg.      Data type: UINT32
...
typedef enum _IFE2_UPDATE
{
    ...
    IFE2_ADDR_OUTPUT_ID0    = 0x00000002,       ///< update output ID0 addr
    IFE2_ADDR_OUTPUT_ID1    = 0x00000004,       ///< update output ID1 addr
    IFE2_LINEOFT_INPUT      = 0x00000008,       ///< update input lineoffset
    IFE2_LINEOFT_OUTPUT     = 0x00000010,       ///< update output lineoffset
    IFE2_INSIZE             = 0x00000020,       ///< update input size
    IFE2_SRCFMT             = 0x00000040,       ///< update input source format
    IFE2_DSTFMT             = 0x00000080,       ///< update output source format
    IFE2_REFCENTERPARA      = 0x00000100,       ///< update reference center para.
    IFE2_FILTERPARAM        = 0x00000200,       ///< update filter para.
    IFE2_GRAYSTAL           = 0x00000400,       ///< update filter para.
    IFE2_INIT               = 0x00000800,       ///< init ife2

    IFE2_ST                 = 0x00001000,       ///< MST/SST runtime change(change source mode)
    IFE2_CHGALL             = 0x00002000,       ///< Runtime change all parameters
...
typedef struct _IFE2_Manager
{
    ...
    IFE2_ADDR        OutAddr0;          ///< ife2 dma output address for set0
    IFE2_ADDR        OutAddr1;          ///< ife2 dma output address for set1
