...
typedef enum _IFE_UPDATE
{
    ...
    IFE_ROWDEFEECT      = 0x00000020,       ///< update row defect concealment
    ...
    IFE_FLIP            = 0x00001000,       ///< update Flip parameters
    IFE_INIT            = 0x00002000,       ///< init ife
    IFE_CROPPARAM       = 0x00004000,       ///< update crop parameters
...
typedef enum _IFE_READ
{
    ...
    IFE_R_ROWDEF    = 0x00000004,   ///< read row defect concealment,               Data type: IFE_ROWDEF
