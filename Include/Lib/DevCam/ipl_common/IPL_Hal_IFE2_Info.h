...
{
    IPH_IFE2CLK0 = 192,  ///< -192 mhz
    IPH_IFE2CLK1 = 240,  ///< -240 mhz
    IPH_IFE2CLK2 = 270,  ///< -270 mhz
    IPH_IFE2CLK3 = 300,  ///< -300 mhz
...
{
    OutPPBEn    = 0x00000001,       ///< enable output ping-pong buffer
    YFtrEn      = 0x00000002,       ///< enable y filter
...
typedef enum _IFE2_SRCMODE
{
    ...
    IFE2_IPP     = 1,    ///< IFE->DCE->IPE->IME(IFE2)
    IFE2_RDE_IPP = 2,    ///< RDE + IFE->DCE->IPE->IME(IFE2)
    IFE2_RHE_IPP = 3,    ///< RDE + IFE->DCE->IPE->IME(IFE2)
    IFE2_SIE_IPP = 4,    ///< SIE + IFE->DCE->IPE->IME(IFE2) (all direct)
