...
typedef enum _IPL_PROC_ID
{
    ...
    IPL_ID_MAX_NUM,
    IPL_ID_1_2,                         ///< process id 1 & 2 for sync control and run time change cmd only
...
/**
     ...
     @note set sie crop offset
     @param[in] Id          ipl id
     @param[in] CropOfsX    crop offset x
     @param[in] CropOfsY    crop offset y
     @return
*/
//#NT#2016/09/14#liwei cheng -begin
//#NT# add add surpport up and left crop offset
extern void IPL_SIESetCropOfs(UINT32 Id, INT32 CropOfsX, INT32 CropOfsY);
/**
     IPL_SIESetCropOfs_Cap
     ...
     @return
*/
extern void IPL_SIESetCropOfs_Cap(UINT32 Id, INT32 CropOfsX, INT32 CropOfsY);
/**
     IPL_CheckCropOfsBound

     @note set sie crop offset
     @param[in] Id           ipl id
     @param[in] StartPixX    StartPixX
     @param[in] StartPixY    StartPixY
     @param[in] ActSizeH     ActSizeH
     @param[in] ActSizeV     ActSizeV
     @param[in] CropSizeH    CropSizeH
     @param[in] CropSizeV    CropSizeV
     @return
*/
extern void IPL_CheckCropOfsBound(UINT32 Id, UINT32* StartPixX,UINT32* StartPixY,UINT32 ActSizeH, UINT32 ActSizeV,UINT32 CropSizeH,UINT32 CropSizeV);
//#NT#2016/09/14#liwei cheng -end
//#NT#2016/09/19#liwei cheng -begin
//#NT# add surpport cap crop offset
/**
     IPL_CheckCropOfsBound
     ...
     @return
*/
extern void IPL_CheckCropOfsBound_Cap(UINT32 Id, UINT32* StartPixX,UINT32* StartPixY,UINT32 ActSizeH, UINT32 ActSizeV,UINT32 CropSizeH,UINT32 CropSizeV);
//#NT#2016/09/19#liwei cheng -end
