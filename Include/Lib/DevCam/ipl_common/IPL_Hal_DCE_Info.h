...
{
    IPH_DCECLK0 = 192,  ///< -192 mhz
    IPH_DCECLK1 = 240,  ///< -240 mhz
    IPH_DCECLK2 = 270,  ///< -270 mhz
    IPH_DCECLK3 = 300,  ///< -300 mhz
...
{
    DCE_D2D     = 0,    ///< DCE only
    DCE_IPP     = 1,    ///< IFE->DCE->IPE->IME(IFE2)
    DCE_RDE_IPP = 2,    ///< RDE + IFE->DCE->IPE->IME(IFE2)
    DCE_RHE_IPP = 3,    ///< RDE + IFE->DCE->IPE->IME(IFE2)
    DCE_SIE_IPP = 4,    ///< SIE + IFE->DCE->IPE->IME(IFE2) (all direct)
...
typedef enum _DceInteEn
{
    ...
    DCE__INT_CACOVF = 0x00000020,   ///< Interrupt for DCE line buffer overflow error
    DCE__INT_STPOB  = 0x00000040,   ///< Interrupt for DCE line buffer overflow error
...
*/
/**
    @name DCE struct - 2D lut scaling factor
*/
//@{
typedef struct
{
    UINT32    HScaleFact;  ///< 2D lut h scaling factor
    UINT32    VScaleFact;  ///< 2D lut v scaling factor
}_2DLUT_SCALE;
//@}
typedef enum
{
...
typedef struct
{
    ...
    _2DLUT_SCALE _2DLutScaleFact;   ///< 2D lut x y scale factor
} _2DLUT_PARAM;
//@}
/**
