/**
    Public header file for IQS

    This file is the header file that define the API and data type for IQS.
...
/**
     ...
     @param[in] Id          awb process id (IQS_PROC_ID)
...
extern void ISP_IQ_Tuning_Lock(void);
extern void ISP_IQ_Tuning_Unlock(void);
#endif //_IQS_TASK_H_
