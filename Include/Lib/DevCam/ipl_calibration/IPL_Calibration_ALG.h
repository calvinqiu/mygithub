...
typedef struct _CAL_ALG_OBJ
{
    ...
    //#NT#2016/03/15#Silvia Wu -begin
    //#NT#  for calibration ECS debug
    ...
    //#NT#2016/03/15#Silvia Wu -end
    void    (*fpAWB_AVG)(IPL_RAW_IMG_INFO* pRaw,UINT32* pAvgRg,UINT32* pAvgBg,CCRange BitSel);///<plz refer to Cal_AlgEvent()
    UINT32  (*fpLenCenter)(IPL_RAW_IMG_INFO* pRaw, UINT32 ScanCenterX, UINT32 ScanCenterY, UINT32 ScanRadius, UINT32 AvgCnt, UINT32 EdgeThr, UINT32 ValidRadius, iCoordinate *out_cent)
...
\n                          num:    dp number.
        - @b fpDPC_ArgFmt:  arrange DP table format
\n                      input para:
\n                          pTbl:   dp coordinate table pointer
\n                          num:    dp number.
\n                      output para:
