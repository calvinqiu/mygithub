...
typedef struct _H2643dnrCfg{
   //  Luma Config //
   UINT32 uiTY_Weight[4][3];    ///< Temporal Filter
   UINT32 uiRY_TH[3];           ///< Range Filter

   // Chroma Config //
   UINT32 uiTC_Weight[4][3];    ///< Temporal Filter
...
//    H264Enc3dnrCfg  eEnc3dnrCfg;        ///< H.264 3dnr config
    ...
    UINT8           ucDirectPath;       ///< H.264 Direct Path, 0 : DRAM 1:IME
...
extern INT32 h264Enc_getEncid(void);
extern INT32 h264Enc_showQp(H264ENC_VAR *pH264EncVar);
extern INT32 h264Enc_set_RC_CBR(H264ENC_VAR *pH264EncVar, UINT32 uiCbrEn, float fStatTime, UINT32 uiBitRate, UINT32 uiQpDelta, UINT32 uiQpFrmRate, INT32 iMaxQp, UINT32 uiIPWeight, UINT32 uiOpt1);
extern INT32 h264Enc_set_RC_VBR(H264ENC_VAR *pH264EncVar, UINT32 uiVbrEn, INT32 iMaxQp, INT32 iMinQp, UINT32 uiMaxBitrate, UINT32 uiMBRP, UINT32 uiQpGopDelta, UINT32 uiOpt1);
