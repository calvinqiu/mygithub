...
//#NT# fix default window to center
#define AF_DEFAULT_WIN          (((AF_WIN_DIMENSION_H/2)*AF_WIN_DIMENSION_W)+(AF_WIN_DIMENSION_W /2))
...
typedef struct _AF_GRP
{
    UINT32 uiHWVA_G1H[AF_VA_WINSIZE];
    UINT32 uiHWVA_G1V[AF_VA_WINSIZE];
    UINT32 uiHWVA_G2H[AF_VA_WINSIZE];
    UINT32 uiHWVA_G2V[AF_VA_WINSIZE];
}AF_GRP;
...
extern void AFALG_SetParam(UINT32 id);
