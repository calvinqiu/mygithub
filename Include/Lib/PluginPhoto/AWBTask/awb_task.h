...
/**
     ...
     @return Description of data returned.
         - @b ER: E_OK success
*/
extern ER AWB_Open(AWB_PROC_ID Id, AWB_OBJ_INFO *Obj);
...
/**
     ...
     @param[in] Id          ae process id (AWB_PROC_ID)
     @return Description of data returned.
         - @b BOOL: true pause, false not pause
*/
extern BOOL AWB_IsPause(AWB_PROC_ID Id);
...
*/
extern void AWBTuning_Lock(void);
extern void AWBTuning_Unlock(void);
