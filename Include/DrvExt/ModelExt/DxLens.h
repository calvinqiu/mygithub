...
/**
     Index for Lens_IRCUT_Move().

     Used to open/close IRCUT.
*/
typedef enum
{
    IRCUT_POS_CLOSE = 0,  ///< Used to close IRCUT.
    IRCUT_POS_OPEN,       ///< Used to open IRCUT.
    IRCUT_POS_MAX,
...
/**
     Index for LensCtrl_IRCUT_SetState().
*/
typedef enum
{
    MOTOR_IRCUT_NORMAL,         ///< Reserved
...
typedef struct _MOTOR_TAB
{
    ...
    //IRCUT
    void          (*ircut_setState)(MOTOR_IRCUT_ACT,UINT32);        ///<ircut action
...
typedef struct
{
    ...
    void       (*lensctrltsk_ircut_setstate)(MOTOR_IRCUT_ACT, UINT32);
...
typedef struct _LENS_TAB
{
    ...
    //IRCUT
    void                (*ircut_setState)(MOTOR_IRCUT_ACT, UINT32);     ///< Set IRCUT state as open or close.
    //Misc
...
extern UINT32   DrvLens_GetFFFocalLength(void);
#endif //_DXLENS_H_
